...
data PaymentFlowsAmountDetails = PaymentFlowsAmountDetails
  { -- | tip:
    paymentFlowsAmountDetailsTip :: (GHC.Maybe.Maybe PaymentFlowsAmountDetailsClientResourceTip)
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentFlowsAmountDetails where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("tip" Data.Aeson.Types.ToJSON..=)) (paymentFlowsAmountDetailsTip obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentFlowsAmountDetails where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentFlowsAmountDetails" (\obj -> GHC.Base.pure PaymentFlowsAmountDetails GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tip"))
