...
data SetupIntentPaymentMethodOptionsCardNetwork'NonNullable
  ...
  | -- | Represents the JSON value @"girocard"@
    SetupIntentPaymentMethodOptionsCardNetwork'NonNullableEnumGirocard
  ...
  | -- | Represents the JSON value @"link"@
    SetupIntentPaymentMethodOptionsCardNetwork'NonNullableEnumLink
...
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsCardNetwork'NonNullable where
  ...
  toJSON (SetupIntentPaymentMethodOptionsCardNetwork'NonNullableEnumGirocard) = "girocard"
  ...
  toJSON (SetupIntentPaymentMethodOptionsCardNetwork'NonNullableEnumLink) = "link"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "girocard" -> SetupIntentPaymentMethodOptionsCardNetwork'NonNullableEnumGirocard
          ...
          | val GHC.Classes.== "link" -> SetupIntentPaymentMethodOptionsCardNetwork'NonNullableEnumLink
