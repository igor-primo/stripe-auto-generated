...
data Recurring = Recurring
  { -- | interval: The frequency at which a subscription is billed. One of \`day\`, \`week\`, \`month\` or \`year\`.
    ...
    recurringMeter :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text)),
...
instance Data.Aeson.Types.ToJSON.ToJSON Recurring where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["interval" Data.Aeson.Types.ToJSON..= recurringInterval obj] : ["interval_count" Data.Aeson.Types.ToJSON..= recurringIntervalCount obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("meter" Data.Aeson.Types.ToJSON..=)) (recurringMeter obj) : ["usage_type" Data.Aeson.Types.ToJSON..= recurringUsageType obj] : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["interval" Data.Aeson.Types.ToJSON..= recurringInterval obj] : ["interval_count" Data.Aeson.Types.ToJSON..= recurringIntervalCount obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("meter" Data.Aeson.Types.ToJSON..=)) (recurringMeter obj) : ["usage_type" Data.Aeson.Types.ToJSON..= recurringUsageType obj] : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON Recurring where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "Recurring" (\obj -> (((GHC.Base.pure Recurring GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "interval")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "interval_count")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "meter")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "usage_type"))
...
mkRecurring ::
  ...
  RecurringUsageType' ->
  Recurring
mkRecurring recurringInterval recurringIntervalCount recurringUsageType =
  Recurring
    { recurringInterval = recurringInterval,
...
instance Data.Aeson.Types.ToJSON.ToJSON RecurringInterval' where
  toJSON (RecurringInterval'Other val) = val
...
instance Data.Aeson.Types.ToJSON.ToJSON RecurringUsageType' where
  toJSON (RecurringUsageType'Other val) = val
