...
instance Data.Aeson.Types.ToJSON.ToJSON InvoicePaymentMethodOptionsCustomerBalanceBankTransferEuBankTransfer where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["country" Data.Aeson.Types.ToJSON..= invoicePaymentMethodOptionsCustomerBalanceBankTransferEuBankTransferCountry obj] : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicePaymentMethodOptionsCustomerBalanceBankTransferEuBankTransfer where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoicePaymentMethodOptionsCustomerBalanceBankTransferEuBankTransfer" (\obj -> GHC.Base.pure InvoicePaymentMethodOptionsCustomerBalanceBankTransferEuBankTransfer GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "country"))

-- | Create a new 'InvoicePaymentMethodOptionsCustomerBalanceBankTransferEuBankTransfer' with all required fields.
mkInvoicePaymentMethodOptionsCustomerBalanceBankTransferEuBankTransfer ::
...
data InvoicePaymentMethodOptionsCustomerBalanceBankTransferEuBankTransferCountry'
  ...
  | -- | Represents the JSON value @"ES"@
    InvoicePaymentMethodOptionsCustomerBalanceBankTransferEuBankTransferCountry'EnumES
  | -- | Represents the JSON value @"FR"@
    InvoicePaymentMethodOptionsCustomerBalanceBankTransferEuBankTransferCountry'EnumFR
  | -- | Represents the JSON value @"IE"@
    InvoicePaymentMethodOptionsCustomerBalanceBankTransferEuBankTransferCountry'EnumIE
  | -- | Represents the JSON value @"NL"@
    InvoicePaymentMethodOptionsCustomerBalanceBankTransferEuBankTransferCountry'EnumNL
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicePaymentMethodOptionsCustomerBalanceBankTransferEuBankTransferCountry' where
  parseJSON val =
    GHC.Base.pure
      ( if
