...
data PaymentMethodOptionsCardInstallmentsPlan'NonNullableType'
  ...
  | -- | Represents the JSON value @"bonus"@
    PaymentMethodOptionsCardInstallmentsPlan'NonNullableType'EnumBonus
  ...
  | -- | Represents the JSON value @"revolving"@
    PaymentMethodOptionsCardInstallmentsPlan'NonNullableType'EnumRevolving
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodOptionsCardInstallmentsPlan'NonNullableType' where
  ...
  toJSON (PaymentMethodOptionsCardInstallmentsPlan'NonNullableType'EnumBonus) = "bonus"
  toJSON (PaymentMethodOptionsCardInstallmentsPlan'NonNullableType'EnumFixedCount) = "fixed_count"
  toJSON (PaymentMethodOptionsCardInstallmentsPlan'NonNullableType'EnumRevolving) = "revolving"

instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodOptionsCardInstallmentsPlan'NonNullableType' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "bonus" -> PaymentMethodOptionsCardInstallmentsPlan'NonNullableType'EnumBonus
          | val GHC.Classes.== "fixed_count" -> PaymentMethodOptionsCardInstallmentsPlan'NonNullableType'EnumFixedCount
          | val GHC.Classes.== "revolving" -> PaymentMethodOptionsCardInstallmentsPlan'NonNullableType'EnumRevolving
