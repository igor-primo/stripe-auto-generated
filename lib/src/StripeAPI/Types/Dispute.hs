...
data Dispute = Dispute
  { -- | amount: Disputed amount. Usually the amount of the charge, but it can differ (usually because of currency fluctuation or because only part of the order is disputed).
    ...
    disputeEnhancedEligibilityTypes :: [DisputeEnhancedEligibilityTypes'],
    -- | evidence:
...
mkDispute ::
  ...
  DisputeStatus' ->
  Dispute
mkDispute disputeAmount disputeBalanceTransactions disputeCharge disputeCreated disputeCurrency disputeEnhancedEligibilityTypes disputeEvidence disputeEvidenceDetails disputeId disputeIsChargeRefundable disputeLivemode disputeMetadata disputeReason disputeStatus =
  Dispute
...
data DisputeEnhancedEligibilityTypes'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    DisputeEnhancedEligibilityTypes'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    DisputeEnhancedEligibilityTypes'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"visa_compelling_evidence_3"@
    DisputeEnhancedEligibilityTypes'EnumVisaCompellingEvidence_3
  | -- | Represents the JSON value @"visa_compliance"@
    DisputeEnhancedEligibilityTypes'EnumVisaCompliance
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON DisputeEnhancedEligibilityTypes' where
  toJSON (DisputeEnhancedEligibilityTypes'Other val) = val
  toJSON (DisputeEnhancedEligibilityTypes'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (DisputeEnhancedEligibilityTypes'EnumVisaCompellingEvidence_3) = "visa_compelling_evidence_3"
  toJSON (DisputeEnhancedEligibilityTypes'EnumVisaCompliance) = "visa_compliance"

instance Data.Aeson.Types.FromJSON.FromJSON DisputeEnhancedEligibilityTypes' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "visa_compelling_evidence_3" -> DisputeEnhancedEligibilityTypes'EnumVisaCompellingEvidence_3
          | val GHC.Classes.== "visa_compliance" -> DisputeEnhancedEligibilityTypes'EnumVisaCompliance
          | GHC.Base.otherwise -> DisputeEnhancedEligibilityTypes'Other val
      )
