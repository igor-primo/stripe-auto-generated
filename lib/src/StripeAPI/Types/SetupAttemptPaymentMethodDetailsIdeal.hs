...
data SetupAttemptPaymentMethodDetailsIdealBank'NonNullable
  ...
  | -- | Represents the JSON value @"buut"@
    SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumBuut
  ...
  | -- | Represents the JSON value @"nn"@
    SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumNn
...
instance Data.Aeson.Types.ToJSON.ToJSON SetupAttemptPaymentMethodDetailsIdealBank'NonNullable where
  ...
  toJSON (SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumBuut) = "buut"
  ...
  toJSON (SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumNn) = "nn"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "buut" -> SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumBuut
          ...
          | val GHC.Classes.== "nn" -> SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumNn
...
data SetupAttemptPaymentMethodDetailsIdealBic'NonNullable
  ...
  | -- | Represents the JSON value @"BUUTNL2A"@
    SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumBUUTNL2A
  ...
  | -- | Represents the JSON value @"NNBANL2G"@
    SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumNNBANL2G
...
instance Data.Aeson.Types.ToJSON.ToJSON SetupAttemptPaymentMethodDetailsIdealBic'NonNullable where
  ...
  toJSON (SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumBUUTNL2A) = "BUUTNL2A"
  ...
  toJSON (SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumNNBANL2G) = "NNBANL2G"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "BUUTNL2A" -> SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumBUUTNL2A
          ...
          | val GHC.Classes.== "NNBANL2G" -> SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumNNBANL2G
