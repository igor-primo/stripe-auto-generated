...
import {-# SOURCE #-} StripeAPI.Types.PayoutsTraceId
...
data Payout = Payout
  { -- | amount: The amount (in cents (or local equivalent)) that transfers to your bank account or debit card.
    ...
    payoutApplicationFee :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PayoutApplicationFee'NonNullableVariants)),
    ...
    payoutApplicationFeeAmount :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable GHC.Types.Int)),
    ...
    --
    -- * Maximum length of 5000
    payoutPayoutMethod :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text)),
    ...
    payoutTraceId :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PayoutTraceId'NonNullable)),
...
mkPayout payoutAmount payoutArrivalDate payoutAutomatic payoutCreated payoutCurrency payoutId payoutLivemode payoutMethod payoutReconciliationStatus payoutSourceType payoutStatus payoutType =
  Payout
    { payoutAmount = payoutAmount,
      payoutApplicationFee = GHC.Maybe.Nothing,
      payoutApplicationFeeAmount = GHC.Maybe.Nothing,
...
data PayoutApplicationFee'NonNullableVariants
  = PayoutApplicationFee'NonNullableText Data.Text.Internal.Text
  | PayoutApplicationFee'NonNullableApplicationFee ApplicationFee
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PayoutApplicationFee'NonNullableVariants where
  toJSON (PayoutApplicationFee'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (PayoutApplicationFee'NonNullableApplicationFee a) = Data.Aeson.Types.ToJSON.toJSON a

instance Data.Aeson.Types.FromJSON.FromJSON PayoutApplicationFee'NonNullableVariants where
  parseJSON val = case (PayoutApplicationFee'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PayoutApplicationFee'NonNullableApplicationFee Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data PayoutTraceId'NonNullable = PayoutTraceId'NonNullable
  { -- | status: Possible values are \`pending\`, \`supported\`, and \`unsupported\`. When \`payout.status\` is \`pending\` or \`in_transit\`, this will be \`pending\`. When the payout transitions to \`paid\`, \`failed\`, or \`canceled\`, this status will become \`supported\` or \`unsupported\` shortly after in most cases. In some cases, this may appear as \`pending\` for up to 10 days after \`arrival_date\` until transitioning to \`supported\` or \`unsupported\`.
    ...
    --
    -- * Maximum length of 5000
    payoutTraceId'NonNullableStatus :: (GHC.Maybe.Maybe Data.Text.Internal.Text),
    -- | value: The trace ID value if \`trace_id.status\` is \`supported\`, otherwise \`nil\`.
    --
    -- Constraints:
    --
    -- * Maximum length of 5000
    payoutTraceId'NonNullableValue :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text))
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON PayoutTraceId'NonNullable where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("status" Data.Aeson.Types.ToJSON..=)) (payoutTraceId'NonNullableStatus obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("value" Data.Aeson.Types.ToJSON..=)) (payoutTraceId'NonNullableValue obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("status" Data.Aeson.Types.ToJSON..=)) (payoutTraceId'NonNullableStatus obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("value" Data.Aeson.Types.ToJSON..=)) (payoutTraceId'NonNullableValue obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON PayoutTraceId'NonNullable where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PayoutTraceId'NonNullable" (\obj -> (GHC.Base.pure PayoutTraceId'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "status")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "value"))

-- | Create a new 'PayoutTraceId'NonNullable' with all required fields.
mkPayoutTraceId'NonNullable :: PayoutTraceId'NonNullable
mkPayoutTraceId'NonNullable =
  PayoutTraceId'NonNullable
    { payoutTraceId'NonNullableStatus = GHC.Maybe.Nothing,
      payoutTraceId'NonNullableValue = GHC.Maybe.Nothing
    }
