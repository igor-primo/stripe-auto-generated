...
import {-# SOURCE #-} StripeAPI.Types.PortalResourceScheduleUpdateAtPeriodEnd
...
data PortalSubscriptionUpdate = PortalSubscriptionUpdate
  { -- | default_allowed_updates: The types of subscription updates that are supported for items listed in the \`products\` attribute. When empty, subscriptions are not updateable.
    ...
    -- | proration_behavior: Determines how to handle prorations resulting from subscription updates. Valid values are \`none\`, \`create_prorations\`, and \`always_invoice\`. Defaults to a value of \`none\` if you don\'t set it during creation.
    portalSubscriptionUpdateProrationBehavior :: PortalSubscriptionUpdateProrationBehavior',
    -- | schedule_at_period_end:
    portalSubscriptionUpdateScheduleAtPeriodEnd :: PortalResourceScheduleUpdateAtPeriodEnd
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.FromJSON.FromJSON PortalSubscriptionUpdate where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PortalSubscriptionUpdate" (\obj -> ((((GHC.Base.pure PortalSubscriptionUpdate GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "default_allowed_updates")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "enabled")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "products")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "proration_behavior")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "schedule_at_period_end"))
...
mkPortalSubscriptionUpdate ::
  ...
  PortalSubscriptionUpdateProrationBehavior' ->
  -- | 'portalSubscriptionUpdateScheduleAtPeriodEnd'
  PortalResourceScheduleUpdateAtPeriodEnd ->
  PortalSubscriptionUpdate
mkPortalSubscriptionUpdate portalSubscriptionUpdateDefaultAllowedUpdates portalSubscriptionUpdateEnabled portalSubscriptionUpdateProrationBehavior portalSubscriptionUpdateScheduleAtPeriodEnd =
  PortalSubscriptionUpdate
    { portalSubscriptionUpdateDefaultAllowedUpdates = portalSubscriptionUpdateDefaultAllowedUpdates,
      portalSubscriptionUpdateEnabled = portalSubscriptionUpdateEnabled,
      portalSubscriptionUpdateProducts = GHC.Maybe.Nothing,
      portalSubscriptionUpdateProrationBehavior = portalSubscriptionUpdateProrationBehavior,
      portalSubscriptionUpdateScheduleAtPeriodEnd = portalSubscriptionUpdateScheduleAtPeriodEnd
    }
