...
data Source = Source
  { -- | ach_credit_transfer
    ...
    sourceAllowRedisplay :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable SourceAllowRedisplay'NonNullable)),
...
mkSource sourceClientSecret sourceCreated sourceFlow sourceId sourceLivemode sourceStatus sourceType =
  Source
    { sourceAchCreditTransfer = GHC.Maybe.Nothing,
      ...
      sourceAllowRedisplay = GHC.Maybe.Nothing,
...
data SourceAllowRedisplay'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    SourceAllowRedisplay'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    SourceAllowRedisplay'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"always"@
    SourceAllowRedisplay'NonNullableEnumAlways
  | -- | Represents the JSON value @"limited"@
    SourceAllowRedisplay'NonNullableEnumLimited
  | -- | Represents the JSON value @"unspecified"@
    SourceAllowRedisplay'NonNullableEnumUnspecified
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON SourceAllowRedisplay'NonNullable where
  toJSON (SourceAllowRedisplay'NonNullableOther val) = val
  toJSON (SourceAllowRedisplay'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (SourceAllowRedisplay'NonNullableEnumAlways) = "always"
  toJSON (SourceAllowRedisplay'NonNullableEnumLimited) = "limited"
  toJSON (SourceAllowRedisplay'NonNullableEnumUnspecified) = "unspecified"

instance Data.Aeson.Types.FromJSON.FromJSON SourceAllowRedisplay'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "always" -> SourceAllowRedisplay'NonNullableEnumAlways
          | val GHC.Classes.== "limited" -> SourceAllowRedisplay'NonNullableEnumLimited
          | val GHC.Classes.== "unspecified" -> SourceAllowRedisplay'NonNullableEnumUnspecified
          | GHC.Base.otherwise -> SourceAllowRedisplay'NonNullableOther val
      )
