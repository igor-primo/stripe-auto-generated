...
data FilePurpose'
  ...
  | -- | Represents the JSON value @"financial_account_statement"@
    FilePurpose'EnumFinancialAccountStatement
  ...
  | -- | Represents the JSON value @"issuing_regulatory_reporting"@
    FilePurpose'EnumIssuingRegulatoryReporting
  ...
  | -- | Represents the JSON value @"terminal_android_apk"@
    FilePurpose'EnumTerminalAndroidApk
...
instance Data.Aeson.Types.ToJSON.ToJSON FilePurpose' where
  ...
  toJSON (FilePurpose'EnumFinancialAccountStatement) = "financial_account_statement"
  ...
  toJSON (FilePurpose'EnumIssuingRegulatoryReporting) = "issuing_regulatory_reporting"
  ...
  toJSON (FilePurpose'EnumTerminalAndroidApk) = "terminal_android_apk"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "financial_account_statement" -> FilePurpose'EnumFinancialAccountStatement
          ...
          | val GHC.Classes.== "issuing_regulatory_reporting" -> FilePurpose'EnumIssuingRegulatoryReporting
          ...
          | val GHC.Classes.== "terminal_android_apk" -> FilePurpose'EnumTerminalAndroidApk
