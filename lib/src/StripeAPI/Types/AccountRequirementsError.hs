...
data AccountRequirementsErrorCode'
  ...
  | -- | Represents the JSON value @"information_missing"@
    AccountRequirementsErrorCode'EnumInformationMissing
  ...
  | -- | Represents the JSON value @"invalid_signator"@
    AccountRequirementsErrorCode'EnumInvalidSignator
  ...
  | -- | Represents the JSON value @"verification_failed_authorizer_authority"@
    AccountRequirementsErrorCode'EnumVerificationFailedAuthorizerAuthority
  ...
  | -- | Represents the JSON value @"verification_failed_representative_authority"@
    AccountRequirementsErrorCode'EnumVerificationFailedRepresentativeAuthority
  ...
  | -- | Represents the JSON value @"verification_legal_entity_structure_mismatch"@
    AccountRequirementsErrorCode'EnumVerificationLegalEntityStructureMismatch
  ...
  | -- | Represents the JSON value @"verification_rejected_ownership_exemption_reason"@
    AccountRequirementsErrorCode'EnumVerificationRejectedOwnershipExemptionReason
  ...
  | -- | Represents the JSON value @"verification_requires_additional_proof_of_registration"@
    AccountRequirementsErrorCode'EnumVerificationRequiresAdditionalProofOfRegistration
  | -- | Represents the JSON value @"verification_supportability"@
    AccountRequirementsErrorCode'EnumVerificationSupportability
...
instance Data.Aeson.Types.ToJSON.ToJSON AccountRequirementsErrorCode' where
  ...
  toJSON (AccountRequirementsErrorCode'EnumInformationMissing) = "information_missing"
  ...
  toJSON (AccountRequirementsErrorCode'EnumInvalidSignator) = "invalid_signator"
  ...
  toJSON (AccountRequirementsErrorCode'EnumVerificationFailedAuthorizerAuthority) = "verification_failed_authorizer_authority"
  ...
  toJSON (AccountRequirementsErrorCode'EnumVerificationFailedRepresentativeAuthority) = "verification_failed_representative_authority"
  ...
  toJSON (AccountRequirementsErrorCode'EnumVerificationLegalEntityStructureMismatch) = "verification_legal_entity_structure_mismatch"
  ...
  toJSON (AccountRequirementsErrorCode'EnumVerificationRejectedOwnershipExemptionReason) = "verification_rejected_ownership_exemption_reason"
  ...
  toJSON (AccountRequirementsErrorCode'EnumVerificationRequiresAdditionalProofOfRegistration) = "verification_requires_additional_proof_of_registration"
  toJSON (AccountRequirementsErrorCode'EnumVerificationSupportability) = "verification_supportability"

instance Data.Aeson.Types.FromJSON.FromJSON AccountRequirementsErrorCode' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "information_missing" -> AccountRequirementsErrorCode'EnumInformationMissing
          ...
          | val GHC.Classes.== "invalid_signator" -> AccountRequirementsErrorCode'EnumInvalidSignator
          ...
          | val GHC.Classes.== "verification_failed_authorizer_authority" -> AccountRequirementsErrorCode'EnumVerificationFailedAuthorizerAuthority
          ...
          | val GHC.Classes.== "verification_failed_representative_authority" -> AccountRequirementsErrorCode'EnumVerificationFailedRepresentativeAuthority
          ...
          | val GHC.Classes.== "verification_legal_entity_structure_mismatch" -> AccountRequirementsErrorCode'EnumVerificationLegalEntityStructureMismatch
          ...
          | val GHC.Classes.== "verification_rejected_ownership_exemption_reason" -> AccountRequirementsErrorCode'EnumVerificationRejectedOwnershipExemptionReason
          ...
          | val GHC.Classes.== "verification_requires_additional_proof_of_registration" -> AccountRequirementsErrorCode'EnumVerificationRequiresAdditionalProofOfRegistration
          | val GHC.Classes.== "verification_supportability" -> AccountRequirementsErrorCode'EnumVerificationSupportability
