...
data InvoicePaymentMethodOptionsCardRequestThreeDSecure'NonNullable
  ...
  | -- | Represents the JSON value @"challenge"@
    InvoicePaymentMethodOptionsCardRequestThreeDSecure'NonNullableEnumChallenge
...
instance Data.Aeson.Types.ToJSON.ToJSON InvoicePaymentMethodOptionsCardRequestThreeDSecure'NonNullable where
  ...
  toJSON (InvoicePaymentMethodOptionsCardRequestThreeDSecure'NonNullableEnumChallenge) = "challenge"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "challenge" -> InvoicePaymentMethodOptionsCardRequestThreeDSecure'NonNullableEnumChallenge
