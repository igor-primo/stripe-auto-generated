...
data Refund = Refund
  { -- | amount: Amount, in cents (or local equivalent).
    ...
    refundPendingReason :: (GHC.Maybe.Maybe RefundPendingReason'),
    -- | presentment_details:
    refundPresentmentDetails :: (GHC.Maybe.Maybe PaymentFlowsPaymentIntentPresentmentDetails),
...
mkRefund refundAmount refundCreated refundCurrency refundId =
  Refund
    { refundAmount = refundAmount,
      ...
      refundPendingReason = GHC.Maybe.Nothing,
      refundPresentmentDetails = GHC.Maybe.Nothing,
...
data RefundPendingReason'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    RefundPendingReason'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    RefundPendingReason'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"charge_pending"@
    RefundPendingReason'EnumChargePending
  | -- | Represents the JSON value @"insufficient_funds"@
    RefundPendingReason'EnumInsufficientFunds
  | -- | Represents the JSON value @"processing"@
    RefundPendingReason'EnumProcessing
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON RefundPendingReason' where
  toJSON (RefundPendingReason'Other val) = val
  toJSON (RefundPendingReason'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (RefundPendingReason'EnumChargePending) = "charge_pending"
  toJSON (RefundPendingReason'EnumInsufficientFunds) = "insufficient_funds"
  toJSON (RefundPendingReason'EnumProcessing) = "processing"

instance Data.Aeson.Types.FromJSON.FromJSON RefundPendingReason' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "charge_pending" -> RefundPendingReason'EnumChargePending
          | val GHC.Classes.== "insufficient_funds" -> RefundPendingReason'EnumInsufficientFunds
          | val GHC.Classes.== "processing" -> RefundPendingReason'EnumProcessing
          | GHC.Base.otherwise -> RefundPendingReason'Other val
      )
