...
data PaymentMethodDetailsP24Bank'NonNullable
  ...
  | -- | Represents the JSON value @"velobank"@
    PaymentMethodDetailsP24Bank'NonNullableEnumVelobank
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsP24Bank'NonNullable where
  ...
  toJSON (PaymentMethodDetailsP24Bank'NonNullableEnumVelobank) = "velobank"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "velobank" -> PaymentMethodDetailsP24Bank'NonNullableEnumVelobank
