...
data SubscriptionsResourcePaymentMethodOptions = SubscriptionsResourcePaymentMethodOptions
  { -- | acss_debit: This sub-hash contains details about the Canadian pre-authorized debit payment method options to pass to invoices created by the subscription.
    ...
    subscriptionsResourcePaymentMethodOptionsSepaDebit :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Aeson.Types.Internal.Object)),
...
mkSubscriptionsResourcePaymentMethodOptions =
  SubscriptionsResourcePaymentMethodOptions
    { subscriptionsResourcePaymentMethodOptionsAcssDebit = GHC.Maybe.Nothing,
      ...
      subscriptionsResourcePaymentMethodOptionsSepaDebit = GHC.Maybe.Nothing,
...
data SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullable
  ...
  | -- | Represents the JSON value @"girocard"@
    SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableEnumGirocard
  ...
  | -- | Represents the JSON value @"link"@
    SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableEnumLink
...
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullable where
  ...
  toJSON (SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableEnumGirocard) = "girocard"
  ...
  toJSON (SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableEnumLink) = "link"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "girocard" -> SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableEnumGirocard
          ...
          | val GHC.Classes.== "link" -> SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableEnumLink
...
data SubscriptionsResourcePaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullable
  ...
  | -- | Represents the JSON value @"challenge"@
    SubscriptionsResourcePaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullableEnumChallenge
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionsResourcePaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullable where
  ...
  toJSON (SubscriptionsResourcePaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullableEnumChallenge) = "challenge"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "challenge" -> SubscriptionsResourcePaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullableEnumChallenge
