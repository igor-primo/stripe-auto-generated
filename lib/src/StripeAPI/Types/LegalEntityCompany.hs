...
import {-# SOURCE #-} StripeAPI.Types.LegalEntityDirectorshipDeclaration
import {-# SOURCE #-} StripeAPI.Types.LegalEntityJapanAddress
import {-# SOURCE #-} StripeAPI.Types.LegalEntityRegistrationDate
...
data LegalEntityCompany = LegalEntityCompany
  { -- | address:
    ...
    legalEntityCompanyDirectorshipDeclaration :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable LegalEntityCompanyDirectorshipDeclaration'NonNullable)),
    ...
    legalEntityCompanyOwnershipExemptionReason :: (GHC.Maybe.Maybe LegalEntityCompanyOwnershipExemptionReason'),
    ...
    -- | registration_date:
    legalEntityCompanyRegistrationDate :: (GHC.Maybe.Maybe LegalEntityRegistrationDate),
...
mkLegalEntityCompany =
  LegalEntityCompany
    { legalEntityCompanyAddress = GHC.Maybe.Nothing,
      ...
      legalEntityCompanyDirectorshipDeclaration = GHC.Maybe.Nothing,
      ...
      legalEntityCompanyOwnershipExemptionReason = GHC.Maybe.Nothing,
      legalEntityCompanyPhone = GHC.Maybe.Nothing,
      legalEntityCompanyRegistrationDate = GHC.Maybe.Nothing,
...
data LegalEntityCompanyDirectorshipDeclaration'NonNullable = LegalEntityCompanyDirectorshipDeclaration'NonNullable
  { -- | date: The Unix timestamp marking when the directorship declaration attestation was made.
    legalEntityCompanyDirectorshipDeclaration'NonNullableDate :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable GHC.Types.Int)),
    -- | ip: The IP address from which the directorship declaration attestation was made.
    --
    -- Constraints:
    --
    -- * Maximum length of 5000
    legalEntityCompanyDirectorshipDeclaration'NonNullableIp :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text)),
    -- | user_agent: The user-agent string from the browser where the directorship declaration attestation was made.
    --
    -- Constraints:
    --
    -- * Maximum length of 5000
    legalEntityCompanyDirectorshipDeclaration'NonNullableUserAgent :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text))
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON LegalEntityCompanyDirectorshipDeclaration'NonNullable where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("date" Data.Aeson.Types.ToJSON..=)) (legalEntityCompanyDirectorshipDeclaration'NonNullableDate obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ip" Data.Aeson.Types.ToJSON..=)) (legalEntityCompanyDirectorshipDeclaration'NonNullableIp obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("user_agent" Data.Aeson.Types.ToJSON..=)) (legalEntityCompanyDirectorshipDeclaration'NonNullableUserAgent obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("date" Data.Aeson.Types.ToJSON..=)) (legalEntityCompanyDirectorshipDeclaration'NonNullableDate obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ip" Data.Aeson.Types.ToJSON..=)) (legalEntityCompanyDirectorshipDeclaration'NonNullableIp obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("user_agent" Data.Aeson.Types.ToJSON..=)) (legalEntityCompanyDirectorshipDeclaration'NonNullableUserAgent obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON LegalEntityCompanyDirectorshipDeclaration'NonNullable where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "LegalEntityCompanyDirectorshipDeclaration'NonNullable" (\obj -> ((GHC.Base.pure LegalEntityCompanyDirectorshipDeclaration'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ip")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "user_agent"))

-- | Create a new 'LegalEntityCompanyDirectorshipDeclaration'NonNullable' with all required fields.
mkLegalEntityCompanyDirectorshipDeclaration'NonNullable :: LegalEntityCompanyDirectorshipDeclaration'NonNullable
mkLegalEntityCompanyDirectorshipDeclaration'NonNullable =
  LegalEntityCompanyDirectorshipDeclaration'NonNullable
    { legalEntityCompanyDirectorshipDeclaration'NonNullableDate = GHC.Maybe.Nothing,
      legalEntityCompanyDirectorshipDeclaration'NonNullableIp = GHC.Maybe.Nothing,
      legalEntityCompanyDirectorshipDeclaration'NonNullableUserAgent = GHC.Maybe.Nothing
    }
...
data LegalEntityCompanyOwnershipExemptionReason'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    LegalEntityCompanyOwnershipExemptionReason'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    LegalEntityCompanyOwnershipExemptionReason'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"qualified_entity_exceeds_ownership_threshold"@
    LegalEntityCompanyOwnershipExemptionReason'EnumQualifiedEntityExceedsOwnershipThreshold
  | -- | Represents the JSON value @"qualifies_as_financial_institution"@
    LegalEntityCompanyOwnershipExemptionReason'EnumQualifiesAsFinancialInstitution
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON LegalEntityCompanyOwnershipExemptionReason' where
  toJSON (LegalEntityCompanyOwnershipExemptionReason'Other val) = val
  toJSON (LegalEntityCompanyOwnershipExemptionReason'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (LegalEntityCompanyOwnershipExemptionReason'EnumQualifiedEntityExceedsOwnershipThreshold) = "qualified_entity_exceeds_ownership_threshold"
  toJSON (LegalEntityCompanyOwnershipExemptionReason'EnumQualifiesAsFinancialInstitution) = "qualifies_as_financial_institution"

instance Data.Aeson.Types.FromJSON.FromJSON LegalEntityCompanyOwnershipExemptionReason' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "qualified_entity_exceeds_ownership_threshold" -> LegalEntityCompanyOwnershipExemptionReason'EnumQualifiedEntityExceedsOwnershipThreshold
          | val GHC.Classes.== "qualifies_as_financial_institution" -> LegalEntityCompanyOwnershipExemptionReason'EnumQualifiesAsFinancialInstitution
          | GHC.Base.otherwise -> LegalEntityCompanyOwnershipExemptionReason'Other val
      )
...
data LegalEntityCompanyStructure'
  ...
  | -- | Represents the JSON value @"registered_charity"@
    LegalEntityCompanyStructure'EnumRegisteredCharity
...
instance Data.Aeson.Types.ToJSON.ToJSON LegalEntityCompanyStructure' where
  ...
  toJSON (LegalEntityCompanyStructure'EnumRegisteredCharity) = "registered_charity"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "registered_charity" -> LegalEntityCompanyStructure'EnumRegisteredCharity
