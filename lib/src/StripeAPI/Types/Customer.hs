...
data CustomerDiscount'NonNullable = CustomerDiscount'NonNullable
  { -- | checkout_session: The Checkout session that this coupon is applied to, if it is applied to a particular session in payment mode. Will not be present for subscription mode.
    ...
    --
    -- * Maximum length of 5000
    customerDiscount'NonNullableSubscriptionItem :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text))
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
mkCustomerDiscount'NonNullable =
  CustomerDiscount'NonNullable
    { customerDiscount'NonNullableCheckoutSession = GHC.Maybe.Nothing,
      ...
      customerDiscount'NonNullableSubscriptionItem = GHC.Maybe.Nothing
    }
...
data CustomerSources'Data' = CustomerSources'Data'
  { -- | account: The account this bank account belongs to. Only applicable on Accounts (not customers or recipients) This property is only available when returned as an [External Account](\/api\/external_account_bank_accounts\/object) where [controller.is_controller](\/api\/accounts\/object\#account_object-controller-is_controller) is \`true\`.
    ...
    customerSources'Data'AllowRedisplay :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable CustomerSources'Data'AllowRedisplay'NonNullable)),
    ...
    --
    -- * Maximum length of 5000
    customerSources'Data'Iin :: (GHC.Maybe.Maybe Data.Text.Internal.Text),
    -- | klarna
    ...
    -- | networks:
    customerSources'Data'Networks :: (GHC.Maybe.Maybe TokenCardNetworks),
    -- | object: String representing the object\'s type. Objects of the same type share the same value.
    ...
    customerSources'Data'RegulatedStatus :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable CustomerSources'Data'RegulatedStatus'NonNullable)),
...
mkCustomerSources'Data' =
  CustomerSources'Data'
    { customerSources'Data'Account = GHC.Maybe.Nothing,
      ...
      customerSources'Data'AllowRedisplay = GHC.Maybe.Nothing,
      ...
      customerSources'Data'Iin = GHC.Maybe.Nothing,
      ...
      customerSources'Data'Networks = GHC.Maybe.Nothing,
      ...
      customerSources'Data'RegulatedStatus = GHC.Maybe.Nothing,
...
data CustomerSources'Data'AllowRedisplay'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    CustomerSources'Data'AllowRedisplay'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    CustomerSources'Data'AllowRedisplay'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"always"@
    CustomerSources'Data'AllowRedisplay'NonNullableEnumAlways
  | -- | Represents the JSON value @"limited"@
    CustomerSources'Data'AllowRedisplay'NonNullableEnumLimited
  | -- | Represents the JSON value @"unspecified"@
    CustomerSources'Data'AllowRedisplay'NonNullableEnumUnspecified
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON CustomerSources'Data'AllowRedisplay'NonNullable where
  toJSON (CustomerSources'Data'AllowRedisplay'NonNullableOther val) = val
  toJSON (CustomerSources'Data'AllowRedisplay'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (CustomerSources'Data'AllowRedisplay'NonNullableEnumAlways) = "always"
  toJSON (CustomerSources'Data'AllowRedisplay'NonNullableEnumLimited) = "limited"
  toJSON (CustomerSources'Data'AllowRedisplay'NonNullableEnumUnspecified) = "unspecified"

instance Data.Aeson.Types.FromJSON.FromJSON CustomerSources'Data'AllowRedisplay'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "always" -> CustomerSources'Data'AllowRedisplay'NonNullableEnumAlways
          | val GHC.Classes.== "limited" -> CustomerSources'Data'AllowRedisplay'NonNullableEnumLimited
          | val GHC.Classes.== "unspecified" -> CustomerSources'Data'AllowRedisplay'NonNullableEnumUnspecified
          | GHC.Base.otherwise -> CustomerSources'Data'AllowRedisplay'NonNullableOther val
      )
...
data CustomerSources'Data'RegulatedStatus'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    CustomerSources'Data'RegulatedStatus'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    CustomerSources'Data'RegulatedStatus'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"regulated"@
    CustomerSources'Data'RegulatedStatus'NonNullableEnumRegulated
  | -- | Represents the JSON value @"unregulated"@
    CustomerSources'Data'RegulatedStatus'NonNullableEnumUnregulated
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON CustomerSources'Data'RegulatedStatus'NonNullable where
  toJSON (CustomerSources'Data'RegulatedStatus'NonNullableOther val) = val
  toJSON (CustomerSources'Data'RegulatedStatus'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (CustomerSources'Data'RegulatedStatus'NonNullableEnumRegulated) = "regulated"
  toJSON (CustomerSources'Data'RegulatedStatus'NonNullableEnumUnregulated) = "unregulated"

instance Data.Aeson.Types.FromJSON.FromJSON CustomerSources'Data'RegulatedStatus'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "regulated" -> CustomerSources'Data'RegulatedStatus'NonNullableEnumRegulated
          | val GHC.Classes.== "unregulated" -> CustomerSources'Data'RegulatedStatus'NonNullableEnumUnregulated
          | GHC.Base.otherwise -> CustomerSources'Data'RegulatedStatus'NonNullableOther val
      )
