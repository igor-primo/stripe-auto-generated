...
data SubscriptionPaymentMethodOptionsCardNetwork'NonNullable
  ...
  | -- | Represents the JSON value @"girocard"@
    SubscriptionPaymentMethodOptionsCardNetwork'NonNullableEnumGirocard
  ...
  | -- | Represents the JSON value @"link"@
    SubscriptionPaymentMethodOptionsCardNetwork'NonNullableEnumLink
...
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionPaymentMethodOptionsCardNetwork'NonNullable where
  ...
  toJSON (SubscriptionPaymentMethodOptionsCardNetwork'NonNullableEnumGirocard) = "girocard"
  ...
  toJSON (SubscriptionPaymentMethodOptionsCardNetwork'NonNullableEnumLink) = "link"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "girocard" -> SubscriptionPaymentMethodOptionsCardNetwork'NonNullableEnumGirocard
          ...
          | val GHC.Classes.== "link" -> SubscriptionPaymentMethodOptionsCardNetwork'NonNullableEnumLink
...
data SubscriptionPaymentMethodOptionsCardRequestThreeDSecure'NonNullable
  ...
  | -- | Represents the JSON value @"challenge"@
    SubscriptionPaymentMethodOptionsCardRequestThreeDSecure'NonNullableEnumChallenge
  deriving (GHC.Show.Show, GHC.Classes.Eq)
