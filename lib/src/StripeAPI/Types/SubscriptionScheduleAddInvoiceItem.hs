...
import {-# SOURCE #-} StripeAPI.Types.SubscriptionScheduleAddInvoiceItemPeriod
...
data SubscriptionScheduleAddInvoiceItem = SubscriptionScheduleAddInvoiceItem
  { -- | discounts: The stackable discounts that will be applied to the item.
    subscriptionScheduleAddInvoiceItemDiscounts :: [DiscountsResourceStackableDiscount],
    -- | metadata: Set of [key-value pairs](https:\/\/stripe.com\/docs\/api\/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format.
    subscriptionScheduleAddInvoiceItemMetadata :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Aeson.Types.Internal.Object)),
    -- | period:
    subscriptionScheduleAddInvoiceItemPeriod :: SubscriptionScheduleAddInvoiceItemPeriod,
...
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionScheduleAddInvoiceItem where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["discounts" Data.Aeson.Types.ToJSON..= subscriptionScheduleAddInvoiceItemDiscounts obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("metadata" Data.Aeson.Types.ToJSON..=)) (subscriptionScheduleAddInvoiceItemMetadata obj) : ["period" Data.Aeson.Types.ToJSON..= subscriptionScheduleAddInvoiceItemPeriod obj] : ["price" Data.Aeson.Types.ToJSON..= subscriptionScheduleAddInvoiceItemPrice obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("quantity" Data.Aeson.Types.ToJSON..=)) (subscriptionScheduleAddInvoiceItemQuantity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("tax_rates" Data.Aeson.Types.ToJSON..=)) (subscriptionScheduleAddInvoiceItemTaxRates obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["discounts" Data.Aeson.Types.ToJSON..= subscriptionScheduleAddInvoiceItemDiscounts obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("metadata" Data.Aeson.Types.ToJSON..=)) (subscriptionScheduleAddInvoiceItemMetadata obj) : ["period" Data.Aeson.Types.ToJSON..= subscriptionScheduleAddInvoiceItemPeriod obj] : ["price" Data.Aeson.Types.ToJSON..= subscriptionScheduleAddInvoiceItemPrice obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("quantity" Data.Aeson.Types.ToJSON..=)) (subscriptionScheduleAddInvoiceItemQuantity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("tax_rates" Data.Aeson.Types.ToJSON..=)) (subscriptionScheduleAddInvoiceItemTaxRates obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionScheduleAddInvoiceItem where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "SubscriptionScheduleAddInvoiceItem" (\obj -> (((((GHC.Base.pure SubscriptionScheduleAddInvoiceItem GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "discounts")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "period")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "price")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "quantity")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_rates"))

-- | Create a new 'SubscriptionScheduleAddInvoiceItem' with all required fields.
mkSubscriptionScheduleAddInvoiceItem ::
  -- | 'subscriptionScheduleAddInvoiceItemDiscounts'
...
mkSubscriptionScheduleAddInvoiceItem subscriptionScheduleAddInvoiceItemDiscounts subscriptionScheduleAddInvoiceItemPeriod subscriptionScheduleAddInvoiceItemPrice =
  SubscriptionScheduleAddInvoiceItem
    { subscriptionScheduleAddInvoiceItemDiscounts = subscriptionScheduleAddInvoiceItemDiscounts,
      subscriptionScheduleAddInvoiceItemMetadata = GHC.Maybe.Nothing,
      subscriptionScheduleAddInvoiceItemPeriod = subscriptionScheduleAddInvoiceItemPeriod,
