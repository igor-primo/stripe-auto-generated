...
data PaymentMethodDetails = PaymentMethodDetails
  { -- | ach_credit_transfer:
    ...
    -- | alma:
    paymentMethodDetailsAlma :: (GHC.Maybe.Maybe PaymentMethodDetailsAlma),
    -- | amazon_pay:
    paymentMethodDetailsAmazonPay :: (GHC.Maybe.Maybe PaymentMethodDetailsAmazonPay),
    -- | au_becs_debit:
    ...
    -- | billie:
    paymentMethodDetailsBillie :: (GHC.Maybe.Maybe PaymentMethodDetailsBillie),
    -- | blik:
    ...
    -- | crypto:
    paymentMethodDetailsCrypto :: (GHC.Maybe.Maybe PaymentMethodDetailsCrypto),
    -- | customer_balance:
    ...
    -- | kakao_pay:
    paymentMethodDetailsKakaoPay :: (GHC.Maybe.Maybe PaymentMethodDetailsKakaoPay),
    -- | klarna:
    ...
    -- | kr_card:
    paymentMethodDetailsKrCard :: (GHC.Maybe.Maybe PaymentMethodDetailsKrCard),
    -- | link:
    paymentMethodDetailsLink :: (GHC.Maybe.Maybe PaymentMethodDetailsLink),
    -- | mobilepay:
    paymentMethodDetailsMobilepay :: (GHC.Maybe.Maybe PaymentMethodDetailsMobilepay),
    -- | multibanco:
    paymentMethodDetailsMultibanco :: (GHC.Maybe.Maybe PaymentMethodDetailsMultibanco),
    -- | naver_pay:
    paymentMethodDetailsNaverPay :: (GHC.Maybe.Maybe PaymentMethodDetailsNaverPay),
    -- | nz_bank_account:
    paymentMethodDetailsNzBankAccount :: (GHC.Maybe.Maybe PaymentMethodDetailsNzBankAccount),
    -- | oxxo:
    ...
    -- | pay_by_bank:
    paymentMethodDetailsPayByBank :: (GHC.Maybe.Maybe PaymentMethodDetailsPayByBank),
    -- | payco:
    paymentMethodDetailsPayco :: (GHC.Maybe.Maybe PaymentMethodDetailsPayco),
    -- | paynow:
    ...
    -- | samsung_pay:
    paymentMethodDetailsSamsungPay :: (GHC.Maybe.Maybe PaymentMethodDetailsSamsungPay),
    -- | satispay:
    paymentMethodDetailsSatispay :: (GHC.Maybe.Maybe PaymentMethodDetailsSatispay),
    -- | sepa_debit:
    ...
    -- | swish:
    paymentMethodDetailsSwish :: (GHC.Maybe.Maybe PaymentMethodDetailsSwish),
    -- | twint:
    paymentMethodDetailsTwint :: (GHC.Maybe.Maybe PaymentMethodDetailsTwint),
...
mkPaymentMethodDetails paymentMethodDetailsType =
  PaymentMethodDetails
    { paymentMethodDetailsAchCreditTransfer = GHC.Maybe.Nothing,
      ...
      paymentMethodDetailsAlma = GHC.Maybe.Nothing,
      paymentMethodDetailsAmazonPay = GHC.Maybe.Nothing,
      ...
      paymentMethodDetailsBillie = GHC.Maybe.Nothing,
      ...
      paymentMethodDetailsCrypto = GHC.Maybe.Nothing,
      ...
      paymentMethodDetailsKakaoPay = GHC.Maybe.Nothing,
      paymentMethodDetailsKlarna = GHC.Maybe.Nothing,
      paymentMethodDetailsKonbini = GHC.Maybe.Nothing,
      paymentMethodDetailsKrCard = GHC.Maybe.Nothing,
      paymentMethodDetailsLink = GHC.Maybe.Nothing,
      paymentMethodDetailsMobilepay = GHC.Maybe.Nothing,
      paymentMethodDetailsMultibanco = GHC.Maybe.Nothing,
      paymentMethodDetailsNaverPay = GHC.Maybe.Nothing,
      paymentMethodDetailsNzBankAccount = GHC.Maybe.Nothing,
      paymentMethodDetailsOxxo = GHC.Maybe.Nothing,
      paymentMethodDetailsP24 = GHC.Maybe.Nothing,
      paymentMethodDetailsPayByBank = GHC.Maybe.Nothing,
      paymentMethodDetailsPayco = GHC.Maybe.Nothing,
      ...
      paymentMethodDetailsSamsungPay = GHC.Maybe.Nothing,
      paymentMethodDetailsSatispay = GHC.Maybe.Nothing,
      ...
      paymentMethodDetailsSwish = GHC.Maybe.Nothing,
      paymentMethodDetailsTwint = GHC.Maybe.Nothing,
