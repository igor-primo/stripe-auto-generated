...
import {-# SOURCE #-} StripeAPI.Types.IssuingDisputeNoValidAuthorizationEvidence
...
data IssuingDisputeEvidence = IssuingDisputeEvidence
  { -- | canceled:
    ...
    issuingDisputeEvidenceNoValidAuthorization :: (GHC.Maybe.Maybe IssuingDisputeNoValidAuthorizationEvidence),
    -- | not_received:
...
mkIssuingDisputeEvidence issuingDisputeEvidenceReason =
  IssuingDisputeEvidence
    { issuingDisputeEvidenceCanceled = GHC.Maybe.Nothing,
      ...
      issuingDisputeEvidenceNoValidAuthorization = GHC.Maybe.Nothing,
...
data IssuingDisputeEvidenceReason'
  ...
  | -- | Represents the JSON value @"no_valid_authorization"@
    IssuingDisputeEvidenceReason'EnumNoValidAuthorization
...
instance Data.Aeson.Types.ToJSON.ToJSON IssuingDisputeEvidenceReason' where
  ...
  toJSON (IssuingDisputeEvidenceReason'EnumNoValidAuthorization) = "no_valid_authorization"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "no_valid_authorization" -> IssuingDisputeEvidenceReason'EnumNoValidAuthorization
