...
data SubscriptionSchedule = SubscriptionSchedule
  { -- | application: ID of the Connect Application that created the schedule.
    ...
    subscriptionScheduleBillingMode :: SubscriptionsResourceBillingMode,
...
mkSubscriptionSchedule subscriptionScheduleBillingMode subscriptionScheduleCreated subscriptionScheduleCustomer subscriptionScheduleDefaultSettings subscriptionScheduleEndBehavior subscriptionScheduleId subscriptionScheduleLivemode subscriptionSchedulePhases subscriptionScheduleStatus =
  SubscriptionSchedule
    { subscriptionScheduleApplication = GHC.Maybe.Nothing,
      subscriptionScheduleBillingMode = subscriptionScheduleBillingMode,
