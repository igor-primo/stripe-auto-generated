...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodOptionsCustomerBalance where
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodOptionsCustomerBalance where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodOptionsCustomerBalance" (\obj -> ((GHC.Base.pure PaymentMethodOptionsCustomerBalance GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "bank_transfer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "funding_type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "setup_future_usage"))
...
mkPaymentMethodOptionsCustomerBalance =
  PaymentMethodOptionsCustomerBalance
    { paymentMethodOptionsCustomerBalanceBankTransfer = GHC.Maybe.Nothing,
...
data PaymentMethodOptionsCustomerBalanceFundingType'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    PaymentMethodOptionsCustomerBalanceFundingType'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    PaymentMethodOptionsCustomerBalanceFundingType'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"bank_transfer"@
    PaymentMethodOptionsCustomerBalanceFundingType'NonNullableEnumBankTransfer
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodOptionsCustomerBalanceFundingType'NonNullable where
  toJSON (PaymentMethodOptionsCustomerBalanceFundingType'NonNullableOther val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodOptionsCustomerBalanceFundingType'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
...
data PaymentMethodOptionsCustomerBalanceSetupFutureUsage'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    PaymentMethodOptionsCustomerBalanceSetupFutureUsage'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    PaymentMethodOptionsCustomerBalanceSetupFutureUsage'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"none"@
    PaymentMethodOptionsCustomerBalanceSetupFutureUsage'EnumNone
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodOptionsCustomerBalanceSetupFutureUsage' where
  toJSON (PaymentMethodOptionsCustomerBalanceSetupFutureUsage'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodOptionsCustomerBalanceSetupFutureUsage' where
  parseJSON val =
    GHC.Base.pure
      ( if
