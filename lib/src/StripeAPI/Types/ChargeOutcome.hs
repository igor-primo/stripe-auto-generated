...
data ChargeOutcome = ChargeOutcome
  { -- | advice_code: An enumerated value providing a more detailed explanation on [how to proceed with an error](https:\/\/stripe.com\/docs\/declines\#retrying-issuer-declines).
    chargeOutcomeAdviceCode :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable ChargeOutcomeAdviceCode'NonNullable)),
    ...
    chargeOutcomeNetworkAdviceCode :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text)),
    ...
    --
    -- * Maximum length of 5000
    chargeOutcomeNetworkDeclineCode :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text)),
...
mkChargeOutcome chargeOutcomeType =
  ChargeOutcome
    { chargeOutcomeAdviceCode = GHC.Maybe.Nothing,
      chargeOutcomeNetworkAdviceCode = GHC.Maybe.Nothing,
      chargeOutcomeNetworkDeclineCode = GHC.Maybe.Nothing,
...
data ChargeOutcomeAdviceCode'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    ChargeOutcomeAdviceCode'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    ChargeOutcomeAdviceCode'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"confirm_card_data"@
    ChargeOutcomeAdviceCode'NonNullableEnumConfirmCardData
  | -- | Represents the JSON value @"do_not_try_again"@
    ChargeOutcomeAdviceCode'NonNullableEnumDoNotTryAgain
  | -- | Represents the JSON value @"try_again_later"@
    ChargeOutcomeAdviceCode'NonNullableEnumTryAgainLater
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON ChargeOutcomeAdviceCode'NonNullable where
  toJSON (ChargeOutcomeAdviceCode'NonNullableOther val) = val
  toJSON (ChargeOutcomeAdviceCode'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (ChargeOutcomeAdviceCode'NonNullableEnumConfirmCardData) = "confirm_card_data"
  toJSON (ChargeOutcomeAdviceCode'NonNullableEnumDoNotTryAgain) = "do_not_try_again"
  toJSON (ChargeOutcomeAdviceCode'NonNullableEnumTryAgainLater) = "try_again_later"

instance Data.Aeson.Types.FromJSON.FromJSON ChargeOutcomeAdviceCode'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "confirm_card_data" -> ChargeOutcomeAdviceCode'NonNullableEnumConfirmCardData
          | val GHC.Classes.== "do_not_try_again" -> ChargeOutcomeAdviceCode'NonNullableEnumDoNotTryAgain
          | val GHC.Classes.== "try_again_later" -> ChargeOutcomeAdviceCode'NonNullableEnumTryAgainLater
          | GHC.Base.otherwise -> ChargeOutcomeAdviceCode'NonNullableOther val
      )
