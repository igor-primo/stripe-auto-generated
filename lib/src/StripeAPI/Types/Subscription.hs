...
import {-# SOURCE #-} StripeAPI.Types.SubscriptionsResourceBillingCycleAnchorConfig
import {-# SOURCE #-} StripeAPI.Types.SubscriptionsResourceBillingMode
...
import {-# SOURCE #-} StripeAPI.Types.SubscriptionsResourceSubscriptionInvoiceSettings
...
data Subscription = Subscription
  { -- | application: ID of the Connect Application that created the subscription.
    ...
    subscriptionBillingCycleAnchorConfig :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable SubscriptionBillingCycleAnchorConfig'NonNullable)),
    -- | billing_mode: The billing mode of the subscription.
    subscriptionBillingMode :: SubscriptionsResourceBillingMode,
    ...
    subscriptionDiscounts :: [SubscriptionDiscounts'Variants],
    ...
    -- | invoice_settings:
    subscriptionInvoiceSettings :: SubscriptionsResourceSubscriptionInvoiceSettings,
...
mkSubscription ::
  ...
  [SubscriptionDiscounts'Variants] ->
  -- | 'subscriptionId'
  Data.Text.Internal.Text ->
  ...
  SubscriptionStatus' ->
  Subscription
mkSubscription subscriptionAutomaticTax subscriptionBillingCycleAnchor subscriptionBillingMode subscriptionCancelAtPeriodEnd subscriptionCollectionMethod subscriptionCreated subscriptionCurrency subscriptionCustomer subscriptionDiscounts subscriptionId subscriptionInvoiceSettings subscriptionItems subscriptionLivemode subscriptionMetadata subscriptionStartDate subscriptionStatus =
  Subscription
    { subscriptionApplication = GHC.Maybe.Nothing,
      ...
      subscriptionBillingCycleAnchorConfig = GHC.Maybe.Nothing,
...
data SubscriptionBillingCycleAnchorConfig'NonNullable = SubscriptionBillingCycleAnchorConfig'NonNullable
  { -- | day_of_month: The day of the month of the billing_cycle_anchor.
    subscriptionBillingCycleAnchorConfig'NonNullableDayOfMonth :: (GHC.Maybe.Maybe GHC.Types.Int),
    -- | hour: The hour of the day of the billing_cycle_anchor.
    subscriptionBillingCycleAnchorConfig'NonNullableHour :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable GHC.Types.Int)),
    -- | minute: The minute of the hour of the billing_cycle_anchor.
    subscriptionBillingCycleAnchorConfig'NonNullableMinute :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable GHC.Types.Int)),
    -- | month: The month to start full cycle billing periods.
    subscriptionBillingCycleAnchorConfig'NonNullableMonth :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable GHC.Types.Int)),
    -- | second: The second of the minute of the billing_cycle_anchor.
    subscriptionBillingCycleAnchorConfig'NonNullableSecond :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable GHC.Types.Int))
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionBillingCycleAnchorConfig'NonNullable where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("day_of_month" Data.Aeson.Types.ToJSON..=)) (subscriptionBillingCycleAnchorConfig'NonNullableDayOfMonth obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("hour" Data.Aeson.Types.ToJSON..=)) (subscriptionBillingCycleAnchorConfig'NonNullableHour obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("minute" Data.Aeson.Types.ToJSON..=)) (subscriptionBillingCycleAnchorConfig'NonNullableMinute obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("month" Data.Aeson.Types.ToJSON..=)) (subscriptionBillingCycleAnchorConfig'NonNullableMonth obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("second" Data.Aeson.Types.ToJSON..=)) (subscriptionBillingCycleAnchorConfig'NonNullableSecond obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("day_of_month" Data.Aeson.Types.ToJSON..=)) (subscriptionBillingCycleAnchorConfig'NonNullableDayOfMonth obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("hour" Data.Aeson.Types.ToJSON..=)) (subscriptionBillingCycleAnchorConfig'NonNullableHour obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("minute" Data.Aeson.Types.ToJSON..=)) (subscriptionBillingCycleAnchorConfig'NonNullableMinute obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("month" Data.Aeson.Types.ToJSON..=)) (subscriptionBillingCycleAnchorConfig'NonNullableMonth obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("second" Data.Aeson.Types.ToJSON..=)) (subscriptionBillingCycleAnchorConfig'NonNullableSecond obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionBillingCycleAnchorConfig'NonNullable where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "SubscriptionBillingCycleAnchorConfig'NonNullable" (\obj -> ((((GHC.Base.pure SubscriptionBillingCycleAnchorConfig'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "day_of_month")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "hour")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "minute")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "month")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "second"))

-- | Create a new 'SubscriptionBillingCycleAnchorConfig'NonNullable' with all required fields.
mkSubscriptionBillingCycleAnchorConfig'NonNullable :: SubscriptionBillingCycleAnchorConfig'NonNullable
mkSubscriptionBillingCycleAnchorConfig'NonNullable =
  SubscriptionBillingCycleAnchorConfig'NonNullable
    { subscriptionBillingCycleAnchorConfig'NonNullableDayOfMonth = GHC.Maybe.Nothing,
      subscriptionBillingCycleAnchorConfig'NonNullableHour = GHC.Maybe.Nothing,
      subscriptionBillingCycleAnchorConfig'NonNullableMinute = GHC.Maybe.Nothing,
      subscriptionBillingCycleAnchorConfig'NonNullableMonth = GHC.Maybe.Nothing,
      subscriptionBillingCycleAnchorConfig'NonNullableSecond = GHC.Maybe.Nothing
    }
...
data SubscriptionDiscounts'Variants
  = SubscriptionDiscounts'Text Data.Text.Internal.Text
  | SubscriptionDiscounts'Discount Discount
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionDiscounts'Variants where
  toJSON (SubscriptionDiscounts'Text a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (SubscriptionDiscounts'Discount a) = Data.Aeson.Types.ToJSON.toJSON a

instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionDiscounts'Variants where
  parseJSON val = case (SubscriptionDiscounts'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((SubscriptionDiscounts'Discount Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
    Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a
    Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a
...
data SubscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullable = SubscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullable
  { -- | acss_debit: This sub-hash contains details about the Canadian pre-authorized debit payment method options to pass to invoices created by the subscription.
    ...
    subscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullableSepaDebit :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Aeson.Types.Internal.Object)),
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullable where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "SubscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullable" (\obj -> ((((((GHC.Base.pure SubscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "acss_debit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "bancontact")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "card")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "customer_balance")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "konbini")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "sepa_debit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "us_bank_account"))
...
mkSubscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullable =
  SubscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullable
    { subscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullableAcssDebit = GHC.Maybe.Nothing,
      ...
      subscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullableSepaDebit = GHC.Maybe.Nothing,
...
data SubscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullable
  ...
  | -- | Represents the JSON value @"girocard"@
    SubscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableEnumGirocard
  ...
  | -- | Represents the JSON value @"link"@
    SubscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableEnumLink
...
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullable where
  ...
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableEnumGirocard) = "girocard"
  ...
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableEnumLink) = "link"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "girocard" -> SubscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableEnumGirocard
          ...
          | val GHC.Classes.== "link" -> SubscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableEnumLink
...
data SubscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullableCard'NonNullableRequestThreeDSecure'NonNullable
  ...
  | -- | Represents the JSON value @"challenge"@
    SubscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullableCard'NonNullableRequestThreeDSecure'NonNullableEnumChallenge
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullableCard'NonNullableRequestThreeDSecure'NonNullable where
  ...
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullableCard'NonNullableRequestThreeDSecure'NonNullableEnumChallenge) = "challenge"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "challenge" -> SubscriptionPaymentSettings'NonNullablePaymentMethodOptions'NonNullableCard'NonNullableRequestThreeDSecure'NonNullableEnumChallenge
...
data SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullable
  ...
  | -- | Represents the JSON value @"affirm"@
    SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumAffirm
  | -- | Represents the JSON value @"amazon_pay"@
    SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumAmazonPay
  ...
  | -- | Represents the JSON value @"crypto"@
    SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumCrypto
  ...
  | -- | Represents the JSON value @"eps"@
    SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumEps
  ...
  | -- | Represents the JSON value @"jp_credit_transfer"@
    SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumJpCreditTransfer
  | -- | Represents the JSON value @"kakao_pay"@
    SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumKakaoPay
  | -- | Represents the JSON value @"klarna"@
    SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumKlarna
  ...
  | -- | Represents the JSON value @"kr_card"@
    SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumKrCard
  | -- | Represents the JSON value @"link"@
    SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumLink
  | -- | Represents the JSON value @"multibanco"@
    SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumMultibanco
  | -- | Represents the JSON value @"naver_pay"@
    SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumNaverPay
  | -- | Represents the JSON value @"nz_bank_account"@
    SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumNzBankAccount
  | -- | Represents the JSON value @"p24"@
    SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumP24
  | -- | Represents the JSON value @"payco"@
    SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumPayco
  ...
  | -- | Represents the JSON value @"revolut_pay"@
    SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumRevolutPay
  | -- | Represents the JSON value @"sepa_credit_transfer"@
    SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumSepaCreditTransfer
  ...
  | -- | Represents the JSON value @"swish"@
    SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumSwish
...
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullable where
  ...
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumAffirm) = "affirm"
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumAmazonPay) = "amazon_pay"
  ...
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumCrypto) = "crypto"
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumCustomerBalance) = "customer_balance"
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumEps) = "eps"
  ...
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumJpCreditTransfer) = "jp_credit_transfer"
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumKakaoPay) = "kakao_pay"
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumKlarna) = "klarna"
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumKonbini) = "konbini"
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumKrCard) = "kr_card"
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumLink) = "link"
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumMultibanco) = "multibanco"
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumNaverPay) = "naver_pay"
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumNzBankAccount) = "nz_bank_account"
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumP24) = "p24"
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumPayco) = "payco"
  ...
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumRevolutPay) = "revolut_pay"
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumSepaCreditTransfer) = "sepa_credit_transfer"
  ...
  toJSON (SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumSwish) = "swish"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "affirm" -> SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumAffirm
          | val GHC.Classes.== "amazon_pay" -> SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumAmazonPay
          ...
          | val GHC.Classes.== "crypto" -> SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumCrypto
          ...
          | val GHC.Classes.== "eps" -> SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumEps
          ...
          | val GHC.Classes.== "jp_credit_transfer" -> SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumJpCreditTransfer
          | val GHC.Classes.== "kakao_pay" -> SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumKakaoPay
          | val GHC.Classes.== "klarna" -> SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumKlarna
          | val GHC.Classes.== "konbini" -> SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumKonbini
          | val GHC.Classes.== "kr_card" -> SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumKrCard
          | val GHC.Classes.== "link" -> SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumLink
          | val GHC.Classes.== "multibanco" -> SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumMultibanco
          | val GHC.Classes.== "naver_pay" -> SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumNaverPay
          | val GHC.Classes.== "nz_bank_account" -> SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumNzBankAccount
          | val GHC.Classes.== "p24" -> SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumP24
          | val GHC.Classes.== "payco" -> SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumPayco
          ...
          | val GHC.Classes.== "revolut_pay" -> SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumRevolutPay
          | val GHC.Classes.== "sepa_credit_transfer" -> SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumSepaCreditTransfer
          ...
          | val GHC.Classes.== "swish" -> SubscriptionPaymentSettings'NonNullablePaymentMethodTypes'NonNullableEnumSwish
