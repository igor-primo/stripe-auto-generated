...
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsAffirm
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsAfterpayClearpay
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsAlma
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsAmazonPay
...
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsBillie
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsBlik
...
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsCrypto
...
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsKakaoPay
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsKlarna
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsKonbini
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsKrCard
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsLink
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsMobilepay
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsMultibanco
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsNaverPay
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsNzBankAccount
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsOxxo
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsP24
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsPayco
...
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsRevolutPay
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsSamsungPay
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsSatispay
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsSepaDebit
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsSofort
import {-# SOURCE #-} StripeAPI.Types.PaymentMethodDetailsSwish
...
data Charge = Charge
  { -- | amount: Amount intended to be collected by this payment. A positive integer representing how much to charge in the [smallest currency unit](https:\/\/stripe.com\/docs\/currencies\#zero-decimal) (e.g., 100 cents to charge \$1.00 or 100 to charge ¥100, a zero-decimal currency). The minimum amount is \$0.50 US or [equivalent in charge currency](https:\/\/stripe.com\/docs\/currencies\#minimum-and-maximum-charge-amounts). The amount value supports up to eight digits (e.g., a value of 99999999 for a USD charge of \$999,999.99).
    ...
    -- | presentment_details:
    chargePresentmentDetails :: (GHC.Maybe.Maybe PaymentFlowsPaymentIntentPresentmentDetails),
...
mkCharge chargeAmount chargeAmountCaptured chargeAmountRefunded chargeBillingDetails chargeCaptured chargeCreated chargeCurrency chargeDisputed chargeId chargeLivemode chargeMetadata chargePaid chargeRefunded chargeStatus =
  Charge
    { chargeAmount = chargeAmount,
      ...
      chargePresentmentDetails = GHC.Maybe.Nothing,
...
data ChargeOutcome'NonNullable = ChargeOutcome'NonNullable
  { -- | advice_code: An enumerated value providing a more detailed explanation on [how to proceed with an error](https:\/\/stripe.com\/docs\/declines\#retrying-issuer-declines).
    chargeOutcome'NonNullableAdviceCode :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable ChargeOutcome'NonNullableAdviceCode'NonNullable)),
    ...
    --
    -- * Maximum length of 5000
    chargeOutcome'NonNullableNetworkAdviceCode :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text)),
    ...
    --
    -- * Maximum length of 5000
    chargeOutcome'NonNullableNetworkDeclineCode :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text)),
    ...
    -- | reason: An enumerated value providing a more detailed explanation of the outcome\'s \`type\`. Charges blocked by Radar\'s default block rule have the value \`highest_risk_level\`. Charges placed in review by Radar\'s default review rule have the value \`elevated_risk_level\`. Charges blocked because the payment is unlikely to be authorized have the value \`low_probability_of_authorization\`. Charges authorized, blocked, or placed in review by custom rules have the value \`rule\`. See [understanding declines](https:\/\/stripe.com\/docs\/declines) for more details.
    --
    -- Constraints:
    --
    -- * Maximum length of 5000
...
mkChargeOutcome'NonNullable =
  ChargeOutcome'NonNullable
    { chargeOutcome'NonNullableAdviceCode = GHC.Maybe.Nothing,
      chargeOutcome'NonNullableNetworkAdviceCode = GHC.Maybe.Nothing,
      chargeOutcome'NonNullableNetworkDeclineCode = GHC.Maybe.Nothing,
...
data ChargeOutcome'NonNullableAdviceCode'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    ChargeOutcome'NonNullableAdviceCode'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    ChargeOutcome'NonNullableAdviceCode'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"confirm_card_data"@
    ChargeOutcome'NonNullableAdviceCode'NonNullableEnumConfirmCardData
  | -- | Represents the JSON value @"do_not_try_again"@
    ChargeOutcome'NonNullableAdviceCode'NonNullableEnumDoNotTryAgain
  | -- | Represents the JSON value @"try_again_later"@
    ChargeOutcome'NonNullableAdviceCode'NonNullableEnumTryAgainLater
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON ChargeOutcome'NonNullableAdviceCode'NonNullable where
  toJSON (ChargeOutcome'NonNullableAdviceCode'NonNullableOther val) = val
  toJSON (ChargeOutcome'NonNullableAdviceCode'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (ChargeOutcome'NonNullableAdviceCode'NonNullableEnumConfirmCardData) = "confirm_card_data"
  toJSON (ChargeOutcome'NonNullableAdviceCode'NonNullableEnumDoNotTryAgain) = "do_not_try_again"
  toJSON (ChargeOutcome'NonNullableAdviceCode'NonNullableEnumTryAgainLater) = "try_again_later"

instance Data.Aeson.Types.FromJSON.FromJSON ChargeOutcome'NonNullableAdviceCode'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "confirm_card_data" -> ChargeOutcome'NonNullableAdviceCode'NonNullableEnumConfirmCardData
          | val GHC.Classes.== "do_not_try_again" -> ChargeOutcome'NonNullableAdviceCode'NonNullableEnumDoNotTryAgain
          | val GHC.Classes.== "try_again_later" -> ChargeOutcome'NonNullableAdviceCode'NonNullableEnumTryAgainLater
          | GHC.Base.otherwise -> ChargeOutcome'NonNullableAdviceCode'NonNullableOther val
      )
...
data ChargePaymentMethodDetails'NonNullable = ChargePaymentMethodDetails'NonNullable
  { -- | ach_credit_transfer:
    ...
    -- | alma:
    chargePaymentMethodDetails'NonNullableAlma :: (GHC.Maybe.Maybe PaymentMethodDetailsAlma),
    -- | amazon_pay:
    chargePaymentMethodDetails'NonNullableAmazonPay :: (GHC.Maybe.Maybe PaymentMethodDetailsAmazonPay),
    -- | au_becs_debit:
    ...
    -- | billie:
    chargePaymentMethodDetails'NonNullableBillie :: (GHC.Maybe.Maybe PaymentMethodDetailsBillie),
    -- | blik:
    ...
    -- | crypto:
    chargePaymentMethodDetails'NonNullableCrypto :: (GHC.Maybe.Maybe PaymentMethodDetailsCrypto),
    -- | customer_balance:
    ...
    -- | kakao_pay:
    chargePaymentMethodDetails'NonNullableKakaoPay :: (GHC.Maybe.Maybe PaymentMethodDetailsKakaoPay),
    -- | klarna:
    ...
    -- | kr_card:
    chargePaymentMethodDetails'NonNullableKrCard :: (GHC.Maybe.Maybe PaymentMethodDetailsKrCard),
    -- | link:
    chargePaymentMethodDetails'NonNullableLink :: (GHC.Maybe.Maybe PaymentMethodDetailsLink),
    -- | mobilepay:
    chargePaymentMethodDetails'NonNullableMobilepay :: (GHC.Maybe.Maybe PaymentMethodDetailsMobilepay),
    -- | multibanco:
    chargePaymentMethodDetails'NonNullableMultibanco :: (GHC.Maybe.Maybe PaymentMethodDetailsMultibanco),
    -- | naver_pay:
    chargePaymentMethodDetails'NonNullableNaverPay :: (GHC.Maybe.Maybe PaymentMethodDetailsNaverPay),
    -- | nz_bank_account:
    chargePaymentMethodDetails'NonNullableNzBankAccount :: (GHC.Maybe.Maybe PaymentMethodDetailsNzBankAccount),
    -- | oxxo:
    ...
    -- | pay_by_bank:
    chargePaymentMethodDetails'NonNullablePayByBank :: (GHC.Maybe.Maybe PaymentMethodDetailsPayByBank),
    -- | payco:
    chargePaymentMethodDetails'NonNullablePayco :: (GHC.Maybe.Maybe PaymentMethodDetailsPayco),
    -- | paynow:
    ...
    -- | samsung_pay:
    chargePaymentMethodDetails'NonNullableSamsungPay :: (GHC.Maybe.Maybe PaymentMethodDetailsSamsungPay),
    -- | satispay:
    chargePaymentMethodDetails'NonNullableSatispay :: (GHC.Maybe.Maybe PaymentMethodDetailsSatispay),
    -- | sepa_debit:
    ...
    -- | swish:
    chargePaymentMethodDetails'NonNullableSwish :: (GHC.Maybe.Maybe PaymentMethodDetailsSwish),
    -- | twint:
    chargePaymentMethodDetails'NonNullableTwint :: (GHC.Maybe.Maybe PaymentMethodDetailsTwint),
    -- | type: The type of transaction-specific details of the payment method used in the payment. See [PaymentMethod.type](https:\/\/stripe.com\/docs\/api\/payment_methods\/object\#payment_method_object-type) for the full list of possible types.
...
mkChargePaymentMethodDetails'NonNullable =
  ChargePaymentMethodDetails'NonNullable
    { chargePaymentMethodDetails'NonNullableAchCreditTransfer = GHC.Maybe.Nothing,
      ...
      chargePaymentMethodDetails'NonNullableAlma = GHC.Maybe.Nothing,
      chargePaymentMethodDetails'NonNullableAmazonPay = GHC.Maybe.Nothing,
      ...
      chargePaymentMethodDetails'NonNullableBillie = GHC.Maybe.Nothing,
      ...
      chargePaymentMethodDetails'NonNullableCrypto = GHC.Maybe.Nothing,
      ...
      chargePaymentMethodDetails'NonNullableKakaoPay = GHC.Maybe.Nothing,
      ...
      chargePaymentMethodDetails'NonNullableKrCard = GHC.Maybe.Nothing,
      chargePaymentMethodDetails'NonNullableLink = GHC.Maybe.Nothing,
      chargePaymentMethodDetails'NonNullableMobilepay = GHC.Maybe.Nothing,
      chargePaymentMethodDetails'NonNullableMultibanco = GHC.Maybe.Nothing,
      chargePaymentMethodDetails'NonNullableNaverPay = GHC.Maybe.Nothing,
      chargePaymentMethodDetails'NonNullableNzBankAccount = GHC.Maybe.Nothing,
      chargePaymentMethodDetails'NonNullableOxxo = GHC.Maybe.Nothing,
      chargePaymentMethodDetails'NonNullableP24 = GHC.Maybe.Nothing,
      chargePaymentMethodDetails'NonNullablePayByBank = GHC.Maybe.Nothing,
      chargePaymentMethodDetails'NonNullablePayco = GHC.Maybe.Nothing,
      ...
      chargePaymentMethodDetails'NonNullableSamsungPay = GHC.Maybe.Nothing,
      chargePaymentMethodDetails'NonNullableSatispay = GHC.Maybe.Nothing,
      ...
      chargePaymentMethodDetails'NonNullableSwish = GHC.Maybe.Nothing,
      chargePaymentMethodDetails'NonNullableTwint = GHC.Maybe.Nothing,
