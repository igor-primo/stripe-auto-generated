...
data Issuing'dispute = Issuing'dispute
  { -- | amount: Disputed amount in the card\'s currency and in the [smallest currency unit](https:\/\/stripe.com\/docs\/currencies\#zero-decimal). Usually the amount of the \`transaction\`, but can differ (usually because of currency fluctuation).
    ...
    issuing'disputeLossReason :: (GHC.Maybe.Maybe Issuing'disputeLossReason'),
...
instance Data.Aeson.Types.FromJSON.FromJSON Issuing'dispute where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "Issuing'dispute" (\obj -> (((((((((((GHC.Base.pure Issuing'dispute GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "balance_transactions")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "evidence")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "loss_reason")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "status")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "transaction")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "treasury"))
...
mkIssuing'dispute issuing'disputeAmount issuing'disputeCreated issuing'disputeCurrency issuing'disputeEvidence issuing'disputeId issuing'disputeLivemode issuing'disputeMetadata issuing'disputeStatus issuing'disputeTransaction =
  Issuing'dispute
    { issuing'disputeAmount = issuing'disputeAmount,
      ...
      issuing'disputeLossReason = GHC.Maybe.Nothing,
...
data Issuing'disputeLossReason'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    Issuing'disputeLossReason'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    Issuing'disputeLossReason'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"cardholder_authentication_issuer_liability"@
    Issuing'disputeLossReason'EnumCardholderAuthenticationIssuerLiability
  | -- | Represents the JSON value @"eci5_token_transaction_with_tavv"@
    Issuing'disputeLossReason'EnumEci5TokenTransactionWithTavv
  | -- | Represents the JSON value @"excess_disputes_in_timeframe"@
    Issuing'disputeLossReason'EnumExcessDisputesInTimeframe
  | -- | Represents the JSON value @"has_not_met_the_minimum_dispute_amount_requirements"@
    Issuing'disputeLossReason'EnumHasNotMetTheMinimumDisputeAmountRequirements
  | -- | Represents the JSON value @"invalid_duplicate_dispute"@
    Issuing'disputeLossReason'EnumInvalidDuplicateDispute
  | -- | Represents the JSON value @"invalid_incorrect_amount_dispute"@
    Issuing'disputeLossReason'EnumInvalidIncorrectAmountDispute
  | -- | Represents the JSON value @"invalid_no_authorization"@
    Issuing'disputeLossReason'EnumInvalidNoAuthorization
  | -- | Represents the JSON value @"invalid_use_of_disputes"@
    Issuing'disputeLossReason'EnumInvalidUseOfDisputes
  | -- | Represents the JSON value @"merchandise_delivered_or_shipped"@
    Issuing'disputeLossReason'EnumMerchandiseDeliveredOrShipped
  | -- | Represents the JSON value @"merchandise_or_service_as_described"@
    Issuing'disputeLossReason'EnumMerchandiseOrServiceAsDescribed
  | -- | Represents the JSON value @"not_cancelled"@
    Issuing'disputeLossReason'EnumNotCancelled
  | -- | Represents the JSON value @"other"@
    Issuing'disputeLossReason'EnumOther
  | -- | Represents the JSON value @"refund_issued"@
    Issuing'disputeLossReason'EnumRefundIssued
  | -- | Represents the JSON value @"submitted_beyond_allowable_time_limit"@
    Issuing'disputeLossReason'EnumSubmittedBeyondAllowableTimeLimit
  | -- | Represents the JSON value @"transaction_3ds_required"@
    Issuing'disputeLossReason'EnumTransaction_3dsRequired
  | -- | Represents the JSON value @"transaction_approved_after_prior_fraud_dispute"@
    Issuing'disputeLossReason'EnumTransactionApprovedAfterPriorFraudDispute
  | -- | Represents the JSON value @"transaction_authorized"@
    Issuing'disputeLossReason'EnumTransactionAuthorized
  | -- | Represents the JSON value @"transaction_electronically_read"@
    Issuing'disputeLossReason'EnumTransactionElectronicallyRead
  | -- | Represents the JSON value @"transaction_qualifies_for_visa_easy_payment_service"@
    Issuing'disputeLossReason'EnumTransactionQualifiesForVisaEasyPaymentService
  | -- | Represents the JSON value @"transaction_unattended"@
    Issuing'disputeLossReason'EnumTransactionUnattended
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON Issuing'disputeLossReason' where
  toJSON (Issuing'disputeLossReason'Other val) = val
  toJSON (Issuing'disputeLossReason'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (Issuing'disputeLossReason'EnumCardholderAuthenticationIssuerLiability) = "cardholder_authentication_issuer_liability"
  toJSON (Issuing'disputeLossReason'EnumEci5TokenTransactionWithTavv) = "eci5_token_transaction_with_tavv"
  toJSON (Issuing'disputeLossReason'EnumExcessDisputesInTimeframe) = "excess_disputes_in_timeframe"
  toJSON (Issuing'disputeLossReason'EnumHasNotMetTheMinimumDisputeAmountRequirements) = "has_not_met_the_minimum_dispute_amount_requirements"
  toJSON (Issuing'disputeLossReason'EnumInvalidDuplicateDispute) = "invalid_duplicate_dispute"
  toJSON (Issuing'disputeLossReason'EnumInvalidIncorrectAmountDispute) = "invalid_incorrect_amount_dispute"
  toJSON (Issuing'disputeLossReason'EnumInvalidNoAuthorization) = "invalid_no_authorization"
  toJSON (Issuing'disputeLossReason'EnumInvalidUseOfDisputes) = "invalid_use_of_disputes"
  toJSON (Issuing'disputeLossReason'EnumMerchandiseDeliveredOrShipped) = "merchandise_delivered_or_shipped"
  toJSON (Issuing'disputeLossReason'EnumMerchandiseOrServiceAsDescribed) = "merchandise_or_service_as_described"
  toJSON (Issuing'disputeLossReason'EnumNotCancelled) = "not_cancelled"
  toJSON (Issuing'disputeLossReason'EnumOther) = "other"
  toJSON (Issuing'disputeLossReason'EnumRefundIssued) = "refund_issued"
  toJSON (Issuing'disputeLossReason'EnumSubmittedBeyondAllowableTimeLimit) = "submitted_beyond_allowable_time_limit"
  toJSON (Issuing'disputeLossReason'EnumTransaction_3dsRequired) = "transaction_3ds_required"
  toJSON (Issuing'disputeLossReason'EnumTransactionApprovedAfterPriorFraudDispute) = "transaction_approved_after_prior_fraud_dispute"
  toJSON (Issuing'disputeLossReason'EnumTransactionAuthorized) = "transaction_authorized"
  toJSON (Issuing'disputeLossReason'EnumTransactionElectronicallyRead) = "transaction_electronically_read"
  toJSON (Issuing'disputeLossReason'EnumTransactionQualifiesForVisaEasyPaymentService) = "transaction_qualifies_for_visa_easy_payment_service"
  toJSON (Issuing'disputeLossReason'EnumTransactionUnattended) = "transaction_unattended"

instance Data.Aeson.Types.FromJSON.FromJSON Issuing'disputeLossReason' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "cardholder_authentication_issuer_liability" -> Issuing'disputeLossReason'EnumCardholderAuthenticationIssuerLiability
          | val GHC.Classes.== "eci5_token_transaction_with_tavv" -> Issuing'disputeLossReason'EnumEci5TokenTransactionWithTavv
          | val GHC.Classes.== "excess_disputes_in_timeframe" -> Issuing'disputeLossReason'EnumExcessDisputesInTimeframe
          | val GHC.Classes.== "has_not_met_the_minimum_dispute_amount_requirements" -> Issuing'disputeLossReason'EnumHasNotMetTheMinimumDisputeAmountRequirements
          | val GHC.Classes.== "invalid_duplicate_dispute" -> Issuing'disputeLossReason'EnumInvalidDuplicateDispute
          | val GHC.Classes.== "invalid_incorrect_amount_dispute" -> Issuing'disputeLossReason'EnumInvalidIncorrectAmountDispute
          | val GHC.Classes.== "invalid_no_authorization" -> Issuing'disputeLossReason'EnumInvalidNoAuthorization
          | val GHC.Classes.== "invalid_use_of_disputes" -> Issuing'disputeLossReason'EnumInvalidUseOfDisputes
          | val GHC.Classes.== "merchandise_delivered_or_shipped" -> Issuing'disputeLossReason'EnumMerchandiseDeliveredOrShipped
          | val GHC.Classes.== "merchandise_or_service_as_described" -> Issuing'disputeLossReason'EnumMerchandiseOrServiceAsDescribed
          | val GHC.Classes.== "not_cancelled" -> Issuing'disputeLossReason'EnumNotCancelled
          | val GHC.Classes.== "other" -> Issuing'disputeLossReason'EnumOther
          | val GHC.Classes.== "refund_issued" -> Issuing'disputeLossReason'EnumRefundIssued
          | val GHC.Classes.== "submitted_beyond_allowable_time_limit" -> Issuing'disputeLossReason'EnumSubmittedBeyondAllowableTimeLimit
          | val GHC.Classes.== "transaction_3ds_required" -> Issuing'disputeLossReason'EnumTransaction_3dsRequired
          | val GHC.Classes.== "transaction_approved_after_prior_fraud_dispute" -> Issuing'disputeLossReason'EnumTransactionApprovedAfterPriorFraudDispute
          | val GHC.Classes.== "transaction_authorized" -> Issuing'disputeLossReason'EnumTransactionAuthorized
          | val GHC.Classes.== "transaction_electronically_read" -> Issuing'disputeLossReason'EnumTransactionElectronicallyRead
          | val GHC.Classes.== "transaction_qualifies_for_visa_easy_payment_service" -> Issuing'disputeLossReason'EnumTransactionQualifiesForVisaEasyPaymentService
          | val GHC.Classes.== "transaction_unattended" -> Issuing'disputeLossReason'EnumTransactionUnattended
          | GHC.Base.otherwise -> Issuing'disputeLossReason'Other val
      )
