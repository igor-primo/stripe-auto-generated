...
import {-# SOURCE #-} StripeAPI.Types.InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptionsFilters
...
data InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptions = InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptions
  { -- | filters:
    invoicePaymentMethodOptionsUsBankAccountLinkedAccountOptionsFilters :: (GHC.Maybe.Maybe InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptionsFilters),
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptions where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptions" (\obj -> ((GHC.Base.pure InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptions GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "filters")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "permissions")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "prefetch"))
...
mkInvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptions =
  InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptions
    { invoicePaymentMethodOptionsUsBankAccountLinkedAccountOptionsFilters = GHC.Maybe.Nothing,
...
data InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptionsPermissions'
  ...
  | -- | Represents the JSON value @"ownership"@
    InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptionsPermissions'EnumOwnership
...
instance Data.Aeson.Types.ToJSON.ToJSON InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptionsPermissions' where
  ...
  toJSON (InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptionsPermissions'EnumOwnership) = "ownership"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "ownership" -> InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptionsPermissions'EnumOwnership
...
data InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptionsPrefetch'NonNullable
  ...
  | -- | Represents the JSON value @"ownership"@
    InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptionsPrefetch'NonNullableEnumOwnership
  | -- | Represents the JSON value @"transactions"@
...
instance Data.Aeson.Types.ToJSON.ToJSON InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptionsPrefetch'NonNullable where
  ...
  toJSON (InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptionsPrefetch'NonNullableEnumOwnership) = "ownership"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "ownership" -> InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptionsPrefetch'NonNullableEnumOwnership
