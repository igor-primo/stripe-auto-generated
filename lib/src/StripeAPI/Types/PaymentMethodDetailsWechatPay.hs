...
data PaymentMethodDetailsWechatPay = PaymentMethodDetailsWechatPay
  { -- | fingerprint: Uniquely identifies this particular WeChat Pay account. You can use this attribute to check whether two WeChat accounts are the same.
    ...
    --
    -- * Maximum length of 5000
    paymentMethodDetailsWechatPayLocation :: (GHC.Maybe.Maybe Data.Text.Internal.Text),
    -- | reader: ID of the [reader](https:\/\/stripe.com\/docs\/api\/terminal\/readers) this transaction was made on.
    --
    -- Constraints:
    --
    -- * Maximum length of 5000
    paymentMethodDetailsWechatPayReader :: (GHC.Maybe.Maybe Data.Text.Internal.Text),
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsWechatPay where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("fingerprint" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsWechatPayFingerprint obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("location" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsWechatPayLocation obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("reader" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsWechatPayReader obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("transaction_id" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsWechatPayTransactionId obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("fingerprint" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsWechatPayFingerprint obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("location" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsWechatPayLocation obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("reader" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsWechatPayReader obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("transaction_id" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsWechatPayTransactionId obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsWechatPay where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodDetailsWechatPay" (\obj -> (((GHC.Base.pure PaymentMethodDetailsWechatPay GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "fingerprint")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "location")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reader")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "transaction_id"))
...
mkPaymentMethodDetailsWechatPay =
  PaymentMethodDetailsWechatPay
    { paymentMethodDetailsWechatPayFingerprint = GHC.Maybe.Nothing,
      paymentMethodDetailsWechatPayLocation = GHC.Maybe.Nothing,
      paymentMethodDetailsWechatPayReader = GHC.Maybe.Nothing,
