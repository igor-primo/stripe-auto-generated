...
data SubscriptionItem = SubscriptionItem
  { -- | billing_thresholds: Define thresholds at which an invoice will be sent, and the related subscription advanced to a new billing period
    ...
    subscriptionItemCurrentPeriodEnd :: GHC.Types.Int,
    -- | current_period_start: The start time of this subscription item\'s current billing period.
    subscriptionItemCurrentPeriodStart :: GHC.Types.Int,
    ...
    subscriptionItemDiscounts :: [SubscriptionItemDiscounts'Variants],
...
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionItem where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("billing_thresholds" Data.Aeson.Types.ToJSON..=)) (subscriptionItemBillingThresholds obj) : ["created" Data.Aeson.Types.ToJSON..= subscriptionItemCreated obj] : ["current_period_end" Data.Aeson.Types.ToJSON..= subscriptionItemCurrentPeriodEnd obj] : ["current_period_start" Data.Aeson.Types.ToJSON..= subscriptionItemCurrentPeriodStart obj] : ["discounts" Data.Aeson.Types.ToJSON..= subscriptionItemDiscounts obj] : ["id" Data.Aeson.Types.ToJSON..= subscriptionItemId obj] : ["metadata" Data.Aeson.Types.ToJSON..= subscriptionItemMetadata obj] : ["price" Data.Aeson.Types.ToJSON..= subscriptionItemPrice obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("quantity" Data.Aeson.Types.ToJSON..=)) (subscriptionItemQuantity obj) : ["subscription" Data.Aeson.Types.ToJSON..= subscriptionItemSubscription obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("tax_rates" Data.Aeson.Types.ToJSON..=)) (subscriptionItemTaxRates obj) : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "subscription_item"] : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("billing_thresholds" Data.Aeson.Types.ToJSON..=)) (subscriptionItemBillingThresholds obj) : ["created" Data.Aeson.Types.ToJSON..= subscriptionItemCreated obj] : ["current_period_end" Data.Aeson.Types.ToJSON..= subscriptionItemCurrentPeriodEnd obj] : ["current_period_start" Data.Aeson.Types.ToJSON..= subscriptionItemCurrentPeriodStart obj] : ["discounts" Data.Aeson.Types.ToJSON..= subscriptionItemDiscounts obj] : ["id" Data.Aeson.Types.ToJSON..= subscriptionItemId obj] : ["metadata" Data.Aeson.Types.ToJSON..= subscriptionItemMetadata obj] : ["price" Data.Aeson.Types.ToJSON..= subscriptionItemPrice obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("quantity" Data.Aeson.Types.ToJSON..=)) (subscriptionItemQuantity obj) : ["subscription" Data.Aeson.Types.ToJSON..= subscriptionItemSubscription obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("tax_rates" Data.Aeson.Types.ToJSON..=)) (subscriptionItemTaxRates obj) : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "subscription_item"] : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionItem where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "SubscriptionItem" (\obj -> ((((((((((GHC.Base.pure SubscriptionItem GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "billing_thresholds")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "current_period_end")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "current_period_start")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "discounts")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "price")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "quantity")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "subscription")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_rates"))

-- | Create a new 'SubscriptionItem' with all required fields.
mkSubscriptionItem ::
  -- | 'subscriptionItemCreated'
  GHC.Types.Int ->
  -- | 'subscriptionItemCurrentPeriodEnd'
  GHC.Types.Int ->
  -- | 'subscriptionItemCurrentPeriodStart'
  GHC.Types.Int ->
  -- | 'subscriptionItemDiscounts'
  [SubscriptionItemDiscounts'Variants] ->
  -- | 'subscriptionItemId'
  ...
  Data.Text.Internal.Text ->
  SubscriptionItem
mkSubscriptionItem subscriptionItemCreated subscriptionItemCurrentPeriodEnd subscriptionItemCurrentPeriodStart subscriptionItemDiscounts subscriptionItemId subscriptionItemMetadata subscriptionItemPrice subscriptionItemSubscription =
  SubscriptionItem
    { subscriptionItemBillingThresholds = GHC.Maybe.Nothing,
      subscriptionItemCreated = subscriptionItemCreated,
      subscriptionItemCurrentPeriodEnd = subscriptionItemCurrentPeriodEnd,
      subscriptionItemCurrentPeriodStart = subscriptionItemCurrentPeriodStart,
      subscriptionItemDiscounts = subscriptionItemDiscounts,
...
data SubscriptionItemDiscounts'Variants
  = SubscriptionItemDiscounts'Text Data.Text.Internal.Text
  | SubscriptionItemDiscounts'Discount Discount
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionItemDiscounts'Variants where
  toJSON (SubscriptionItemDiscounts'Text a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (SubscriptionItemDiscounts'Discount a) = Data.Aeson.Types.ToJSON.toJSON a

instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionItemDiscounts'Variants where
  parseJSON val = case (SubscriptionItemDiscounts'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((SubscriptionItemDiscounts'Discount Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
