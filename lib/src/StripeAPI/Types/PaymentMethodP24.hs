...
data PaymentMethodP24Bank'NonNullable
  ...
  | -- | Represents the JSON value @"velobank"@
    PaymentMethodP24Bank'NonNullableEnumVelobank
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodP24Bank'NonNullable where
  ...
  toJSON (PaymentMethodP24Bank'NonNullableEnumVelobank) = "velobank"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "velobank" -> PaymentMethodP24Bank'NonNullableEnumVelobank
