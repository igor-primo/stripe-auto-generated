...
data PaymentMethodDetailsCardInstallmentsPlan'NonNullableType'
  ...
  | -- | Represents the JSON value @"bonus"@
    PaymentMethodDetailsCardInstallmentsPlan'NonNullableType'EnumBonus
  ...
  | -- | Represents the JSON value @"revolving"@
    PaymentMethodDetailsCardInstallmentsPlan'NonNullableType'EnumRevolving
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCardInstallmentsPlan'NonNullableType' where
  ...
  toJSON (PaymentMethodDetailsCardInstallmentsPlan'NonNullableType'EnumBonus) = "bonus"
  toJSON (PaymentMethodDetailsCardInstallmentsPlan'NonNullableType'EnumFixedCount) = "fixed_count"
  toJSON (PaymentMethodDetailsCardInstallmentsPlan'NonNullableType'EnumRevolving) = "revolving"

instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsCardInstallmentsPlan'NonNullableType' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "bonus" -> PaymentMethodDetailsCardInstallmentsPlan'NonNullableType'EnumBonus
          | val GHC.Classes.== "fixed_count" -> PaymentMethodDetailsCardInstallmentsPlan'NonNullableType'EnumFixedCount
          | val GHC.Classes.== "revolving" -> PaymentMethodDetailsCardInstallmentsPlan'NonNullableType'EnumRevolving
