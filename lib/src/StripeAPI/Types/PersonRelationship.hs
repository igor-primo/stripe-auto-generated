...
data PersonRelationship = PersonRelationship
  { -- | authorizer: Whether the person is the authorizer of the account\'s representative.
    personRelationshipAuthorizer :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable GHC.Types.Bool)),
    ...
    personRelationshipLegalGuardian :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable GHC.Types.Bool)),
