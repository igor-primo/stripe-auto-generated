...
instance Data.Aeson.Types.ToJSON.ToJSON AccountAnnualRevenue where
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountAnnualRevenue where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "AccountAnnualRevenue" (\obj -> ((GHC.Base.pure AccountAnnualRevenue GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "fiscal_year_end"))

-- | Create a new 'AccountAnnualRevenue' with all required fields.
mkAccountAnnualRevenue :: AccountAnnualRevenue
mkAccountAnnualRevenue =
  AccountAnnualRevenue
    { accountAnnualRevenueAmount = GHC.Maybe.Nothing,
