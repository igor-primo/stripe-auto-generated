...
data PaymentMethodDetailsCard = PaymentMethodDetailsCard
  { -- | amount_authorized: The authorized amount.
    ...
    paymentMethodDetailsCardAuthorizationCode :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text)),
    ...
    --
    -- * Maximum length of 5000
    paymentMethodDetailsCardNetworkTransactionId :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text)),
    -- | overcapture:
    ...
    paymentMethodDetailsCardRegulatedStatus :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PaymentMethodDetailsCardRegulatedStatus'NonNullable)),
...
mkPaymentMethodDetailsCard paymentMethodDetailsCardExpMonth paymentMethodDetailsCardExpYear =
  PaymentMethodDetailsCard
    { paymentMethodDetailsCardAmountAuthorized = GHC.Maybe.Nothing,
      paymentMethodDetailsCardAuthorizationCode = GHC.Maybe.Nothing,
      ...
      paymentMethodDetailsCardNetworkTransactionId = GHC.Maybe.Nothing,
      paymentMethodDetailsCardOvercapture = GHC.Maybe.Nothing,
      paymentMethodDetailsCardRegulatedStatus = GHC.Maybe.Nothing,
...
data PaymentMethodDetailsCardInstallments'NonNullablePlan'NonNullableType'
  ...
  | -- | Represents the JSON value @"bonus"@
    PaymentMethodDetailsCardInstallments'NonNullablePlan'NonNullableType'EnumBonus
  ...
  | -- | Represents the JSON value @"revolving"@
    PaymentMethodDetailsCardInstallments'NonNullablePlan'NonNullableType'EnumRevolving
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCardInstallments'NonNullablePlan'NonNullableType' where
  ...
  toJSON (PaymentMethodDetailsCardInstallments'NonNullablePlan'NonNullableType'EnumBonus) = "bonus"
  toJSON (PaymentMethodDetailsCardInstallments'NonNullablePlan'NonNullableType'EnumFixedCount) = "fixed_count"
  toJSON (PaymentMethodDetailsCardInstallments'NonNullablePlan'NonNullableType'EnumRevolving) = "revolving"

instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsCardInstallments'NonNullablePlan'NonNullableType' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "bonus" -> PaymentMethodDetailsCardInstallments'NonNullablePlan'NonNullableType'EnumBonus
          | val GHC.Classes.== "fixed_count" -> PaymentMethodDetailsCardInstallments'NonNullablePlan'NonNullableType'EnumFixedCount
          | val GHC.Classes.== "revolving" -> PaymentMethodDetailsCardInstallments'NonNullablePlan'NonNullableType'EnumRevolving
...
data PaymentMethodDetailsCardRegulatedStatus'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    PaymentMethodDetailsCardRegulatedStatus'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    PaymentMethodDetailsCardRegulatedStatus'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"regulated"@
    PaymentMethodDetailsCardRegulatedStatus'NonNullableEnumRegulated
  | -- | Represents the JSON value @"unregulated"@
    PaymentMethodDetailsCardRegulatedStatus'NonNullableEnumUnregulated
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCardRegulatedStatus'NonNullable where
  toJSON (PaymentMethodDetailsCardRegulatedStatus'NonNullableOther val) = val
  toJSON (PaymentMethodDetailsCardRegulatedStatus'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (PaymentMethodDetailsCardRegulatedStatus'NonNullableEnumRegulated) = "regulated"
  toJSON (PaymentMethodDetailsCardRegulatedStatus'NonNullableEnumUnregulated) = "unregulated"

instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsCardRegulatedStatus'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "regulated" -> PaymentMethodDetailsCardRegulatedStatus'NonNullableEnumRegulated
          | val GHC.Classes.== "unregulated" -> PaymentMethodDetailsCardRegulatedStatus'NonNullableEnumUnregulated
          | GHC.Base.otherwise -> PaymentMethodDetailsCardRegulatedStatus'NonNullableOther val
      )
