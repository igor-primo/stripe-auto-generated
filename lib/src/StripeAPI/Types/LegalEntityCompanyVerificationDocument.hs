...
data LegalEntityCompanyVerificationDocument = LegalEntityCompanyVerificationDocument
  { -- | back: The back of a document returned by a [file upload](https:\/\/stripe.com\/docs\/api\#create_file) with a \`purpose\` value of \`additional_verification\`. Note that \`additional_verification\` files are [not downloadable](\/file-upload\#uploading-a-file).
    ...
    -- | front: The front of a document returned by a [file upload](https:\/\/stripe.com\/docs\/api\#create_file) with a \`purpose\` value of \`additional_verification\`. Note that \`additional_verification\` files are [not downloadable](\/file-upload\#uploading-a-file).
