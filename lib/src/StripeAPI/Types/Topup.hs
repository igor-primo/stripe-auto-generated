...
data TopupSource'NonNullable = TopupSource'NonNullable
  { -- | ach_credit_transfer
    ...
    topupSource'NonNullableAllowRedisplay :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable TopupSource'NonNullableAllowRedisplay'NonNullable)),
...
mkTopupSource'NonNullable =
  TopupSource'NonNullable
    { topupSource'NonNullableAchCreditTransfer = GHC.Maybe.Nothing,
      ...
      topupSource'NonNullableAllowRedisplay = GHC.Maybe.Nothing,
...
data TopupSource'NonNullableAllowRedisplay'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    TopupSource'NonNullableAllowRedisplay'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    TopupSource'NonNullableAllowRedisplay'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"always"@
    TopupSource'NonNullableAllowRedisplay'NonNullableEnumAlways
  | -- | Represents the JSON value @"limited"@
    TopupSource'NonNullableAllowRedisplay'NonNullableEnumLimited
  | -- | Represents the JSON value @"unspecified"@
    TopupSource'NonNullableAllowRedisplay'NonNullableEnumUnspecified
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON TopupSource'NonNullableAllowRedisplay'NonNullable where
  toJSON (TopupSource'NonNullableAllowRedisplay'NonNullableOther val) = val
  toJSON (TopupSource'NonNullableAllowRedisplay'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (TopupSource'NonNullableAllowRedisplay'NonNullableEnumAlways) = "always"
  toJSON (TopupSource'NonNullableAllowRedisplay'NonNullableEnumLimited) = "limited"
  toJSON (TopupSource'NonNullableAllowRedisplay'NonNullableEnumUnspecified) = "unspecified"

instance Data.Aeson.Types.FromJSON.FromJSON TopupSource'NonNullableAllowRedisplay'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "always" -> TopupSource'NonNullableAllowRedisplay'NonNullableEnumAlways
          | val GHC.Classes.== "limited" -> TopupSource'NonNullableAllowRedisplay'NonNullableEnumLimited
          | val GHC.Classes.== "unspecified" -> TopupSource'NonNullableAllowRedisplay'NonNullableEnumUnspecified
          | GHC.Base.otherwise -> TopupSource'NonNullableAllowRedisplay'NonNullableOther val
      )
