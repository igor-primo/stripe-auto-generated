...
instance Data.Aeson.Types.ToJSON.ToJSON PortalFeatures where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["customer_update" Data.Aeson.Types.ToJSON..= portalFeaturesCustomerUpdate obj] : ["invoice_history" Data.Aeson.Types.ToJSON..= portalFeaturesInvoiceHistory obj] : ["payment_method_update" Data.Aeson.Types.ToJSON..= portalFeaturesPaymentMethodUpdate obj] : ["subscription_cancel" Data.Aeson.Types.ToJSON..= portalFeaturesSubscriptionCancel obj] : ["subscription_update" Data.Aeson.Types.ToJSON..= portalFeaturesSubscriptionUpdate obj] : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PortalFeatures where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PortalFeatures" (\obj -> ((((GHC.Base.pure PortalFeatures GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "customer_update")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "invoice_history")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "payment_method_update")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "subscription_cancel")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "subscription_update"))
...
mkPortalFeatures ::
  ...
  PortalFeatures
mkPortalFeatures portalFeaturesCustomerUpdate portalFeaturesInvoiceHistory portalFeaturesPaymentMethodUpdate portalFeaturesSubscriptionCancel portalFeaturesSubscriptionUpdate =
  PortalFeatures
