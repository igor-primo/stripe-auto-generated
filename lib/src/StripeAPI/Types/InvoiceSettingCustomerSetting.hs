...
import {-# SOURCE #-} StripeAPI.Types.InvoiceSettingCustomerRenderingOptions
...
data InvoiceSettingCustomerSettingRenderingOptions'NonNullable = InvoiceSettingCustomerSettingRenderingOptions'NonNullable
  { -- | amount_tax_display: How line-item prices and amounts will be displayed with respect to tax on invoice PDFs.
    ...
    --
    -- * Maximum length of 5000
    invoiceSettingCustomerSettingRenderingOptions'NonNullableTemplate :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text))
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON InvoiceSettingCustomerSettingRenderingOptions'NonNullable where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount_tax_display" Data.Aeson.Types.ToJSON..=)) (invoiceSettingCustomerSettingRenderingOptions'NonNullableAmountTaxDisplay obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("template" Data.Aeson.Types.ToJSON..=)) (invoiceSettingCustomerSettingRenderingOptions'NonNullableTemplate obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount_tax_display" Data.Aeson.Types.ToJSON..=)) (invoiceSettingCustomerSettingRenderingOptions'NonNullableAmountTaxDisplay obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("template" Data.Aeson.Types.ToJSON..=)) (invoiceSettingCustomerSettingRenderingOptions'NonNullableTemplate obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON InvoiceSettingCustomerSettingRenderingOptions'NonNullable where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoiceSettingCustomerSettingRenderingOptions'NonNullable" (\obj -> (GHC.Base.pure InvoiceSettingCustomerSettingRenderingOptions'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_tax_display")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "template"))
...
mkInvoiceSettingCustomerSettingRenderingOptions'NonNullable =
  InvoiceSettingCustomerSettingRenderingOptions'NonNullable
    { invoiceSettingCustomerSettingRenderingOptions'NonNullableAmountTaxDisplay = GHC.Maybe.Nothing,
      invoiceSettingCustomerSettingRenderingOptions'NonNullableTemplate = GHC.Maybe.Nothing
    }
