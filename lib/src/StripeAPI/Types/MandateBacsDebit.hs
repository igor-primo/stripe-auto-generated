...
instance Data.Aeson.Types.FromJSON.FromJSON MandateBacsDebit where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "MandateBacsDebit" (\obj -> (((GHC.Base.pure MandateBacsDebit GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "network_status")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "reference")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "revocation_reason")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))
...
data MandateBacsDebitRevocationReason'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    MandateBacsDebitRevocationReason'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    MandateBacsDebitRevocationReason'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"account_closed"@
    MandateBacsDebitRevocationReason'NonNullableEnumAccountClosed
  | -- | Represents the JSON value @"bank_account_restricted"@
    MandateBacsDebitRevocationReason'NonNullableEnumBankAccountRestricted
  | -- | Represents the JSON value @"bank_ownership_changed"@
    MandateBacsDebitRevocationReason'NonNullableEnumBankOwnershipChanged
  | -- | Represents the JSON value @"could_not_process"@
    MandateBacsDebitRevocationReason'NonNullableEnumCouldNotProcess
  | -- | Represents the JSON value @"debit_not_authorized"@
    MandateBacsDebitRevocationReason'NonNullableEnumDebitNotAuthorized
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON MandateBacsDebitRevocationReason'NonNullable where
  toJSON (MandateBacsDebitRevocationReason'NonNullableOther val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON MandateBacsDebitRevocationReason'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "account_closed" -> MandateBacsDebitRevocationReason'NonNullableEnumAccountClosed
