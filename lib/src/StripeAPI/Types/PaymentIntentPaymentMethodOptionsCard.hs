...
data PaymentIntentPaymentMethodOptionsCard = PaymentIntentPaymentMethodOptionsCard
  { -- | capture_method: Controls when the funds will be captured from the customer\'s account.
    ...
    paymentIntentPaymentMethodOptionsCardRequireCvcRecollection :: (GHC.Maybe.Maybe GHC.Types.Bool),
...
mkPaymentIntentPaymentMethodOptionsCard =
  PaymentIntentPaymentMethodOptionsCard
    { paymentIntentPaymentMethodOptionsCardCaptureMethod = GHC.Maybe.Nothing,
      ...
      paymentIntentPaymentMethodOptionsCardRequireCvcRecollection = GHC.Maybe.Nothing,
...
data PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType'
  ...
  | -- | Represents the JSON value @"bonus"@
    PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType'EnumBonus
  ...
  | -- | Represents the JSON value @"revolving"@
    PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType'EnumRevolving
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType' where
  ...
  toJSON (PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType'EnumBonus) = "bonus"
  toJSON (PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType'EnumFixedCount) = "fixed_count"
  toJSON (PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType'EnumRevolving) = "revolving"
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "bonus" -> PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType'EnumBonus
          ...
          | val GHC.Classes.== "revolving" -> PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType'EnumRevolving
...
data PaymentIntentPaymentMethodOptionsCardNetwork'NonNullable
  ...
  | -- | Represents the JSON value @"girocard"@
    PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableEnumGirocard
  ...
  | -- | Represents the JSON value @"link"@
    PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableEnumLink
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsCardNetwork'NonNullable where
  ...
  toJSON (PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableEnumGirocard) = "girocard"
  ...
  toJSON (PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableEnumLink) = "link"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "girocard" -> PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableEnumGirocard
          ...
          | val GHC.Classes.== "link" -> PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableEnumLink
