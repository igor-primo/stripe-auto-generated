...
import {-# SOURCE #-} StripeAPI.Types.DisputeEnhancedEligibility
...
data DisputeEvidenceDetails = DisputeEvidenceDetails
  { -- | due_by: Date by which evidence must be submitted in order to successfully challenge dispute. Will be 0 if the customer\'s bank or credit card company doesn\'t allow a response for this particular dispute.
    ...
    disputeEvidenceDetailsEnhancedEligibility :: DisputeEnhancedEligibility,
...
instance Data.Aeson.Types.ToJSON.ToJSON DisputeEvidenceDetails where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("due_by" Data.Aeson.Types.ToJSON..=)) (disputeEvidenceDetailsDueBy obj) : ["enhanced_eligibility" Data.Aeson.Types.ToJSON..= disputeEvidenceDetailsEnhancedEligibility obj] : ["has_evidence" Data.Aeson.Types.ToJSON..= disputeEvidenceDetailsHasEvidence obj] : ["past_due" Data.Aeson.Types.ToJSON..= disputeEvidenceDetailsPastDue obj] : ["submission_count" Data.Aeson.Types.ToJSON..= disputeEvidenceDetailsSubmissionCount obj] : GHC.Base.mempty))
...
mkDisputeEvidenceDetails ::
  -- | 'disputeEvidenceDetailsEnhancedEligibility'
...
mkDisputeEvidenceDetails disputeEvidenceDetailsEnhancedEligibility disputeEvidenceDetailsHasEvidence disputeEvidenceDetailsPastDue disputeEvidenceDetailsSubmissionCount =
  DisputeEvidenceDetails
    { disputeEvidenceDetailsDueBy = GHC.Maybe.Nothing,
      disputeEvidenceDetailsEnhancedEligibility = disputeEvidenceDetailsEnhancedEligibility,
