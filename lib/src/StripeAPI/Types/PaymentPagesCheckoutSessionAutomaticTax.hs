...
data PaymentPagesCheckoutSessionAutomaticTax = PaymentPagesCheckoutSessionAutomaticTax
  { -- | enabled: Indicates whether automatic tax is enabled for the session
    ...
    paymentPagesCheckoutSessionAutomaticTaxProvider :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text)),
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionAutomaticTax where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["enabled" Data.Aeson.Types.ToJSON..= paymentPagesCheckoutSessionAutomaticTaxEnabled obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("liability" Data.Aeson.Types.ToJSON..=)) (paymentPagesCheckoutSessionAutomaticTaxLiability obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("provider" Data.Aeson.Types.ToJSON..=)) (paymentPagesCheckoutSessionAutomaticTaxProvider obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("status" Data.Aeson.Types.ToJSON..=)) (paymentPagesCheckoutSessionAutomaticTaxStatus obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionAutomaticTax where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentPagesCheckoutSessionAutomaticTax" (\obj -> (((GHC.Base.pure PaymentPagesCheckoutSessionAutomaticTax GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "enabled")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "liability")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "provider")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "status"))
...
mkPaymentPagesCheckoutSessionAutomaticTax paymentPagesCheckoutSessionAutomaticTaxEnabled =
  PaymentPagesCheckoutSessionAutomaticTax
    { paymentPagesCheckoutSessionAutomaticTaxEnabled = paymentPagesCheckoutSessionAutomaticTaxEnabled,
      ...
      paymentPagesCheckoutSessionAutomaticTaxProvider = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullable where
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullable where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullable" (\obj -> (GHC.Base.pure PaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))
...
mkPaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullable =
  PaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullable
    { paymentPagesCheckoutSessionAutomaticTaxLiability'NonNullableAccount = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullableAccount'Variants where
  toJSON (PaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullableAccount'Text a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (PaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullableAccount'Account a) = Data.Aeson.Types.ToJSON.toJSON a

instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullableAccount'Variants where
  parseJSON val = case (PaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullableAccount'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullableAccount'Account Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data PaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullableType'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    PaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullableType'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    PaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullableType'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"account"@
    PaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullableType'EnumAccount
  | -- | Represents the JSON value @"self"@
    PaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullableType'EnumSelf
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullableType' where
  toJSON (PaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullableType'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullableType' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "account" -> PaymentPagesCheckoutSessionAutomaticTaxLiability'NonNullableType'EnumAccount
