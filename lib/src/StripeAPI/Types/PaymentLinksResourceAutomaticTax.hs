...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentLinksResourceAutomaticTax where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["enabled" Data.Aeson.Types.ToJSON..= paymentLinksResourceAutomaticTaxEnabled obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("liability" Data.Aeson.Types.ToJSON..=)) (paymentLinksResourceAutomaticTaxLiability obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentLinksResourceAutomaticTax where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentLinksResourceAutomaticTax" (\obj -> (GHC.Base.pure PaymentLinksResourceAutomaticTax GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "enabled")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "liability"))
...
mkPaymentLinksResourceAutomaticTax paymentLinksResourceAutomaticTaxEnabled =
  PaymentLinksResourceAutomaticTax
    { paymentLinksResourceAutomaticTaxEnabled = paymentLinksResourceAutomaticTaxEnabled,
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentLinksResourceAutomaticTaxLiability'NonNullable where
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentLinksResourceAutomaticTaxLiability'NonNullable where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentLinksResourceAutomaticTaxLiability'NonNullable" (\obj -> (GHC.Base.pure PaymentLinksResourceAutomaticTaxLiability'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))
...
mkPaymentLinksResourceAutomaticTaxLiability'NonNullable =
  PaymentLinksResourceAutomaticTaxLiability'NonNullable
    { paymentLinksResourceAutomaticTaxLiability'NonNullableAccount = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentLinksResourceAutomaticTaxLiability'NonNullableAccount'Variants where
  toJSON (PaymentLinksResourceAutomaticTaxLiability'NonNullableAccount'Text a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (PaymentLinksResourceAutomaticTaxLiability'NonNullableAccount'Account a) = Data.Aeson.Types.ToJSON.toJSON a

instance Data.Aeson.Types.FromJSON.FromJSON PaymentLinksResourceAutomaticTaxLiability'NonNullableAccount'Variants where
  parseJSON val = case (PaymentLinksResourceAutomaticTaxLiability'NonNullableAccount'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PaymentLinksResourceAutomaticTaxLiability'NonNullableAccount'Account Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data PaymentLinksResourceAutomaticTaxLiability'NonNullableType'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    PaymentLinksResourceAutomaticTaxLiability'NonNullableType'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    PaymentLinksResourceAutomaticTaxLiability'NonNullableType'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"account"@
    PaymentLinksResourceAutomaticTaxLiability'NonNullableType'EnumAccount
  | -- | Represents the JSON value @"self"@
    PaymentLinksResourceAutomaticTaxLiability'NonNullableType'EnumSelf
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PaymentLinksResourceAutomaticTaxLiability'NonNullableType' where
  toJSON (PaymentLinksResourceAutomaticTaxLiability'NonNullableType'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentLinksResourceAutomaticTaxLiability'NonNullableType' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "account" -> PaymentLinksResourceAutomaticTaxLiability'NonNullableType'EnumAccount
