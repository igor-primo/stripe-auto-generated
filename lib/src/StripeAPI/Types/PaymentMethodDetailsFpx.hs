...
data PaymentMethodDetailsFpxBank'
  ...
  | -- | Represents the JSON value @"bank_of_china"@
    PaymentMethodDetailsFpxBank'EnumBankOfChina
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsFpxBank' where
  ...
  toJSON (PaymentMethodDetailsFpxBank'EnumBankOfChina) = "bank_of_china"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "bank_of_china" -> PaymentMethodDetailsFpxBank'EnumBankOfChina
