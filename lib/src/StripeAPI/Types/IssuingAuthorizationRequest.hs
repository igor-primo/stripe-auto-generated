...
data IssuingAuthorizationRequestReason'
  ...
  | -- | Represents the JSON value @"card_canceled"@
    IssuingAuthorizationRequestReason'EnumCardCanceled
  | -- | Represents the JSON value @"card_expired"@
    IssuingAuthorizationRequestReason'EnumCardExpired
  | -- | Represents the JSON value @"card_inactive"@
    IssuingAuthorizationRequestReason'EnumCardInactive
  | -- | Represents the JSON value @"cardholder_blocked"@
    IssuingAuthorizationRequestReason'EnumCardholderBlocked
  ...
  | -- | Represents the JSON value @"insecure_authorization_method"@
    IssuingAuthorizationRequestReason'EnumInsecureAuthorizationMethod
  | -- | Represents the JSON value @"insufficient_funds"@
    IssuingAuthorizationRequestReason'EnumInsufficientFunds
  | -- | Represents the JSON value @"network_fallback"@
    IssuingAuthorizationRequestReason'EnumNetworkFallback
  | -- | Represents the JSON value @"not_allowed"@
    IssuingAuthorizationRequestReason'EnumNotAllowed
  | -- | Represents the JSON value @"pin_blocked"@
    IssuingAuthorizationRequestReason'EnumPinBlocked
...
instance Data.Aeson.Types.ToJSON.ToJSON IssuingAuthorizationRequestReason' where
  ...
  toJSON (IssuingAuthorizationRequestReason'EnumCardCanceled) = "card_canceled"
  toJSON (IssuingAuthorizationRequestReason'EnumCardExpired) = "card_expired"
  toJSON (IssuingAuthorizationRequestReason'EnumCardInactive) = "card_inactive"
  toJSON (IssuingAuthorizationRequestReason'EnumCardholderBlocked) = "cardholder_blocked"
  ...
  toJSON (IssuingAuthorizationRequestReason'EnumInsecureAuthorizationMethod) = "insecure_authorization_method"
  toJSON (IssuingAuthorizationRequestReason'EnumInsufficientFunds) = "insufficient_funds"
  toJSON (IssuingAuthorizationRequestReason'EnumNetworkFallback) = "network_fallback"
  toJSON (IssuingAuthorizationRequestReason'EnumNotAllowed) = "not_allowed"
  toJSON (IssuingAuthorizationRequestReason'EnumPinBlocked) = "pin_blocked"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "card_canceled" -> IssuingAuthorizationRequestReason'EnumCardCanceled
          | val GHC.Classes.== "card_expired" -> IssuingAuthorizationRequestReason'EnumCardExpired
          | val GHC.Classes.== "card_inactive" -> IssuingAuthorizationRequestReason'EnumCardInactive
          | val GHC.Classes.== "cardholder_blocked" -> IssuingAuthorizationRequestReason'EnumCardholderBlocked
          ...
          | val GHC.Classes.== "insecure_authorization_method" -> IssuingAuthorizationRequestReason'EnumInsecureAuthorizationMethod
          | val GHC.Classes.== "insufficient_funds" -> IssuingAuthorizationRequestReason'EnumInsufficientFunds
          | val GHC.Classes.== "network_fallback" -> IssuingAuthorizationRequestReason'EnumNetworkFallback
          | val GHC.Classes.== "not_allowed" -> IssuingAuthorizationRequestReason'EnumNotAllowed
          | val GHC.Classes.== "pin_blocked" -> IssuingAuthorizationRequestReason'EnumPinBlocked
