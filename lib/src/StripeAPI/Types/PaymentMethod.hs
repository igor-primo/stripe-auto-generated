...
data PaymentMethod = PaymentMethod
  { -- | acss_debit:
    ...
    paymentMethodAllowRedisplay :: (GHC.Maybe.Maybe PaymentMethodAllowRedisplay'),
    -- | alma:
    paymentMethodAlma :: (GHC.Maybe.Maybe PaymentMethodAlma),
    -- | amazon_pay:
    paymentMethodAmazonPay :: (GHC.Maybe.Maybe PaymentMethodAmazonPay),
    -- | au_becs_debit:
    ...
    -- | billie:
    paymentMethodBillie :: (GHC.Maybe.Maybe PaymentMethodBillie),
    -- | billing_details:
    paymentMethodBillingDetails :: BillingDetails,
    -- | blik:
    paymentMethodBlik :: (GHC.Maybe.Maybe PaymentMethodBlik),
    -- | boleto:
    ...
    -- | cashapp:
    paymentMethodCashapp :: (GHC.Maybe.Maybe PaymentMethodCashapp),
    -- | created: Time at which the object was created. Measured in seconds since the Unix epoch.
    paymentMethodCreated :: GHC.Types.Int,
    -- | crypto:
    paymentMethodCrypto :: (GHC.Maybe.Maybe PaymentMethodCrypto),
    ...
    -- | kakao_pay:
    paymentMethodKakaoPay :: (GHC.Maybe.Maybe PaymentMethodKakaoPay),
    -- | klarna:
    paymentMethodKlarna :: (GHC.Maybe.Maybe PaymentMethodKlarna),
    -- | konbini:
    paymentMethodKonbini :: (GHC.Maybe.Maybe PaymentMethodKonbini),
    -- | kr_card:
    paymentMethodKrCard :: (GHC.Maybe.Maybe PaymentMethodKrCard),
    -- | link:
    ...
    -- | mobilepay:
    paymentMethodMobilepay :: (GHC.Maybe.Maybe PaymentMethodMobilepay),
    -- | multibanco:
    paymentMethodMultibanco :: (GHC.Maybe.Maybe PaymentMethodMultibanco),
    -- | naver_pay:
    paymentMethodNaverPay :: (GHC.Maybe.Maybe PaymentMethodNaverPay),
    -- | nz_bank_account:
    paymentMethodNzBankAccount :: (GHC.Maybe.Maybe PaymentMethodNzBankAccount),
    -- | oxxo:
    paymentMethodOxxo :: (GHC.Maybe.Maybe PaymentMethodOxxo),
    -- | p24:
    paymentMethodP24 :: (GHC.Maybe.Maybe PaymentMethodP24),
    -- | pay_by_bank:
    paymentMethodPayByBank :: (GHC.Maybe.Maybe PaymentMethodPayByBank),
    -- | payco:
    paymentMethodPayco :: (GHC.Maybe.Maybe PaymentMethodPayco),
    -- | paynow:
    paymentMethodPaynow :: (GHC.Maybe.Maybe PaymentMethodPaynow),
    -- | paypal:
    paymentMethodPaypal :: (GHC.Maybe.Maybe PaymentMethodPaypal),
    -- | pix:
    paymentMethodPix :: (GHC.Maybe.Maybe PaymentMethodPix),
    -- | promptpay:
    ...
    -- | revolut_pay:
    paymentMethodRevolutPay :: (GHC.Maybe.Maybe PaymentMethodRevolutPay),
    -- | samsung_pay:
    paymentMethodSamsungPay :: (GHC.Maybe.Maybe PaymentMethodSamsungPay),
    -- | satispay:
    paymentMethodSatispay :: (GHC.Maybe.Maybe PaymentMethodSatispay),
    -- | sepa_debit:
    paymentMethodSepaDebit :: (GHC.Maybe.Maybe PaymentMethodSepaDebit),
    -- | sofort:
    paymentMethodSofort :: (GHC.Maybe.Maybe PaymentMethodSofort),
    -- | swish:
    paymentMethodSwish :: (GHC.Maybe.Maybe PaymentMethodSwish),
    -- | twint:
    paymentMethodTwint :: (GHC.Maybe.Maybe PaymentMethodTwint),
    ...
    -- | zip:
    paymentMethodZip :: (GHC.Maybe.Maybe PaymentMethodZip)
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
mkPaymentMethod paymentMethodBillingDetails paymentMethodCreated paymentMethodId paymentMethodLivemode paymentMethodType =
  PaymentMethod
    { paymentMethodAcssDebit = GHC.Maybe.Nothing,
      ...
      paymentMethodAllowRedisplay = GHC.Maybe.Nothing,
      paymentMethodAlma = GHC.Maybe.Nothing,
      paymentMethodAmazonPay = GHC.Maybe.Nothing,
      ...
      paymentMethodKakaoPay = GHC.Maybe.Nothing,
      paymentMethodKlarna = GHC.Maybe.Nothing,
      paymentMethodKonbini = GHC.Maybe.Nothing,
      paymentMethodKrCard = GHC.Maybe.Nothing,
      paymentMethodLink = GHC.Maybe.Nothing,
      paymentMethodLivemode = paymentMethodLivemode,
      paymentMethodMetadata = GHC.Maybe.Nothing,
      paymentMethodMobilepay = GHC.Maybe.Nothing,
      paymentMethodMultibanco = GHC.Maybe.Nothing,
      paymentMethodNaverPay = GHC.Maybe.Nothing,
      paymentMethodNzBankAccount = GHC.Maybe.Nothing,
      paymentMethodOxxo = GHC.Maybe.Nothing,
      paymentMethodP24 = GHC.Maybe.Nothing,
      paymentMethodPayByBank = GHC.Maybe.Nothing,
      paymentMethodPayco = GHC.Maybe.Nothing,
      paymentMethodPaynow = GHC.Maybe.Nothing,
      paymentMethodPaypal = GHC.Maybe.Nothing,
      paymentMethodPix = GHC.Maybe.Nothing,
      paymentMethodPromptpay = GHC.Maybe.Nothing,
      paymentMethodRadarOptions = GHC.Maybe.Nothing,
      paymentMethodRevolutPay = GHC.Maybe.Nothing,
      paymentMethodSamsungPay = GHC.Maybe.Nothing,
      paymentMethodSatispay = GHC.Maybe.Nothing,
      paymentMethodSepaDebit = GHC.Maybe.Nothing,
      paymentMethodSofort = GHC.Maybe.Nothing,
      paymentMethodSwish = GHC.Maybe.Nothing,
      paymentMethodTwint = GHC.Maybe.Nothing,
      paymentMethodType = paymentMethodType,
      paymentMethodUsBankAccount = GHC.Maybe.Nothing,
      paymentMethodWechatPay = GHC.Maybe.Nothing,
      paymentMethodZip = GHC.Maybe.Nothing
    }
...
data PaymentMethodAllowRedisplay'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    PaymentMethodAllowRedisplay'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    PaymentMethodAllowRedisplay'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"always"@
    PaymentMethodAllowRedisplay'EnumAlways
  | -- | Represents the JSON value @"limited"@
    PaymentMethodAllowRedisplay'EnumLimited
  | -- | Represents the JSON value @"unspecified"@
    PaymentMethodAllowRedisplay'EnumUnspecified
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodAllowRedisplay' where
  toJSON (PaymentMethodAllowRedisplay'Other val) = val
  toJSON (PaymentMethodAllowRedisplay'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (PaymentMethodAllowRedisplay'EnumAlways) = "always"
  toJSON (PaymentMethodAllowRedisplay'EnumLimited) = "limited"
  toJSON (PaymentMethodAllowRedisplay'EnumUnspecified) = "unspecified"

instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodAllowRedisplay' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "always" -> PaymentMethodAllowRedisplay'EnumAlways
          | val GHC.Classes.== "limited" -> PaymentMethodAllowRedisplay'EnumLimited
          | val GHC.Classes.== "unspecified" -> PaymentMethodAllowRedisplay'EnumUnspecified
          | GHC.Base.otherwise -> PaymentMethodAllowRedisplay'Other val
      )
...
data PaymentMethodType'
  ...
  | -- | Represents the JSON value @"alma"@
    PaymentMethodType'EnumAlma
  | -- | Represents the JSON value @"amazon_pay"@
    PaymentMethodType'EnumAmazonPay
  ...
  | -- | Represents the JSON value @"billie"@
    PaymentMethodType'EnumBillie
  | -- | Represents the JSON value @"blik"@
    PaymentMethodType'EnumBlik
  ...
  | -- | Represents the JSON value @"cashapp"@
    PaymentMethodType'EnumCashapp
  | -- | Represents the JSON value @"crypto"@
    PaymentMethodType'EnumCrypto
  ...
  | -- | Represents the JSON value @"kakao_pay"@
    PaymentMethodType'EnumKakaoPay
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodType' where
  ...
  toJSON (PaymentMethodType'EnumAlma) = "alma"
  toJSON (PaymentMethodType'EnumAmazonPay) = "amazon_pay"
  ...
  toJSON (PaymentMethodType'EnumBillie) = "billie"
  toJSON (PaymentMethodType'EnumBlik) = "blik"
  ...
  toJSON (PaymentMethodType'EnumCashapp) = "cashapp"
  toJSON (PaymentMethodType'EnumCrypto) = "crypto"
  ...
  toJSON (PaymentMethodType'EnumKakaoPay) = "kakao_pay"
  toJSON (PaymentMethodType'EnumKlarna) = "klarna"
  toJSON (PaymentMethodType'EnumKonbini) = "konbini"
  toJSON (PaymentMethodType'EnumKrCard) = "kr_card"
  toJSON (PaymentMethodType'EnumLink) = "link"
  toJSON (PaymentMethodType'EnumMobilepay) = "mobilepay"
  toJSON (PaymentMethodType'EnumMultibanco) = "multibanco"
  toJSON (PaymentMethodType'EnumNaverPay) = "naver_pay"
  toJSON (PaymentMethodType'EnumNzBankAccount) = "nz_bank_account"
  toJSON (PaymentMethodType'EnumOxxo) = "oxxo"
  toJSON (PaymentMethodType'EnumP24) = "p24"
  toJSON (PaymentMethodType'EnumPayByBank) = "pay_by_bank"
  toJSON (PaymentMethodType'EnumPayco) = "payco"
  toJSON (PaymentMethodType'EnumPaynow) = "paynow"
  toJSON (PaymentMethodType'EnumPaypal) = "paypal"
  toJSON (PaymentMethodType'EnumPix) = "pix"
  toJSON (PaymentMethodType'EnumPromptpay) = "promptpay"
  toJSON (PaymentMethodType'EnumRevolutPay) = "revolut_pay"
  toJSON (PaymentMethodType'EnumSamsungPay) = "samsung_pay"
  toJSON (PaymentMethodType'EnumSatispay) = "satispay"
  toJSON (PaymentMethodType'EnumSepaDebit) = "sepa_debit"
  toJSON (PaymentMethodType'EnumSofort) = "sofort"
  toJSON (PaymentMethodType'EnumSwish) = "swish"
  toJSON (PaymentMethodType'EnumTwint) = "twint"
  toJSON (PaymentMethodType'EnumUsBankAccount) = "us_bank_account"
  toJSON (PaymentMethodType'EnumWechatPay) = "wechat_pay"
  toJSON (PaymentMethodType'EnumZip) = "zip"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "alma" -> PaymentMethodType'EnumAlma
          | val GHC.Classes.== "amazon_pay" -> PaymentMethodType'EnumAmazonPay
          ...
          | val GHC.Classes.== "billie" -> PaymentMethodType'EnumBillie
          | val GHC.Classes.== "blik" -> PaymentMethodType'EnumBlik
          ...
          | val GHC.Classes.== "cashapp" -> PaymentMethodType'EnumCashapp
          | val GHC.Classes.== "crypto" -> PaymentMethodType'EnumCrypto
          ...
          | val GHC.Classes.== "kakao_pay" -> PaymentMethodType'EnumKakaoPay
          | val GHC.Classes.== "klarna" -> PaymentMethodType'EnumKlarna
          | val GHC.Classes.== "konbini" -> PaymentMethodType'EnumKonbini
          | val GHC.Classes.== "kr_card" -> PaymentMethodType'EnumKrCard
          | val GHC.Classes.== "link" -> PaymentMethodType'EnumLink
          | val GHC.Classes.== "mobilepay" -> PaymentMethodType'EnumMobilepay
          | val GHC.Classes.== "multibanco" -> PaymentMethodType'EnumMultibanco
          | val GHC.Classes.== "naver_pay" -> PaymentMethodType'EnumNaverPay
          | val GHC.Classes.== "nz_bank_account" -> PaymentMethodType'EnumNzBankAccount
          | val GHC.Classes.== "oxxo" -> PaymentMethodType'EnumOxxo
          | val GHC.Classes.== "p24" -> PaymentMethodType'EnumP24
          | val GHC.Classes.== "pay_by_bank" -> PaymentMethodType'EnumPayByBank
          | val GHC.Classes.== "payco" -> PaymentMethodType'EnumPayco
          | val GHC.Classes.== "paynow" -> PaymentMethodType'EnumPaynow
          | val GHC.Classes.== "paypal" -> PaymentMethodType'EnumPaypal
          | val GHC.Classes.== "pix" -> PaymentMethodType'EnumPix
          | val GHC.Classes.== "promptpay" -> PaymentMethodType'EnumPromptpay
          | val GHC.Classes.== "revolut_pay" -> PaymentMethodType'EnumRevolutPay
          | val GHC.Classes.== "samsung_pay" -> PaymentMethodType'EnumSamsungPay
          | val GHC.Classes.== "satispay" -> PaymentMethodType'EnumSatispay
          | val GHC.Classes.== "sepa_debit" -> PaymentMethodType'EnumSepaDebit
          | val GHC.Classes.== "sofort" -> PaymentMethodType'EnumSofort
          | val GHC.Classes.== "swish" -> PaymentMethodType'EnumSwish
          | val GHC.Classes.== "twint" -> PaymentMethodType'EnumTwint
          ...
          | val GHC.Classes.== "zip" -> PaymentMethodType'EnumZip
