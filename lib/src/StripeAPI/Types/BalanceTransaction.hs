...
data BalanceTransaction = BalanceTransaction
  { -- | amount: Gross amount of this transaction (in cents (or local equivalent)). A positive value represents funds charged to another party, and a negative value represents funds sent to another party.
    ...
    balanceTransactionBalanceType :: (GHC.Maybe.Maybe BalanceTransactionBalanceType'),
...
instance Data.Aeson.Types.FromJSON.FromJSON BalanceTransaction where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "BalanceTransaction" (\obj -> ((((((((((((((GHC.Base.pure BalanceTransaction GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "available_on")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "balance_type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "exchange_rate")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "fee")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "fee_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "net")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "reporting_category")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "source")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "status")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))
...
mkBalanceTransaction balanceTransactionAmount balanceTransactionAvailableOn balanceTransactionCreated balanceTransactionCurrency balanceTransactionFee balanceTransactionFeeDetails balanceTransactionId balanceTransactionNet balanceTransactionReportingCategory balanceTransactionStatus balanceTransactionType =
  BalanceTransaction
    { balanceTransactionAmount = balanceTransactionAmount,
      ...
      balanceTransactionBalanceType = GHC.Maybe.Nothing,
...
data BalanceTransactionBalanceType'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    BalanceTransactionBalanceType'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    BalanceTransactionBalanceType'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"issuing"@
    BalanceTransactionBalanceType'EnumIssuing
  | -- | Represents the JSON value @"payments"@
    BalanceTransactionBalanceType'EnumPayments
  | -- | Represents the JSON value @"refund_and_dispute_prefunding"@
    BalanceTransactionBalanceType'EnumRefundAndDisputePrefunding
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON BalanceTransactionBalanceType' where
  toJSON (BalanceTransactionBalanceType'Other val) = val
  toJSON (BalanceTransactionBalanceType'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (BalanceTransactionBalanceType'EnumIssuing) = "issuing"
  toJSON (BalanceTransactionBalanceType'EnumPayments) = "payments"
  toJSON (BalanceTransactionBalanceType'EnumRefundAndDisputePrefunding) = "refund_and_dispute_prefunding"

instance Data.Aeson.Types.FromJSON.FromJSON BalanceTransactionBalanceType' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "issuing" -> BalanceTransactionBalanceType'EnumIssuing
          | val GHC.Classes.== "payments" -> BalanceTransactionBalanceType'EnumPayments
          | val GHC.Classes.== "refund_and_dispute_prefunding" -> BalanceTransactionBalanceType'EnumRefundAndDisputePrefunding
          | GHC.Base.otherwise -> BalanceTransactionBalanceType'Other val
      )
...
instance Data.Aeson.Types.FromJSON.FromJSON BalanceTransactionSource'NonNullableVariants where
  parseJSON val = case (BalanceTransactionSource'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((BalanceTransactionSource'NonNullableApplicationFee Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((BalanceTransactionSource'NonNullableCharge Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((BalanceTransactionSource'NonNullableConnectCollectionTransfer Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((BalanceTransactionSource'NonNullableCustomerCashBalanceTransaction Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((BalanceTransactionSource'NonNullableDispute Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((BalanceTransactionSource'NonNullableFeeRefund Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((BalanceTransactionSource'NonNullableIssuing'authorization Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((BalanceTransactionSource'NonNullableIssuing'dispute Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((BalanceTransactionSource'NonNullableIssuing'transaction Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((BalanceTransactionSource'NonNullablePayout Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((BalanceTransactionSource'NonNullableRefund Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((BalanceTransactionSource'NonNullableReserveTransaction Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((BalanceTransactionSource'NonNullableTaxDeductedAtSource Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((BalanceTransactionSource'NonNullableTopup Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((BalanceTransactionSource'NonNullableTransfer Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((BalanceTransactionSource'NonNullableTransferReversal Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched")))))))))))))))) of
...
data BalanceTransactionType'
  ...
  | -- | Represents the JSON value @"payout_minimum_balance_hold"@
    BalanceTransactionType'EnumPayoutMinimumBalanceHold
  | -- | Represents the JSON value @"payout_minimum_balance_release"@
    BalanceTransactionType'EnumPayoutMinimumBalanceRelease
  ...
  | -- | Represents the JSON value @"stripe_balance_payment_debit"@
    BalanceTransactionType'EnumStripeBalancePaymentDebit
  | -- | Represents the JSON value @"stripe_balance_payment_debit_reversal"@
    BalanceTransactionType'EnumStripeBalancePaymentDebitReversal
...
instance Data.Aeson.Types.ToJSON.ToJSON BalanceTransactionType' where
  ...
  toJSON (BalanceTransactionType'EnumPayoutMinimumBalanceHold) = "payout_minimum_balance_hold"
  toJSON (BalanceTransactionType'EnumPayoutMinimumBalanceRelease) = "payout_minimum_balance_release"
  ...
  toJSON (BalanceTransactionType'EnumStripeBalancePaymentDebit) = "stripe_balance_payment_debit"
  toJSON (BalanceTransactionType'EnumStripeBalancePaymentDebitReversal) = "stripe_balance_payment_debit_reversal"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "payout_minimum_balance_hold" -> BalanceTransactionType'EnumPayoutMinimumBalanceHold
          | val GHC.Classes.== "payout_minimum_balance_release" -> BalanceTransactionType'EnumPayoutMinimumBalanceRelease
          ...
          | val GHC.Classes.== "stripe_balance_payment_debit" -> BalanceTransactionType'EnumStripeBalancePaymentDebit
          | val GHC.Classes.== "stripe_balance_payment_debit_reversal" -> BalanceTransactionType'EnumStripeBalancePaymentDebitReversal
