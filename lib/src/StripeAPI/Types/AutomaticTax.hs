...
data AutomaticTax = AutomaticTax
  { -- | disabled_reason: If Stripe disabled automatic tax, this enum describes why.
    automaticTaxDisabledReason :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable AutomaticTaxDisabledReason'NonNullable)),
    ...
    automaticTaxProvider :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text)),
...
instance Data.Aeson.Types.ToJSON.ToJSON AutomaticTax where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("disabled_reason" Data.Aeson.Types.ToJSON..=)) (automaticTaxDisabledReason obj) : ["enabled" Data.Aeson.Types.ToJSON..= automaticTaxEnabled obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("liability" Data.Aeson.Types.ToJSON..=)) (automaticTaxLiability obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("provider" Data.Aeson.Types.ToJSON..=)) (automaticTaxProvider obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("status" Data.Aeson.Types.ToJSON..=)) (automaticTaxStatus obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("disabled_reason" Data.Aeson.Types.ToJSON..=)) (automaticTaxDisabledReason obj) : ["enabled" Data.Aeson.Types.ToJSON..= automaticTaxEnabled obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("liability" Data.Aeson.Types.ToJSON..=)) (automaticTaxLiability obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("provider" Data.Aeson.Types.ToJSON..=)) (automaticTaxProvider obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("status" Data.Aeson.Types.ToJSON..=)) (automaticTaxStatus obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON AutomaticTax where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "AutomaticTax" (\obj -> ((((GHC.Base.pure AutomaticTax GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "disabled_reason")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "enabled")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "liability")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "provider")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "status"))
...
mkAutomaticTax automaticTaxEnabled =
  AutomaticTax
    { automaticTaxDisabledReason = GHC.Maybe.Nothing,
      automaticTaxEnabled = automaticTaxEnabled,
      automaticTaxLiability = GHC.Maybe.Nothing,
      automaticTaxProvider = GHC.Maybe.Nothing,
...
data AutomaticTaxDisabledReason'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    AutomaticTaxDisabledReason'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    AutomaticTaxDisabledReason'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"finalization_requires_location_inputs"@
    AutomaticTaxDisabledReason'NonNullableEnumFinalizationRequiresLocationInputs
  | -- | Represents the JSON value @"finalization_system_error"@
    AutomaticTaxDisabledReason'NonNullableEnumFinalizationSystemError
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON AutomaticTaxDisabledReason'NonNullable where
  toJSON (AutomaticTaxDisabledReason'NonNullableOther val) = val
  toJSON (AutomaticTaxDisabledReason'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (AutomaticTaxDisabledReason'NonNullableEnumFinalizationRequiresLocationInputs) = "finalization_requires_location_inputs"
  toJSON (AutomaticTaxDisabledReason'NonNullableEnumFinalizationSystemError) = "finalization_system_error"

instance Data.Aeson.Types.FromJSON.FromJSON AutomaticTaxDisabledReason'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "finalization_requires_location_inputs" -> AutomaticTaxDisabledReason'NonNullableEnumFinalizationRequiresLocationInputs
          | val GHC.Classes.== "finalization_system_error" -> AutomaticTaxDisabledReason'NonNullableEnumFinalizationSystemError
          | GHC.Base.otherwise -> AutomaticTaxDisabledReason'NonNullableOther val
      )
...
instance Data.Aeson.Types.ToJSON.ToJSON AutomaticTaxLiability'NonNullable where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (automaticTaxLiability'NonNullableAccount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (automaticTaxLiability'NonNullableType obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (automaticTaxLiability'NonNullableAccount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (automaticTaxLiability'NonNullableType obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON AutomaticTaxLiability'NonNullable where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "AutomaticTaxLiability'NonNullable" (\obj -> (GHC.Base.pure AutomaticTaxLiability'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))
...
mkAutomaticTaxLiability'NonNullable =
  AutomaticTaxLiability'NonNullable
    { automaticTaxLiability'NonNullableAccount = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON AutomaticTaxLiability'NonNullableAccount'Variants where
  toJSON (AutomaticTaxLiability'NonNullableAccount'Text a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (AutomaticTaxLiability'NonNullableAccount'Account a) = Data.Aeson.Types.ToJSON.toJSON a

instance Data.Aeson.Types.FromJSON.FromJSON AutomaticTaxLiability'NonNullableAccount'Variants where
  parseJSON val = case (AutomaticTaxLiability'NonNullableAccount'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((AutomaticTaxLiability'NonNullableAccount'Account Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data AutomaticTaxLiability'NonNullableType'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    AutomaticTaxLiability'NonNullableType'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    AutomaticTaxLiability'NonNullableType'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"account"@
    AutomaticTaxLiability'NonNullableType'EnumAccount
  | -- | Represents the JSON value @"self"@
    AutomaticTaxLiability'NonNullableType'EnumSelf
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON AutomaticTaxLiability'NonNullableType' where
  toJSON (AutomaticTaxLiability'NonNullableType'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON AutomaticTaxLiability'NonNullableType' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "account" -> AutomaticTaxLiability'NonNullableType'EnumAccount
