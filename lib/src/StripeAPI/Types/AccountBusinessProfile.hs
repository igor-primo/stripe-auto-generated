...
data AccountBusinessProfile = AccountBusinessProfile
  { -- | annual_revenue: The applicant\'s gross annual revenue for its preceding fiscal year.
    ...
    accountBusinessProfileMinorityOwnedBusinessDesignation :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullable])),
...
mkAccountBusinessProfile =
  AccountBusinessProfile
    { accountBusinessProfileAnnualRevenue = GHC.Maybe.Nothing,
      accountBusinessProfileEstimatedWorkerCount = GHC.Maybe.Nothing,
      accountBusinessProfileMcc = GHC.Maybe.Nothing,
      accountBusinessProfileMinorityOwnedBusinessDesignation = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON AccountBusinessProfileAnnualRevenue'NonNullable where
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountBusinessProfileAnnualRevenue'NonNullable where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "AccountBusinessProfileAnnualRevenue'NonNullable" (\obj -> ((GHC.Base.pure AccountBusinessProfileAnnualRevenue'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "fiscal_year_end"))
...
mkAccountBusinessProfileAnnualRevenue'NonNullable =
  AccountBusinessProfileAnnualRevenue'NonNullable
    { accountBusinessProfileAnnualRevenue'NonNullableAmount = GHC.Maybe.Nothing,
...
data AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"lgbtqi_owned_business"@
    AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullableEnumLgbtqiOwnedBusiness
  | -- | Represents the JSON value @"minority_owned_business"@
    AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullableEnumMinorityOwnedBusiness
  | -- | Represents the JSON value @"none_of_these_apply"@
    AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullableEnumNoneOfTheseApply
  | -- | Represents the JSON value @"prefer_not_to_answer"@
    AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullableEnumPreferNotToAnswer
  | -- | Represents the JSON value @"women_owned_business"@
    AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullableEnumWomenOwnedBusiness
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullable where
  toJSON (AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullableOther val) = val
  toJSON (AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullableEnumLgbtqiOwnedBusiness) = "lgbtqi_owned_business"
  toJSON (AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullableEnumMinorityOwnedBusiness) = "minority_owned_business"
  toJSON (AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullableEnumNoneOfTheseApply) = "none_of_these_apply"
  toJSON (AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullableEnumPreferNotToAnswer) = "prefer_not_to_answer"
  toJSON (AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullableEnumWomenOwnedBusiness) = "women_owned_business"

instance Data.Aeson.Types.FromJSON.FromJSON AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "lgbtqi_owned_business" -> AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullableEnumLgbtqiOwnedBusiness
          | val GHC.Classes.== "minority_owned_business" -> AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullableEnumMinorityOwnedBusiness
          | val GHC.Classes.== "none_of_these_apply" -> AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullableEnumNoneOfTheseApply
          | val GHC.Classes.== "prefer_not_to_answer" -> AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullableEnumPreferNotToAnswer
          | val GHC.Classes.== "women_owned_business" -> AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullableEnumWomenOwnedBusiness
          | GHC.Base.otherwise -> AccountBusinessProfileMinorityOwnedBusinessDesignation'NonNullableOther val
      )
