...
data TaxRate = TaxRate
  { -- | active: Defaults to \`true\`. When set to \`false\`, this tax rate cannot be used with new applications or Checkout Sessions, but will still work for subscriptions and invoices that already have it set.
    ...
    taxRateFlatAmount :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable TaxRateFlatAmount'NonNullable)),
    ...
    taxRateRateType :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable TaxRateRateType'NonNullable)),
...
mkTaxRate taxRateActive taxRateCreated taxRateDisplayName taxRateId taxRateInclusive taxRateLivemode taxRatePercentage =
  TaxRate
    { taxRateActive = taxRateActive,
      ...
      taxRateFlatAmount = GHC.Maybe.Nothing,
      taxRateId = taxRateId,
      ...
      taxRateRateType = GHC.Maybe.Nothing,
...
data TaxRateFlatAmount'NonNullable = TaxRateFlatAmount'NonNullable
  { -- | amount: Amount of the tax when the \`rate_type\` is \`flat_amount\`. This positive integer represents how much to charge in the smallest currency unit (e.g., 100 cents to charge \$1.00 or 100 to charge ¥100, a zero-decimal currency). The amount value supports up to eight digits (e.g., a value of 99999999 for a USD charge of \$999,999.99).
    taxRateFlatAmount'NonNullableAmount :: (GHC.Maybe.Maybe GHC.Types.Int),
    -- | currency: Three-letter ISO currency code, in lowercase.
    --
    -- Constraints:
    --
    -- * Maximum length of 5000
    taxRateFlatAmount'NonNullableCurrency :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON TaxRateFlatAmount'NonNullable where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount" Data.Aeson.Types.ToJSON..=)) (taxRateFlatAmount'NonNullableAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (taxRateFlatAmount'NonNullableCurrency obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount" Data.Aeson.Types.ToJSON..=)) (taxRateFlatAmount'NonNullableAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (taxRateFlatAmount'NonNullableCurrency obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON TaxRateFlatAmount'NonNullable where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "TaxRateFlatAmount'NonNullable" (\obj -> (GHC.Base.pure TaxRateFlatAmount'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency"))

-- | Create a new 'TaxRateFlatAmount'NonNullable' with all required fields.
mkTaxRateFlatAmount'NonNullable :: TaxRateFlatAmount'NonNullable
mkTaxRateFlatAmount'NonNullable =
  TaxRateFlatAmount'NonNullable
    { taxRateFlatAmount'NonNullableAmount = GHC.Maybe.Nothing,
      taxRateFlatAmount'NonNullableCurrency = GHC.Maybe.Nothing
    }
...
data TaxRateJurisdictionLevel'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    TaxRateJurisdictionLevel'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    TaxRateJurisdictionLevel'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"city"@
    TaxRateJurisdictionLevel'NonNullableEnumCity
  | -- | Represents the JSON value @"country"@
    TaxRateJurisdictionLevel'NonNullableEnumCountry
  | -- | Represents the JSON value @"county"@
    TaxRateJurisdictionLevel'NonNullableEnumCounty
  | -- | Represents the JSON value @"district"@
    TaxRateJurisdictionLevel'NonNullableEnumDistrict
  | -- | Represents the JSON value @"multiple"@
    TaxRateJurisdictionLevel'NonNullableEnumMultiple
  | -- | Represents the JSON value @"state"@
    TaxRateJurisdictionLevel'NonNullableEnumState
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON TaxRateJurisdictionLevel'NonNullable where
  toJSON (TaxRateJurisdictionLevel'NonNullableOther val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON TaxRateJurisdictionLevel'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "city" -> TaxRateJurisdictionLevel'NonNullableEnumCity
...
data TaxRateRateType'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    TaxRateRateType'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    TaxRateRateType'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"flat_amount"@
    TaxRateRateType'NonNullableEnumFlatAmount
  | -- | Represents the JSON value @"percentage"@
    TaxRateRateType'NonNullableEnumPercentage
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON TaxRateRateType'NonNullable where
  toJSON (TaxRateRateType'NonNullableOther val) = val
  toJSON (TaxRateRateType'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (TaxRateRateType'NonNullableEnumFlatAmount) = "flat_amount"
  toJSON (TaxRateRateType'NonNullableEnumPercentage) = "percentage"

instance Data.Aeson.Types.FromJSON.FromJSON TaxRateRateType'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "flat_amount" -> TaxRateRateType'NonNullableEnumFlatAmount
          | val GHC.Classes.== "percentage" -> TaxRateRateType'NonNullableEnumPercentage
          | GHC.Base.otherwise -> TaxRateRateType'NonNullableOther val
      )
...
data TaxRateTaxType'NonNullable
  ...
  | -- | Represents the JSON value @"qst"@
    TaxRateTaxType'NonNullableEnumQst
  | -- | Represents the JSON value @"retail_delivery_fee"@
    TaxRateTaxType'NonNullableEnumRetailDeliveryFee
...
instance Data.Aeson.Types.ToJSON.ToJSON TaxRateTaxType'NonNullable where
  ...
  toJSON (TaxRateTaxType'NonNullableEnumRetailDeliveryFee) = "retail_delivery_fee"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "retail_delivery_fee" -> TaxRateTaxType'NonNullableEnumRetailDeliveryFee
