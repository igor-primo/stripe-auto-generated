...
data PaymentMethodCard = PaymentMethodCard
  { -- | brand: Card brand. Can be \`amex\`, \`cartes_bancaires\`, \`diners\`, \`discover\`, \`eftpos_au\`, \`jcb\`, \`link\`, \`mastercard\`, \`unionpay\`, \`visa\` or \`unknown\`.
    ...
    --
    -- * Maximum length of 5000
    paymentMethodCardDisplayBrand :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text)),
    ...
    paymentMethodCardRegulatedStatus :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PaymentMethodCardRegulatedStatus'NonNullable)),
...
mkPaymentMethodCard paymentMethodCardBrand paymentMethodCardExpMonth paymentMethodCardExpYear paymentMethodCardFunding paymentMethodCardLast4 =
  PaymentMethodCard
    { paymentMethodCardBrand = paymentMethodCardBrand,
      ...
      paymentMethodCardDisplayBrand = GHC.Maybe.Nothing,
      ...
      paymentMethodCardRegulatedStatus = GHC.Maybe.Nothing,
...
-- | Defines the enum schema located at @components.schemas.payment_method_card.properties.regulated_status@ in the specification.
--
-- Status of a card based on the card issuer.
data PaymentMethodCardRegulatedStatus'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    PaymentMethodCardRegulatedStatus'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    PaymentMethodCardRegulatedStatus'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"regulated"@
    PaymentMethodCardRegulatedStatus'NonNullableEnumRegulated
  | -- | Represents the JSON value @"unregulated"@
    PaymentMethodCardRegulatedStatus'NonNullableEnumUnregulated
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodCardRegulatedStatus'NonNullable where
  toJSON (PaymentMethodCardRegulatedStatus'NonNullableOther val) = val
  toJSON (PaymentMethodCardRegulatedStatus'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (PaymentMethodCardRegulatedStatus'NonNullableEnumRegulated) = "regulated"
  toJSON (PaymentMethodCardRegulatedStatus'NonNullableEnumUnregulated) = "unregulated"

instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodCardRegulatedStatus'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "regulated" -> PaymentMethodCardRegulatedStatus'NonNullableEnumRegulated
          | val GHC.Classes.== "unregulated" -> PaymentMethodCardRegulatedStatus'NonNullableEnumUnregulated
          | GHC.Base.otherwise -> PaymentMethodCardRegulatedStatus'NonNullableOther val
      )
