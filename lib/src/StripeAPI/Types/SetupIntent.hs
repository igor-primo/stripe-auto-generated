...
data SetupIntentLastSetupError'NonNullable = SetupIntentLastSetupError'NonNullable
  { -- | advice_code: For card errors resulting from a card issuer decline, a short string indicating [how to proceed with an error](https:\/\/stripe.com\/docs\/declines\#retrying-issuer-declines) if they provide one.
    ...
    --
    -- * Maximum length of 5000
    setupIntentLastSetupError'NonNullableAdviceCode :: (GHC.Maybe.Maybe Data.Text.Internal.Text),
    ...
    --
    -- * Maximum length of 5000
    setupIntentLastSetupError'NonNullableNetworkAdviceCode :: (GHC.Maybe.Maybe Data.Text.Internal.Text),
    ...
    --
    -- * Maximum length of 5000
    setupIntentLastSetupError'NonNullableNetworkDeclineCode :: (GHC.Maybe.Maybe Data.Text.Internal.Text),
...
mkSetupIntentLastSetupError'NonNullable =
  SetupIntentLastSetupError'NonNullable
    { setupIntentLastSetupError'NonNullableAdviceCode = GHC.Maybe.Nothing,
      ...
      setupIntentLastSetupError'NonNullableNetworkAdviceCode = GHC.Maybe.Nothing,
      setupIntentLastSetupError'NonNullableNetworkDeclineCode = GHC.Maybe.Nothing,
...
data SetupIntentLastSetupError'NonNullableSource' = SetupIntentLastSetupError'NonNullableSource'
  { -- | account: The account this bank account belongs to. Only applicable on Accounts (not customers or recipients) This property is only available when returned as an [External Account](\/api\/external_account_bank_accounts\/object) where [controller.is_controller](\/api\/accounts\/object\#account_object-controller-is_controller) is \`true\`.
    ...
    setupIntentLastSetupError'NonNullableSource'AllowRedisplay :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullable)),
    ...
    --
    -- * Maximum length of 5000
    setupIntentLastSetupError'NonNullableSource'Iin :: (GHC.Maybe.Maybe Data.Text.Internal.Text),
    -- | klarna
    ...
    -- | networks:
    setupIntentLastSetupError'NonNullableSource'Networks :: (GHC.Maybe.Maybe TokenCardNetworks),
    ...
    setupIntentLastSetupError'NonNullableSource'RegulatedStatus :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullable)),
...
mkSetupIntentLastSetupError'NonNullableSource' =
  SetupIntentLastSetupError'NonNullableSource'
    { setupIntentLastSetupError'NonNullableSource'Account = GHC.Maybe.Nothing,
      ...
      setupIntentLastSetupError'NonNullableSource'AllowRedisplay = GHC.Maybe.Nothing,
      ...
      setupIntentLastSetupError'NonNullableSource'Iin = GHC.Maybe.Nothing,
      ...
      setupIntentLastSetupError'NonNullableSource'Networks = GHC.Maybe.Nothing,
      ...
      setupIntentLastSetupError'NonNullableSource'RegulatedStatus = GHC.Maybe.Nothing,
...
data SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"always"@
    SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableEnumAlways
  | -- | Represents the JSON value @"limited"@
    SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableEnumLimited
  | -- | Represents the JSON value @"unspecified"@
    SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableEnumUnspecified
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullable where
  toJSON (SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableOther val) = val
  toJSON (SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableEnumAlways) = "always"
  toJSON (SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableEnumLimited) = "limited"
  toJSON (SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableEnumUnspecified) = "unspecified"

instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "always" -> SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableEnumAlways
          | val GHC.Classes.== "limited" -> SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableEnumLimited
          | val GHC.Classes.== "unspecified" -> SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableEnumUnspecified
          | GHC.Base.otherwise -> SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableOther val
      )
...
data SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"regulated"@
    SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullableEnumRegulated
  | -- | Represents the JSON value @"unregulated"@
    SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullableEnumUnregulated
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullable where
  toJSON (SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullableOther val) = val
  toJSON (SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullableEnumRegulated) = "regulated"
  toJSON (SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullableEnumUnregulated) = "unregulated"

instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "regulated" -> SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullableEnumRegulated
          | val GHC.Classes.== "unregulated" -> SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullableEnumUnregulated
          | GHC.Base.otherwise -> SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullableOther val
      )
...
data SetupIntentPaymentMethodOptions'NonNullable = SetupIntentPaymentMethodOptions'NonNullable
  { -- | acss_debit
    ...
    -- | amazon_pay
    setupIntentPaymentMethodOptions'NonNullableAmazonPay :: (GHC.Maybe.Maybe SetupIntentPaymentMethodOptions'NonNullableAmazonPay'),
    -- | bacs_debit
    setupIntentPaymentMethodOptions'NonNullableBacsDebit :: (GHC.Maybe.Maybe SetupIntentPaymentMethodOptions'NonNullableBacsDebit'),
    -- | card
    setupIntentPaymentMethodOptions'NonNullableCard :: (GHC.Maybe.Maybe SetupIntentPaymentMethodOptions'NonNullableCard'),
    -- | card_present
    setupIntentPaymentMethodOptions'NonNullableCardPresent :: (GHC.Maybe.Maybe SetupIntentPaymentMethodOptions'NonNullableCardPresent'),
    -- | klarna
    setupIntentPaymentMethodOptions'NonNullableKlarna :: (GHC.Maybe.Maybe SetupIntentPaymentMethodOptions'NonNullableKlarna'),
    -- | link
...
mkSetupIntentPaymentMethodOptions'NonNullable =
  SetupIntentPaymentMethodOptions'NonNullable
    { setupIntentPaymentMethodOptions'NonNullableAcssDebit = GHC.Maybe.Nothing,
      setupIntentPaymentMethodOptions'NonNullableAmazonPay = GHC.Maybe.Nothing,
      setupIntentPaymentMethodOptions'NonNullableBacsDebit = GHC.Maybe.Nothing,
      setupIntentPaymentMethodOptions'NonNullableCard = GHC.Maybe.Nothing,
      setupIntentPaymentMethodOptions'NonNullableCardPresent = GHC.Maybe.Nothing,
      setupIntentPaymentMethodOptions'NonNullableKlarna = GHC.Maybe.Nothing,
...
data SetupIntentPaymentMethodOptions'NonNullableAmazonPay' = SetupIntentPaymentMethodOptions'NonNullableAmazonPay'
  { -- | verification_method: Bank account verification method.
    setupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod :: (GHC.Maybe.Maybe SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod')
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableAmazonPay' where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableAmazonPay' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptions'NonNullableAmazonPay'" (\obj -> GHC.Base.pure SetupIntentPaymentMethodOptions'NonNullableAmazonPay' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))

-- | Create a new 'SetupIntentPaymentMethodOptions'NonNullableAmazonPay'' with all required fields.
mkSetupIntentPaymentMethodOptions'NonNullableAmazonPay' :: SetupIntentPaymentMethodOptions'NonNullableAmazonPay'
mkSetupIntentPaymentMethodOptions'NonNullableAmazonPay' = SetupIntentPaymentMethodOptions'NonNullableAmazonPay' {setupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod = GHC.Maybe.Nothing}
...
data SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"automatic"@
    SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'EnumAutomatic
  | -- | Represents the JSON value @"instant"@
    SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'EnumInstant
  | -- | Represents the JSON value @"microdeposits"@
    SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'EnumMicrodeposits
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod' where
  toJSON (SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'Other val) = val
  toJSON (SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'EnumAutomatic) = "automatic"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'EnumInstant) = "instant"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'EnumMicrodeposits) = "microdeposits"

instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'EnumAutomatic
          | val GHC.Classes.== "instant" -> SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'EnumInstant
          | val GHC.Classes.== "microdeposits" -> SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'EnumMicrodeposits
          | GHC.Base.otherwise -> SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'Other val
      )
...
data SetupIntentPaymentMethodOptions'NonNullableBacsDebit' = SetupIntentPaymentMethodOptions'NonNullableBacsDebit'
  { -- | mandate_options:
    setupIntentPaymentMethodOptions'NonNullableBacsDebit'MandateOptions :: (GHC.Maybe.Maybe SetupIntentPaymentMethodOptionsMandateOptionsBacsDebit),
    -- | verification_method: Bank account verification method.
    setupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod :: (GHC.Maybe.Maybe SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod')
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableBacsDebit' where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableBacsDebit'MandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableBacsDebit'MandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableBacsDebit' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptions'NonNullableBacsDebit'" (\obj -> (GHC.Base.pure SetupIntentPaymentMethodOptions'NonNullableBacsDebit' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mandate_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))

-- | Create a new 'SetupIntentPaymentMethodOptions'NonNullableBacsDebit'' with all required fields.
mkSetupIntentPaymentMethodOptions'NonNullableBacsDebit' :: SetupIntentPaymentMethodOptions'NonNullableBacsDebit'
mkSetupIntentPaymentMethodOptions'NonNullableBacsDebit' =
  SetupIntentPaymentMethodOptions'NonNullableBacsDebit'
    { setupIntentPaymentMethodOptions'NonNullableBacsDebit'MandateOptions = GHC.Maybe.Nothing,
      setupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod = GHC.Maybe.Nothing
    }
...
data SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"automatic"@
    SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'EnumAutomatic
  | -- | Represents the JSON value @"instant"@
    SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'EnumInstant
  | -- | Represents the JSON value @"microdeposits"@
    SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'EnumMicrodeposits
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod' where
  toJSON (SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'Other val) = val
  toJSON (SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'EnumAutomatic) = "automatic"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'EnumInstant) = "instant"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'EnumMicrodeposits) = "microdeposits"

instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'EnumAutomatic
          | val GHC.Classes.== "instant" -> SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'EnumInstant
          | val GHC.Classes.== "microdeposits" -> SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'EnumMicrodeposits
          | GHC.Base.otherwise -> SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'Other val
      )
...
data SetupIntentPaymentMethodOptions'NonNullableCard' = SetupIntentPaymentMethodOptions'NonNullableCard'
  { -- | mandate_options: Configuration options for setting up an eMandate for cards issued in India.
    setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullable)),
    ...
    setupIntentPaymentMethodOptions'NonNullableCard'Network :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullable)),
    -- | request_three_d_secure: We strongly recommend that you rely on our SCA Engine to automatically prompt your customers for authentication based on risk level and [other requirements](https:\/\/stripe.com\/docs\/strong-customer-authentication). However, if you wish to request 3D Secure based on logic from your own fraud engine, provide this option. If not provided, this value defaults to \`automatic\`. Read our guide on [manually requesting 3D Secure](https:\/\/stripe.com\/docs\/payments\/3d-secure\/authentication-flow\#manual-three-ds) for more information on how this configuration interacts with Radar and our SCA Engine.
    setupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullable)),
    -- | verification_method: Bank account verification method.
    setupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod :: (GHC.Maybe.Maybe SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod')
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableCard' where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("network" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'Network obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("request_three_d_secure" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("network" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'Network obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("request_three_d_secure" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableCard' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptions'NonNullableCard'" (\obj -> (((GHC.Base.pure SetupIntentPaymentMethodOptions'NonNullableCard' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mandate_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "network")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "request_three_d_secure")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))

-- | Create a new 'SetupIntentPaymentMethodOptions'NonNullableCard'' with all required fields.
mkSetupIntentPaymentMethodOptions'NonNullableCard' :: SetupIntentPaymentMethodOptions'NonNullableCard'
mkSetupIntentPaymentMethodOptions'NonNullableCard' =
  SetupIntentPaymentMethodOptions'NonNullableCard'
    { setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions = GHC.Maybe.Nothing,
      setupIntentPaymentMethodOptions'NonNullableCard'Network = GHC.Maybe.Nothing,
      setupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure = GHC.Maybe.Nothing,
      setupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod = GHC.Maybe.Nothing
    }
...
data SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullable = SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullable
  { -- | amount: Amount to be charged for future payments.
    setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmount :: (GHC.Maybe.Maybe GHC.Types.Int),
    ...
    setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType :: (GHC.Maybe.Maybe SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'),
    -- | currency: Three-letter [ISO currency code](https:\/\/www.iso.org\/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https:\/\/stripe.com\/docs\/currencies).
    setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableCurrency :: (GHC.Maybe.Maybe Data.Text.Internal.Text),
    -- | description: A description of the mandate or subscription that is meant to be displayed to the customer.
    --
    -- Constraints:
    --
    -- * Maximum length of 200
    setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableDescription :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text)),
    ...
    setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableEndDate :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable GHC.Types.Int)),
    -- | interval: Specifies payment frequency. One of \`day\`, \`week\`, \`month\`, \`year\`, or \`sporadic\`.
    setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval :: (GHC.Maybe.Maybe SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'),
    ...
    setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableIntervalCount :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable GHC.Types.Int)),
    -- | reference: Unique identifier for the mandate or subscription.
    --
    -- Constraints:
    --
    -- * Maximum length of 80
    setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableReference :: (GHC.Maybe.Maybe Data.Text.Internal.Text),
    -- | start_date: Start date of the mandate or subscription. Start date should not be lesser than yesterday.
    setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableStartDate :: (GHC.Maybe.Maybe GHC.Types.Int),
    -- | supported_types: Specifies the type of mandates supported. Possible values are \`india\`.
    setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes'NonNullable]))
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullable where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount_type" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableCurrency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("description" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableDescription obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("end_date" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableEndDate obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval_count" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableIntervalCount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("reference" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableReference obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("start_date" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableStartDate obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("supported_types" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount_type" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableCurrency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("description" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableDescription obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("end_date" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableEndDate obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval_count" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableIntervalCount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("reference" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableReference obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("start_date" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableStartDate obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("supported_types" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullable where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullable" (\obj -> (((((((((GHC.Base.pure SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "end_date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "interval")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "interval_count")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reference")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "start_date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "supported_types"))

-- | Create a new 'SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullable' with all required fields.
mkSetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullable :: SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullable
mkSetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullable =
  SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullable
    { setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmount = GHC.Maybe.Nothing,
      setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType = GHC.Maybe.Nothing,
      setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableCurrency = GHC.Maybe.Nothing,
      setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableDescription = GHC.Maybe.Nothing,
      setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableEndDate = GHC.Maybe.Nothing,
      setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval = GHC.Maybe.Nothing,
      setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableIntervalCount = GHC.Maybe.Nothing,
      setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableReference = GHC.Maybe.Nothing,
      setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableStartDate = GHC.Maybe.Nothing,
      setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes = GHC.Maybe.Nothing
    }
...
data SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"fixed"@
    SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'EnumFixed
  | -- | Represents the JSON value @"maximum"@
    SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'EnumMaximum
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType' where
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'Other val) = val
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'EnumFixed) = "fixed"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'EnumMaximum) = "maximum"

instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "fixed" -> SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'EnumFixed
          | val GHC.Classes.== "maximum" -> SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'EnumMaximum
          | GHC.Base.otherwise -> SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'Other val
      )
...
data SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"day"@
    SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumDay
  | -- | Represents the JSON value @"month"@
    SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumMonth
  | -- | Represents the JSON value @"sporadic"@
    SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumSporadic
  | -- | Represents the JSON value @"week"@
    SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumWeek
  | -- | Represents the JSON value @"year"@
    SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumYear
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval' where
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'Other val) = val
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumDay) = "day"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumMonth) = "month"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumSporadic) = "sporadic"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumWeek) = "week"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumYear) = "year"

instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "day" -> SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumDay
          | val GHC.Classes.== "month" -> SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumMonth
          | val GHC.Classes.== "sporadic" -> SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumSporadic
          | val GHC.Classes.== "week" -> SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumWeek
          | val GHC.Classes.== "year" -> SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumYear
          | GHC.Base.otherwise -> SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'Other val
      )
...
data SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"india"@
    SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes'NonNullableEnumIndia
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes'NonNullable where
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes'NonNullableOther val) = val
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes'NonNullableEnumIndia) = "india"

instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "india" -> SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes'NonNullableEnumIndia
          | GHC.Base.otherwise -> SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes'NonNullableOther val
      )
...
data SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"amex"@
    SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumAmex
  | -- | Represents the JSON value @"cartes_bancaires"@
    SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumCartesBancaires
  | -- | Represents the JSON value @"diners"@
    SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumDiners
  | -- | Represents the JSON value @"discover"@
    SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumDiscover
  | -- | Represents the JSON value @"eftpos_au"@
    SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumEftposAu
  | -- | Represents the JSON value @"girocard"@
    SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumGirocard
  | -- | Represents the JSON value @"interac"@
    SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumInterac
  | -- | Represents the JSON value @"jcb"@
    SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumJcb
  | -- | Represents the JSON value @"link"@
    SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumLink
  | -- | Represents the JSON value @"mastercard"@
    SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumMastercard
  | -- | Represents the JSON value @"unionpay"@
    SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumUnionpay
  | -- | Represents the JSON value @"unknown"@
    SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumUnknown
  | -- | Represents the JSON value @"visa"@
    SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumVisa
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullable where
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableOther val) = val
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumAmex) = "amex"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumCartesBancaires) = "cartes_bancaires"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumDiners) = "diners"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumDiscover) = "discover"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumEftposAu) = "eftpos_au"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumGirocard) = "girocard"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumInterac) = "interac"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumJcb) = "jcb"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumLink) = "link"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumMastercard) = "mastercard"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumUnionpay) = "unionpay"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumUnknown) = "unknown"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumVisa) = "visa"

instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "amex" -> SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumAmex
          | val GHC.Classes.== "cartes_bancaires" -> SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumCartesBancaires
          | val GHC.Classes.== "diners" -> SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumDiners
          | val GHC.Classes.== "discover" -> SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumDiscover
          | val GHC.Classes.== "eftpos_au" -> SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumEftposAu
          | val GHC.Classes.== "girocard" -> SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumGirocard
          | val GHC.Classes.== "interac" -> SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumInterac
          | val GHC.Classes.== "jcb" -> SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumJcb
          | val GHC.Classes.== "link" -> SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumLink
          | val GHC.Classes.== "mastercard" -> SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumMastercard
          | val GHC.Classes.== "unionpay" -> SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumUnionpay
          | val GHC.Classes.== "unknown" -> SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumUnknown
          | val GHC.Classes.== "visa" -> SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumVisa
          | GHC.Base.otherwise -> SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableOther val
      )
...
data SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"any"@
    SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableEnumAny
  | -- | Represents the JSON value @"automatic"@
    SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableEnumAutomatic
  | -- | Represents the JSON value @"challenge"@
    SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableEnumChallenge
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullable where
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableOther val) = val
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableEnumAny) = "any"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableEnumAutomatic) = "automatic"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableEnumChallenge) = "challenge"

instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "any" -> SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableEnumAny
          | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableEnumAutomatic
          | val GHC.Classes.== "challenge" -> SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableEnumChallenge
          | GHC.Base.otherwise -> SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableOther val
      )
...
data SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"automatic"@
    SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'EnumAutomatic
  | -- | Represents the JSON value @"instant"@
    SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'EnumInstant
  | -- | Represents the JSON value @"microdeposits"@
    SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'EnumMicrodeposits
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod' where
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'Other val) = val
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'EnumAutomatic) = "automatic"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'EnumInstant) = "instant"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'EnumMicrodeposits) = "microdeposits"

instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'EnumAutomatic
          | val GHC.Classes.== "instant" -> SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'EnumInstant
          | val GHC.Classes.== "microdeposits" -> SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'EnumMicrodeposits
          | GHC.Base.otherwise -> SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'Other val
      )
...
data SetupIntentPaymentMethodOptions'NonNullableCardPresent' = SetupIntentPaymentMethodOptions'NonNullableCardPresent'
  { -- | verification_method: Bank account verification method.
    setupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod :: (GHC.Maybe.Maybe SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod')
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableCardPresent' where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableCardPresent' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptions'NonNullableCardPresent'" (\obj -> GHC.Base.pure SetupIntentPaymentMethodOptions'NonNullableCardPresent' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))

-- | Create a new 'SetupIntentPaymentMethodOptions'NonNullableCardPresent'' with all required fields.
mkSetupIntentPaymentMethodOptions'NonNullableCardPresent' :: SetupIntentPaymentMethodOptions'NonNullableCardPresent'
mkSetupIntentPaymentMethodOptions'NonNullableCardPresent' = SetupIntentPaymentMethodOptions'NonNullableCardPresent' {setupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod = GHC.Maybe.Nothing}
...
data SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"automatic"@
    SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'EnumAutomatic
  | -- | Represents the JSON value @"instant"@
    SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'EnumInstant
  | -- | Represents the JSON value @"microdeposits"@
    SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'EnumMicrodeposits
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod' where
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'Other val) = val
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'EnumAutomatic) = "automatic"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'EnumInstant) = "instant"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'EnumMicrodeposits) = "microdeposits"

instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'EnumAutomatic
          | val GHC.Classes.== "instant" -> SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'EnumInstant
          | val GHC.Classes.== "microdeposits" -> SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'EnumMicrodeposits
          | GHC.Base.otherwise -> SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'Other val
      )
...
data SetupIntentPaymentMethodOptions'NonNullableKlarna' = SetupIntentPaymentMethodOptions'NonNullableKlarna'
  { -- | currency: The currency of the setup intent. Three letter ISO currency code.
    setupIntentPaymentMethodOptions'NonNullableKlarna'Currency :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text)),
    -- | preferred_locale: Preferred locale of the Klarna checkout page that the customer is redirected to.
    --
    -- Constraints:
    --
    -- * Maximum length of 5000
    setupIntentPaymentMethodOptions'NonNullableKlarna'PreferredLocale :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text)),
    -- | verification_method: Bank account verification method.
    setupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod :: (GHC.Maybe.Maybe SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod')
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableKlarna' where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableKlarna'Currency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("preferred_locale" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableKlarna'PreferredLocale obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableKlarna'Currency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("preferred_locale" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableKlarna'PreferredLocale obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableKlarna' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptions'NonNullableKlarna'" (\obj -> ((GHC.Base.pure SetupIntentPaymentMethodOptions'NonNullableKlarna' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "preferred_locale")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))

-- | Create a new 'SetupIntentPaymentMethodOptions'NonNullableKlarna'' with all required fields.
mkSetupIntentPaymentMethodOptions'NonNullableKlarna' :: SetupIntentPaymentMethodOptions'NonNullableKlarna'
mkSetupIntentPaymentMethodOptions'NonNullableKlarna' =
  SetupIntentPaymentMethodOptions'NonNullableKlarna'
    { setupIntentPaymentMethodOptions'NonNullableKlarna'Currency = GHC.Maybe.Nothing,
      setupIntentPaymentMethodOptions'NonNullableKlarna'PreferredLocale = GHC.Maybe.Nothing,
      setupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod = GHC.Maybe.Nothing
    }
...
data SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"automatic"@
    SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'EnumAutomatic
  | -- | Represents the JSON value @"instant"@
    SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'EnumInstant
  | -- | Represents the JSON value @"microdeposits"@
    SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'EnumMicrodeposits
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod' where
  toJSON (SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'Other val) = val
  toJSON (SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'EnumAutomatic) = "automatic"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'EnumInstant) = "instant"
  toJSON (SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'EnumMicrodeposits) = "microdeposits"

instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'EnumAutomatic
          | val GHC.Classes.== "instant" -> SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'EnumInstant
          | val GHC.Classes.== "microdeposits" -> SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'EnumMicrodeposits
          | GHC.Base.otherwise -> SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'Other val
      )
...
data SetupIntentPaymentMethodOptions'NonNullableUsBankAccount' = SetupIntentPaymentMethodOptions'NonNullableUsBankAccount'
  { -- | financial_connections:
    setupIntentPaymentMethodOptions'NonNullableUsBankAccount'FinancialConnections :: (GHC.Maybe.Maybe LinkedAccountOptionsCommon),
    -- | mandate_options:
