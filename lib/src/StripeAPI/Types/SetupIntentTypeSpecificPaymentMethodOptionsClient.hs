...
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentTypeSpecificPaymentMethodOptionsClient where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentTypeSpecificPaymentMethodOptionsClient where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentTypeSpecificPaymentMethodOptionsClient" (\obj -> GHC.Base.pure SetupIntentTypeSpecificPaymentMethodOptionsClient GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))
...
data SetupIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    SetupIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    SetupIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"automatic"@
    SetupIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod'EnumAutomatic
  | -- | Represents the JSON value @"instant"@
    SetupIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod'EnumInstant
  | -- | Represents the JSON value @"microdeposits"@
    SetupIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod'EnumMicrodeposits
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod' where
  toJSON (SetupIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod' where
  parseJSON val =
    GHC.Base.pure
      ( if
