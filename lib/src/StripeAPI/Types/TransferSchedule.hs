...
data TransferSchedule = TransferSchedule
  { -- | delay_days: The number of days charges for the account will be held before being paid out.
    ...
    transferScheduleMonthlyPayoutDays :: (GHC.Maybe.Maybe [GHC.Types.Int]),
    ...
    transferScheduleWeeklyPayoutDays :: (GHC.Maybe.Maybe [TransferScheduleWeeklyPayoutDays'])
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.FromJSON.FromJSON TransferSchedule where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "TransferSchedule" (\obj -> (((((GHC.Base.pure TransferSchedule GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "delay_days")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "interval")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "monthly_anchor")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "monthly_payout_days")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "weekly_anchor")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "weekly_payout_days"))
...
mkTransferSchedule transferScheduleDelayDays transferScheduleInterval =
  TransferSchedule
    { transferScheduleDelayDays = transferScheduleDelayDays,
      ...
      transferScheduleMonthlyPayoutDays = GHC.Maybe.Nothing,
      transferScheduleWeeklyAnchor = GHC.Maybe.Nothing,
      transferScheduleWeeklyPayoutDays = GHC.Maybe.Nothing
    }
...
data TransferScheduleWeeklyPayoutDays'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    TransferScheduleWeeklyPayoutDays'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    TransferScheduleWeeklyPayoutDays'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"friday"@
    TransferScheduleWeeklyPayoutDays'EnumFriday
  | -- | Represents the JSON value @"monday"@
    TransferScheduleWeeklyPayoutDays'EnumMonday
  | -- | Represents the JSON value @"saturday"@
    TransferScheduleWeeklyPayoutDays'EnumSaturday
  | -- | Represents the JSON value @"sunday"@
    TransferScheduleWeeklyPayoutDays'EnumSunday
  | -- | Represents the JSON value @"thursday"@
    TransferScheduleWeeklyPayoutDays'EnumThursday
  | -- | Represents the JSON value @"tuesday"@
    TransferScheduleWeeklyPayoutDays'EnumTuesday
  | -- | Represents the JSON value @"wednesday"@
    TransferScheduleWeeklyPayoutDays'EnumWednesday
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON TransferScheduleWeeklyPayoutDays' where
  toJSON (TransferScheduleWeeklyPayoutDays'Other val) = val
  toJSON (TransferScheduleWeeklyPayoutDays'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (TransferScheduleWeeklyPayoutDays'EnumFriday) = "friday"
  toJSON (TransferScheduleWeeklyPayoutDays'EnumMonday) = "monday"
  toJSON (TransferScheduleWeeklyPayoutDays'EnumSaturday) = "saturday"
  toJSON (TransferScheduleWeeklyPayoutDays'EnumSunday) = "sunday"
  toJSON (TransferScheduleWeeklyPayoutDays'EnumThursday) = "thursday"
  toJSON (TransferScheduleWeeklyPayoutDays'EnumTuesday) = "tuesday"
  toJSON (TransferScheduleWeeklyPayoutDays'EnumWednesday) = "wednesday"

instance Data.Aeson.Types.FromJSON.FromJSON TransferScheduleWeeklyPayoutDays' where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "friday" -> TransferScheduleWeeklyPayoutDays'EnumFriday
          | val GHC.Classes.== "monday" -> TransferScheduleWeeklyPayoutDays'EnumMonday
          | val GHC.Classes.== "saturday" -> TransferScheduleWeeklyPayoutDays'EnumSaturday
          | val GHC.Classes.== "sunday" -> TransferScheduleWeeklyPayoutDays'EnumSunday
          | val GHC.Classes.== "thursday" -> TransferScheduleWeeklyPayoutDays'EnumThursday
          | val GHC.Classes.== "tuesday" -> TransferScheduleWeeklyPayoutDays'EnumTuesday
          | val GHC.Classes.== "wednesday" -> TransferScheduleWeeklyPayoutDays'EnumWednesday
          | GHC.Base.otherwise -> TransferScheduleWeeklyPayoutDays'Other val
      )
