...
import {-# SOURCE #-} StripeAPI.Types.CheckoutAmazonPayPaymentMethodOptions
...
import {-# SOURCE #-} StripeAPI.Types.CheckoutKakaoPayPaymentMethodOptions
...
import {-# SOURCE #-} StripeAPI.Types.CheckoutKrCardPaymentMethodOptions
import {-# SOURCE #-} StripeAPI.Types.CheckoutLinkPaymentMethodOptions
import {-# SOURCE #-} StripeAPI.Types.CheckoutLinkWalletOptions
import {-# SOURCE #-} StripeAPI.Types.CheckoutMobilepayPaymentMethodOptions
import {-# SOURCE #-} StripeAPI.Types.CheckoutMultibancoPaymentMethodOptions
import {-# SOURCE #-} StripeAPI.Types.CheckoutNaverPayPaymentMethodOptions
...
import {-# SOURCE #-} StripeAPI.Types.CheckoutPaycoPaymentMethodOptions
...
import {-# SOURCE #-} StripeAPI.Types.CheckoutRevolutPayPaymentMethodOptions
import {-# SOURCE #-} StripeAPI.Types.CheckoutSamsungPayPaymentMethodOptions
...
import {-# SOURCE #-} StripeAPI.Types.CheckoutSessionWalletOptions
import {-# SOURCE #-} StripeAPI.Types.CheckoutSofortPaymentMethodOptions
import {-# SOURCE #-} StripeAPI.Types.CheckoutSwishPaymentMethodOptions
...
import {-# SOURCE #-} StripeAPI.Types.PaymentPagesCheckoutSessionAdaptivePricing
...
import {-# SOURCE #-} StripeAPI.Types.PaymentPagesCheckoutSessionCollectedInformation
...
import {-# SOURCE #-} StripeAPI.Types.PaymentPagesCheckoutSessionDiscount
...
import {-# SOURCE #-} StripeAPI.Types.PaymentPagesCheckoutSessionOptionalItem
import {-# SOURCE #-} StripeAPI.Types.PaymentPagesCheckoutSessionPaymentMethodReuseAgreement
import {-# SOURCE #-} StripeAPI.Types.PaymentPagesCheckoutSessionPermissions
import {-# SOURCE #-} StripeAPI.Types.PaymentPagesCheckoutSessionPhoneNumberCollection
import {-# SOURCE #-} StripeAPI.Types.PaymentPagesCheckoutSessionSavedPaymentMethodOptions
...
data Checkout'session = Checkout'session
  { -- | adaptive_pricing: Settings for price localization with [Adaptive Pricing](https:\/\/docs.stripe.com\/payments\/checkout\/adaptive-pricing).
    checkout'sessionAdaptivePricing :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Checkout'sessionAdaptivePricing'NonNullable)),
    ...
    checkout'sessionCollectedInformation :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Checkout'sessionCollectedInformation'NonNullable)),
    ...
    checkout'sessionDiscounts :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [PaymentPagesCheckoutSessionDiscount])),
    ...
    checkout'sessionOptionalItems :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [PaymentPagesCheckoutSessionOptionalItem])),
    -- | origin_context: Where the user is coming from. This informs the optimizations that are applied to the session.
    checkout'sessionOriginContext :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Checkout'sessionOriginContext'NonNullable)),
    ...
    checkout'sessionPermissions :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Checkout'sessionPermissions'NonNullable)),
    -- | phone_number_collection:
    checkout'sessionPhoneNumberCollection :: (GHC.Maybe.Maybe PaymentPagesCheckoutSessionPhoneNumberCollection),
    -- | presentment_details:
    checkout'sessionPresentmentDetails :: (GHC.Maybe.Maybe PaymentFlowsPaymentIntentPresentmentDetails),
    ...
    checkout'sessionSavedPaymentMethodOptions :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Checkout'sessionSavedPaymentMethodOptions'NonNullable)),
    ...
    checkout'sessionWalletOptions :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Checkout'sessionWalletOptions'NonNullable))
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
mkCheckout'session checkout'sessionAutomaticTax checkout'sessionCreated checkout'sessionCustomFields checkout'sessionCustomText checkout'sessionExpiresAt checkout'sessionId checkout'sessionLivemode checkout'sessionMode checkout'sessionPaymentMethodTypes checkout'sessionPaymentStatus checkout'sessionShippingOptions =
  Checkout'session
    { checkout'sessionAdaptivePricing = GHC.Maybe.Nothing,
      ...
      checkout'sessionCollectedInformation = GHC.Maybe.Nothing,
      ...
      checkout'sessionDiscounts = GHC.Maybe.Nothing,
      ...
      checkout'sessionMode = checkout'sessionMode,
      checkout'sessionOptionalItems = GHC.Maybe.Nothing,
      checkout'sessionOriginContext = GHC.Maybe.Nothing,
      ...
      checkout'sessionPaymentStatus = checkout'sessionPaymentStatus,
      checkout'sessionPermissions = GHC.Maybe.Nothing,
      checkout'sessionPhoneNumberCollection = GHC.Maybe.Nothing,
      checkout'sessionPresentmentDetails = GHC.Maybe.Nothing,
      ...
      checkout'sessionSavedPaymentMethodOptions = GHC.Maybe.Nothing,
      ...
      checkout'sessionWalletOptions = GHC.Maybe.Nothing
    }

-- | Defines the object schema located at @components.schemas.checkout.session.properties.adaptive_pricing.anyOf@ in the specification.
--
-- Settings for price localization with [Adaptive Pricing](https:\\\/\\\/docs.stripe.com\\\/payments\\\/checkout\\\/adaptive-pricing).
data Checkout'sessionAdaptivePricing'NonNullable = Checkout'sessionAdaptivePricing'NonNullable
  { -- | enabled: If enabled, Adaptive Pricing is available on [eligible sessions](https:\/\/docs.stripe.com\/payments\/currencies\/localize-prices\/adaptive-pricing?payment-ui=stripe-hosted\#restrictions).
    checkout'sessionAdaptivePricing'NonNullableEnabled :: (GHC.Maybe.Maybe GHC.Types.Bool)
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON Checkout'sessionAdaptivePricing'NonNullable where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("enabled" Data.Aeson.Types.ToJSON..=)) (checkout'sessionAdaptivePricing'NonNullableEnabled obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("enabled" Data.Aeson.Types.ToJSON..=)) (checkout'sessionAdaptivePricing'NonNullableEnabled obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON Checkout'sessionAdaptivePricing'NonNullable where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "Checkout'sessionAdaptivePricing'NonNullable" (\obj -> GHC.Base.pure Checkout'sessionAdaptivePricing'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "enabled"))

-- | Create a new 'Checkout'sessionAdaptivePricing'NonNullable' with all required fields.
mkCheckout'sessionAdaptivePricing'NonNullable :: Checkout'sessionAdaptivePricing'NonNullable
mkCheckout'sessionAdaptivePricing'NonNullable = Checkout'sessionAdaptivePricing'NonNullable {checkout'sessionAdaptivePricing'NonNullableEnabled = GHC.Maybe.Nothing}
...
-- | Defines the object schema located at @components.schemas.checkout.session.properties.collected_information.anyOf@ in the specification.
--
-- Information about the customer collected within the Checkout Session.
data Checkout'sessionCollectedInformation'NonNullable = Checkout'sessionCollectedInformation'NonNullable
  { -- | shipping_details: Shipping information for this Checkout Session.
    checkout'sessionCollectedInformation'NonNullableShippingDetails :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Checkout'sessionCollectedInformation'NonNullableShippingDetails'NonNullable))
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON Checkout'sessionCollectedInformation'NonNullable where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("shipping_details" Data.Aeson.Types.ToJSON..=)) (checkout'sessionCollectedInformation'NonNullableShippingDetails obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("shipping_details" Data.Aeson.Types.ToJSON..=)) (checkout'sessionCollectedInformation'NonNullableShippingDetails obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON Checkout'sessionCollectedInformation'NonNullable where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "Checkout'sessionCollectedInformation'NonNullable" (\obj -> GHC.Base.pure Checkout'sessionCollectedInformation'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "shipping_details"))

-- | Create a new 'Checkout'sessionCollectedInformation'NonNullable' with all required fields.
mkCheckout'sessionCollectedInformation'NonNullable :: Checkout'sessionCollectedInformation'NonNullable
mkCheckout'sessionCollectedInformation'NonNullable = Checkout'sessionCollectedInformation'NonNullable {checkout'sessionCollectedInformation'NonNullableShippingDetails = GHC.Maybe.Nothing}

-- | Defines the object schema located at @components.schemas.checkout.session.properties.collected_information.anyOf.properties.shipping_details.anyOf@ in the specification.
--
-- Shipping information for this Checkout Session.
data Checkout'sessionCollectedInformation'NonNullableShippingDetails'NonNullable = Checkout'sessionCollectedInformation'NonNullableShippingDetails'NonNullable
  { -- | address:
    checkout'sessionCollectedInformation'NonNullableShippingDetails'NonNullableAddress :: (GHC.Maybe.Maybe Address),
    -- | name: Customer name.
    --
    -- Constraints:
    --
    -- * Maximum length of 5000
    checkout'sessionCollectedInformation'NonNullableShippingDetails'NonNullableName :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON Checkout'sessionCollectedInformation'NonNullableShippingDetails'NonNullable where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address" Data.Aeson.Types.ToJSON..=)) (checkout'sessionCollectedInformation'NonNullableShippingDetails'NonNullableAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("name" Data.Aeson.Types.ToJSON..=)) (checkout'sessionCollectedInformation'NonNullableShippingDetails'NonNullableName obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address" Data.Aeson.Types.ToJSON..=)) (checkout'sessionCollectedInformation'NonNullableShippingDetails'NonNullableAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("name" Data.Aeson.Types.ToJSON..=)) (checkout'sessionCollectedInformation'NonNullableShippingDetails'NonNullableName obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON Checkout'sessionCollectedInformation'NonNullableShippingDetails'NonNullable where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "Checkout'sessionCollectedInformation'NonNullableShippingDetails'NonNullable" (\obj -> (GHC.Base.pure Checkout'sessionCollectedInformation'NonNullableShippingDetails'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "address")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "name"))

-- | Create a new 'Checkout'sessionCollectedInformation'NonNullableShippingDetails'NonNullable' with all required fields.
mkCheckout'sessionCollectedInformation'NonNullableShippingDetails'NonNullable :: Checkout'sessionCollectedInformation'NonNullableShippingDetails'NonNullable
mkCheckout'sessionCollectedInformation'NonNullableShippingDetails'NonNullable =
  Checkout'sessionCollectedInformation'NonNullableShippingDetails'NonNullable
    { checkout'sessionCollectedInformation'NonNullableShippingDetails'NonNullableAddress = GHC.Maybe.Nothing,
      checkout'sessionCollectedInformation'NonNullableShippingDetails'NonNullableName = GHC.Maybe.Nothing
    }
...
-- | Defines the enum schema located at @components.schemas.checkout.session.properties.origin_context@ in the specification.
--
-- Where the user is coming from. This informs the optimizations that are applied to the session.
data Checkout'sessionOriginContext'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    Checkout'sessionOriginContext'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    Checkout'sessionOriginContext'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"mobile_app"@
    Checkout'sessionOriginContext'NonNullableEnumMobileApp
  | -- | Represents the JSON value @"web"@
    Checkout'sessionOriginContext'NonNullableEnumWeb
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON Checkout'sessionOriginContext'NonNullable where
  toJSON (Checkout'sessionOriginContext'NonNullableOther val) = val
  toJSON (Checkout'sessionOriginContext'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (Checkout'sessionOriginContext'NonNullableEnumMobileApp) = "mobile_app"
  toJSON (Checkout'sessionOriginContext'NonNullableEnumWeb) = "web"

instance Data.Aeson.Types.FromJSON.FromJSON Checkout'sessionOriginContext'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "mobile_app" -> Checkout'sessionOriginContext'NonNullableEnumMobileApp
          | val GHC.Classes.== "web" -> Checkout'sessionOriginContext'NonNullableEnumWeb
          | GHC.Base.otherwise -> Checkout'sessionOriginContext'NonNullableOther val
      )
...
data Checkout'sessionPaymentMethodOptions'NonNullable = Checkout'sessionPaymentMethodOptions'NonNullable
  { -- | acss_debit:
    ...
    -- | amazon_pay:
    checkout'sessionPaymentMethodOptions'NonNullableAmazonPay :: (GHC.Maybe.Maybe CheckoutAmazonPayPaymentMethodOptions),
    -- | au_becs_debit:
    ...
    -- | kakao_pay:
    checkout'sessionPaymentMethodOptions'NonNullableKakaoPay :: (GHC.Maybe.Maybe CheckoutKakaoPayPaymentMethodOptions),
    -- | klarna:
    ...
    -- | kr_card:
    checkout'sessionPaymentMethodOptions'NonNullableKrCard :: (GHC.Maybe.Maybe CheckoutKrCardPaymentMethodOptions),
    -- | link:
    checkout'sessionPaymentMethodOptions'NonNullableLink :: (GHC.Maybe.Maybe CheckoutLinkPaymentMethodOptions),
    -- | mobilepay:
    checkout'sessionPaymentMethodOptions'NonNullableMobilepay :: (GHC.Maybe.Maybe CheckoutMobilepayPaymentMethodOptions),
    -- | multibanco:
    checkout'sessionPaymentMethodOptions'NonNullableMultibanco :: (GHC.Maybe.Maybe CheckoutMultibancoPaymentMethodOptions),
    -- | naver_pay:
    checkout'sessionPaymentMethodOptions'NonNullableNaverPay :: (GHC.Maybe.Maybe CheckoutNaverPayPaymentMethodOptions),
    -- | oxxo:
    ...
    -- | payco:
    checkout'sessionPaymentMethodOptions'NonNullablePayco :: (GHC.Maybe.Maybe CheckoutPaycoPaymentMethodOptions),
    -- | paynow:
    ...
    -- | samsung_pay:
    checkout'sessionPaymentMethodOptions'NonNullableSamsungPay :: (GHC.Maybe.Maybe CheckoutSamsungPayPaymentMethodOptions),
    -- | sepa_debit:
    ...
    -- | swish:
    checkout'sessionPaymentMethodOptions'NonNullableSwish :: (GHC.Maybe.Maybe CheckoutSwishPaymentMethodOptions),
    -- | us_bank_account:
...
mkCheckout'sessionPaymentMethodOptions'NonNullable =
  Checkout'sessionPaymentMethodOptions'NonNullable
    { checkout'sessionPaymentMethodOptions'NonNullableAcssDebit = GHC.Maybe.Nothing,
      ...
      checkout'sessionPaymentMethodOptions'NonNullableAmazonPay = GHC.Maybe.Nothing,
      ...
      checkout'sessionPaymentMethodOptions'NonNullableKakaoPay = GHC.Maybe.Nothing,
      ...
      checkout'sessionPaymentMethodOptions'NonNullableKrCard = GHC.Maybe.Nothing,
      checkout'sessionPaymentMethodOptions'NonNullableLink = GHC.Maybe.Nothing,
      checkout'sessionPaymentMethodOptions'NonNullableMobilepay = GHC.Maybe.Nothing,
      checkout'sessionPaymentMethodOptions'NonNullableMultibanco = GHC.Maybe.Nothing,
      checkout'sessionPaymentMethodOptions'NonNullableNaverPay = GHC.Maybe.Nothing,
      ...
      checkout'sessionPaymentMethodOptions'NonNullablePayco = GHC.Maybe.Nothing,
      ...
      checkout'sessionPaymentMethodOptions'NonNullableSamsungPay = GHC.Maybe.Nothing,
      ...
      checkout'sessionPaymentMethodOptions'NonNullableSwish = GHC.Maybe.Nothing,
...
-- | Defines the object schema located at @components.schemas.checkout.session.properties.permissions.anyOf@ in the specification.
--
-- This property is used to set up permissions for various actions (e.g., update) on the CheckoutSession object.
--
-- For specific permissions, please refer to their dedicated subsections, such as \\\`permissions.update_shipping_details\\\`.
data Checkout'sessionPermissions'NonNullable = Checkout'sessionPermissions'NonNullable
  { -- | update_shipping_details: Determines which entity is allowed to update the shipping details.
    ...
    checkout'sessionPermissions'NonNullableUpdateShippingDetails :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Checkout'sessionPermissions'NonNullableUpdateShippingDetails'NonNullable))
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON Checkout'sessionPermissions'NonNullable where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("update_shipping_details" Data.Aeson.Types.ToJSON..=)) (checkout'sessionPermissions'NonNullableUpdateShippingDetails obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("update_shipping_details" Data.Aeson.Types.ToJSON..=)) (checkout'sessionPermissions'NonNullableUpdateShippingDetails obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON Checkout'sessionPermissions'NonNullable where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "Checkout'sessionPermissions'NonNullable" (\obj -> GHC.Base.pure Checkout'sessionPermissions'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "update_shipping_details"))

-- | Create a new 'Checkout'sessionPermissions'NonNullable' with all required fields.
mkCheckout'sessionPermissions'NonNullable :: Checkout'sessionPermissions'NonNullable
mkCheckout'sessionPermissions'NonNullable = Checkout'sessionPermissions'NonNullable {checkout'sessionPermissions'NonNullableUpdateShippingDetails = GHC.Maybe.Nothing}

-- | Defines the enum schema located at @components.schemas.checkout.session.properties.permissions.anyOf.properties.update_shipping_details@ in the specification.
--
...
data Checkout'sessionPermissions'NonNullableUpdateShippingDetails'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    Checkout'sessionPermissions'NonNullableUpdateShippingDetails'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    Checkout'sessionPermissions'NonNullableUpdateShippingDetails'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"client_only"@
    Checkout'sessionPermissions'NonNullableUpdateShippingDetails'NonNullableEnumClientOnly
  | -- | Represents the JSON value @"server_only"@
    Checkout'sessionPermissions'NonNullableUpdateShippingDetails'NonNullableEnumServerOnly
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON Checkout'sessionPermissions'NonNullableUpdateShippingDetails'NonNullable where
  toJSON (Checkout'sessionPermissions'NonNullableUpdateShippingDetails'NonNullableOther val) = val
  toJSON (Checkout'sessionPermissions'NonNullableUpdateShippingDetails'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (Checkout'sessionPermissions'NonNullableUpdateShippingDetails'NonNullableEnumClientOnly) = "client_only"
  toJSON (Checkout'sessionPermissions'NonNullableUpdateShippingDetails'NonNullableEnumServerOnly) = "server_only"

instance Data.Aeson.Types.FromJSON.FromJSON Checkout'sessionPermissions'NonNullableUpdateShippingDetails'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "client_only" -> Checkout'sessionPermissions'NonNullableUpdateShippingDetails'NonNullableEnumClientOnly
          | val GHC.Classes.== "server_only" -> Checkout'sessionPermissions'NonNullableUpdateShippingDetails'NonNullableEnumServerOnly
          | GHC.Base.otherwise -> Checkout'sessionPermissions'NonNullableUpdateShippingDetails'NonNullableOther val
      )
...
-- | Defines the object schema located at @components.schemas.checkout.session.properties.saved_payment_method_options.anyOf@ in the specification.
--
-- Controls saved payment method settings for the session. Only available in \\\`payment\\\` and \\\`subscription\\\` mode.
data Checkout'sessionSavedPaymentMethodOptions'NonNullable = Checkout'sessionSavedPaymentMethodOptions'NonNullable
  { -- | allow_redisplay_filters: Uses the \`allow_redisplay\` value of each saved payment method to filter the set presented to a returning customer. By default, only saved payment methods with ’allow_redisplay: ‘always’ are shown in Checkout.
    checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [Checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters'NonNullable])),
    -- | payment_method_remove: Enable customers to choose if they wish to remove their saved payment methods. Disabled by default.
    checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodRemove :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodRemove'NonNullable)),
    ...
    checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodSave :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodSave'NonNullable))
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON Checkout'sessionSavedPaymentMethodOptions'NonNullable where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("allow_redisplay_filters" Data.Aeson.Types.ToJSON..=)) (checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("payment_method_remove" Data.Aeson.Types.ToJSON..=)) (checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodRemove obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("payment_method_save" Data.Aeson.Types.ToJSON..=)) (checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodSave obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("allow_redisplay_filters" Data.Aeson.Types.ToJSON..=)) (checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("payment_method_remove" Data.Aeson.Types.ToJSON..=)) (checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodRemove obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("payment_method_save" Data.Aeson.Types.ToJSON..=)) (checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodSave obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON Checkout'sessionSavedPaymentMethodOptions'NonNullable where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "Checkout'sessionSavedPaymentMethodOptions'NonNullable" (\obj -> ((GHC.Base.pure Checkout'sessionSavedPaymentMethodOptions'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "allow_redisplay_filters")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payment_method_remove")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payment_method_save"))

-- | Create a new 'Checkout'sessionSavedPaymentMethodOptions'NonNullable' with all required fields.
mkCheckout'sessionSavedPaymentMethodOptions'NonNullable :: Checkout'sessionSavedPaymentMethodOptions'NonNullable
mkCheckout'sessionSavedPaymentMethodOptions'NonNullable =
  Checkout'sessionSavedPaymentMethodOptions'NonNullable
    { checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters = GHC.Maybe.Nothing,
      checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodRemove = GHC.Maybe.Nothing,
      checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodSave = GHC.Maybe.Nothing
    }

-- | Defines the enum schema located at @components.schemas.checkout.session.properties.saved_payment_method_options.anyOf.properties.allow_redisplay_filters.items@ in the specification.
data Checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    Checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    Checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"always"@
    Checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters'NonNullableEnumAlways
  | -- | Represents the JSON value @"limited"@
    Checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters'NonNullableEnumLimited
  | -- | Represents the JSON value @"unspecified"@
    Checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters'NonNullableEnumUnspecified
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON Checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters'NonNullable where
  toJSON (Checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters'NonNullableOther val) = val
  toJSON (Checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (Checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters'NonNullableEnumAlways) = "always"
  toJSON (Checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters'NonNullableEnumLimited) = "limited"
  toJSON (Checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters'NonNullableEnumUnspecified) = "unspecified"

instance Data.Aeson.Types.FromJSON.FromJSON Checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "always" -> Checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters'NonNullableEnumAlways
          | val GHC.Classes.== "limited" -> Checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters'NonNullableEnumLimited
          | val GHC.Classes.== "unspecified" -> Checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters'NonNullableEnumUnspecified
          | GHC.Base.otherwise -> Checkout'sessionSavedPaymentMethodOptions'NonNullableAllowRedisplayFilters'NonNullableOther val
      )

-- | Defines the enum schema located at @components.schemas.checkout.session.properties.saved_payment_method_options.anyOf.properties.payment_method_remove@ in the specification.
--
-- Enable customers to choose if they wish to remove their saved payment methods. Disabled by default.
data Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodRemove'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodRemove'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodRemove'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"disabled"@
    Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodRemove'NonNullableEnumDisabled
  | -- | Represents the JSON value @"enabled"@
    Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodRemove'NonNullableEnumEnabled
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodRemove'NonNullable where
  toJSON (Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodRemove'NonNullableOther val) = val
  toJSON (Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodRemove'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodRemove'NonNullableEnumDisabled) = "disabled"
  toJSON (Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodRemove'NonNullableEnumEnabled) = "enabled"

instance Data.Aeson.Types.FromJSON.FromJSON Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodRemove'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "disabled" -> Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodRemove'NonNullableEnumDisabled
          | val GHC.Classes.== "enabled" -> Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodRemove'NonNullableEnumEnabled
          | GHC.Base.otherwise -> Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodRemove'NonNullableOther val
      )

-- | Defines the enum schema located at @components.schemas.checkout.session.properties.saved_payment_method_options.anyOf.properties.payment_method_save@ in the specification.
--
-- Enable customers to choose if they wish to save their payment method for future use. Disabled by default.
data Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodSave'NonNullable
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodSave'NonNullableOther Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodSave'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"disabled"@
    Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodSave'NonNullableEnumDisabled
  | -- | Represents the JSON value @"enabled"@
    Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodSave'NonNullableEnumEnabled
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodSave'NonNullable where
  toJSON (Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodSave'NonNullableOther val) = val
  toJSON (Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodSave'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodSave'NonNullableEnumDisabled) = "disabled"
  toJSON (Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodSave'NonNullableEnumEnabled) = "enabled"

instance Data.Aeson.Types.FromJSON.FromJSON Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodSave'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "disabled" -> Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodSave'NonNullableEnumDisabled
          | val GHC.Classes.== "enabled" -> Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodSave'NonNullableEnumEnabled
          | GHC.Base.otherwise -> Checkout'sessionSavedPaymentMethodOptions'NonNullablePaymentMethodSave'NonNullableOther val
      )
...
data Checkout'sessionShippingAddressCollection'NonNullableAllowedCountries'
  ...
  | -- | Represents the JSON value @"SD"@
    Checkout'sessionShippingAddressCollection'NonNullableAllowedCountries'EnumSD
...
instance Data.Aeson.Types.ToJSON.ToJSON Checkout'sessionShippingAddressCollection'NonNullableAllowedCountries' where
  ...
  toJSON (Checkout'sessionShippingAddressCollection'NonNullableAllowedCountries'EnumSD) = "SD"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "SD" -> Checkout'sessionShippingAddressCollection'NonNullableAllowedCountries'EnumSD
...
data Checkout'sessionSubmitType'NonNullable
  ...
  | -- | Represents the JSON value @"subscribe"@
    Checkout'sessionSubmitType'NonNullableEnumSubscribe
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
instance Data.Aeson.Types.ToJSON.ToJSON Checkout'sessionSubmitType'NonNullable where
  ...
  toJSON (Checkout'sessionSubmitType'NonNullableEnumSubscribe) = "subscribe"
  ...
  parseJSON val =
    GHC.Base.pure
      ( if
          ...
          | val GHC.Classes.== "subscribe" -> Checkout'sessionSubmitType'NonNullableEnumSubscribe
...
data Checkout'sessionUiMode'NonNullable
  ...
  | -- | Represents the JSON value @"custom"@
    Checkout'sessionUiMode'NonNullableEnumCustom
...
instance Data.Aeson.Types.ToJSON.ToJSON Checkout'sessionUiMode'NonNullable where
  ...
  toJSON (Checkout'sessionUiMode'NonNullableEnumCustom) = "custom"
...
instance Data.Aeson.Types.FromJSON.FromJSON Checkout'sessionUiMode'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
          | val GHC.Classes.== "custom" -> Checkout'sessionUiMode'NonNullableEnumCustom
...
-- | Defines the object schema located at @components.schemas.checkout.session.properties.wallet_options.anyOf@ in the specification.
--
-- Wallet-specific configuration for this Checkout Session.
data Checkout'sessionWalletOptions'NonNullable = Checkout'sessionWalletOptions'NonNullable
  { -- | link:
    checkout'sessionWalletOptions'NonNullableLink :: (GHC.Maybe.Maybe CheckoutLinkWalletOptions)
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
instance Data.Aeson.Types.ToJSON.ToJSON Checkout'sessionWalletOptions'NonNullable where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("link" Data.Aeson.Types.ToJSON..=)) (checkout'sessionWalletOptions'NonNullableLink obj) : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("link" Data.Aeson.Types.ToJSON..=)) (checkout'sessionWalletOptions'NonNullableLink obj) : GHC.Base.mempty)))

instance Data.Aeson.Types.FromJSON.FromJSON Checkout'sessionWalletOptions'NonNullable where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "Checkout'sessionWalletOptions'NonNullable" (\obj -> GHC.Base.pure Checkout'sessionWalletOptions'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "link"))

-- | Create a new 'Checkout'sessionWalletOptions'NonNullable' with all required fields.
mkCheckout'sessionWalletOptions'NonNullable :: Checkout'sessionWalletOptions'NonNullable
mkCheckout'sessionWalletOptions'NonNullable = Checkout'sessionWalletOptions'NonNullable {checkout'sessionWalletOptions'NonNullableLink = GHC.Maybe.Nothing}
