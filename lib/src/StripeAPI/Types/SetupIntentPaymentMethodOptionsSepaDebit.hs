...
-- | Contains the types generated from the schema SetupIntentPaymentMethodOptionsSepaDebit
...
-- | Defines the object schema located at @components.schemas.setup_intent_payment_method_options_sepa_debit@ in the specification.
data SetupIntentPaymentMethodOptionsSepaDebit = SetupIntentPaymentMethodOptionsSepaDebit
  { -- | mandate_options:
    setupIntentPaymentMethodOptionsSepaDebitMandateOptions :: (GHC.Maybe.Maybe SetupIntentPaymentMethodOptionsMandateOptionsSepaDebit)
  }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
mkSetupIntentPaymentMethodOptionsSepaDebit = SetupIntentPaymentMethodOptionsSepaDebit {setupIntentPaymentMethodOptionsSepaDebitMandateOptions = GHC.Maybe.Nothing}
